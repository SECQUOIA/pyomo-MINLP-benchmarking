#  MINLP written by GAMS Convert at 01/15/21 11:37:31
#  
#  Equation counts
#      Total        E        G        L        N        X        C        B
...
m.c32 = Constraint(expr=(m.x179/(0.001 + 0.999*m.b365) - log(1 + m.x167/(0.001 + 0.999*m.b365)))*(0.001 + 0.999*m.b365)
                         <= 0)

m.c33 = Constraint(expr=(m.x180/(0.001 + 0.999*m.b366) - log(1 + m.x168/(0.001 + 0.999*m.b366)))*(0.001 + 0.999*m.b366)
                         <= 0)

m.c34 = Constraint(expr=(m.x181/(0.001 + 0.999*m.b367) - log(1 + m.x169/(0.001 + 0.999*m.b367)))*(0.001 + 0.999*m.b367)
                         <= 0)
...
m.c59 = Constraint(expr=(m.x185/(0.001 + 0.999*m.b368) - 1.2*log(1 + m.x173/(0.001 + 0.999*m.b368)))*(0.001 + 0.999*
                        m.b368) <= 0)

m.c60 = Constraint(expr=(m.x186/(0.001 + 0.999*m.b369) - 1.2*log(1 + m.x174/(0.001 + 0.999*m.b369)))*(0.001 + 0.999*
                        m.b369) <= 0)

m.c61 = Constraint(expr=(m.x187/(0.001 + 0.999*m.b370) - 1.2*log(1 + m.x175/(0.001 + 0.999*m.b370)))*(0.001 + 0.999*
                        m.b370) <= 0)
...
m.c113 = Constraint(expr=(m.x221/(0.001 + 0.999*m.b374) - 1.5*log(1 + m.x197/(0.001 + 0.999*m.b374)))*(0.001 + 0.999*
                         m.b374) <= 0)

m.c114 = Constraint(expr=(m.x222/(0.001 + 0.999*m.b375) - 1.5*log(1 + m.x198/(0.001 + 0.999*m.b375)))*(0.001 + 0.999*
                         m.b375) <= 0)

m.c115 = Constraint(expr=(m.x223/(0.001 + 0.999*m.b376) - 1.5*log(1 + m.x199/(0.001 + 0.999*m.b376)))*(0.001 + 0.999*
                         m.b376) <= 0)
...
m.c182 = Constraint(expr=(m.x269/(0.001 + 0.999*m.b380) - 1.25*log(1 + m.x239/(0.001 + 0.999*m.b380)))*(0.001 + 0.999*
                         m.b380) <= 0)

m.c183 = Constraint(expr=(m.x270/(0.001 + 0.999*m.b381) - 1.25*log(1 + m.x240/(0.001 + 0.999*m.b381)))*(0.001 + 0.999*
                         m.b381) <= 0)

m.c184 = Constraint(expr=(m.x271/(0.001 + 0.999*m.b382) - 1.25*log(1 + m.x241/(0.001 + 0.999*m.b382)))*(0.001 + 0.999*
                         m.b382) <= 0)
...
m.c209 = Constraint(expr=(m.x281/(0.001 + 0.999*m.b383) - 0.9*log(1 + m.x245/(0.001 + 0.999*m.b383)))*(0.001 + 0.999*
                         m.b383) <= 0)

m.c210 = Constraint(expr=(m.x282/(0.001 + 0.999*m.b384) - 0.9*log(1 + m.x246/(0.001 + 0.999*m.b384)))*(0.001 + 0.999*
                         m.b384) <= 0)

m.c211 = Constraint(expr=(m.x283/(0.001 + 0.999*m.b385) - 0.9*log(1 + m.x247/(0.001 + 0.999*m.b385)))*(0.001 + 0.999*
                         m.b385) <= 0)
...
m.c236 = Constraint(expr=(m.x293/(0.001 + 0.999*m.b386) - log(1 + m.x224/(0.001 + 0.999*m.b386)))*(0.001 + 0.999*m.b386)
                          <= 0)

m.c237 = Constraint(expr=(m.x294/(0.001 + 0.999*m.b387) - log(1 + m.x225/(0.001 + 0.999*m.b387)))*(0.001 + 0.999*m.b387)
                          <= 0)

m.c238 = Constraint(expr=(m.x295/(0.001 + 0.999*m.b388) - log(1 + m.x226/(0.001 + 0.999*m.b388)))*(0.001 + 0.999*m.b388)
                          <= 0)
...
m.c317 = Constraint(expr=(m.x311/(0.001 + 0.999*m.b395) - 1.1*log(1 + m.x263/(0.001 + 0.999*m.b395)))*(0.001 + 0.999*
                         m.b395) <= 0)

m.c318 = Constraint(expr=(m.x312/(0.001 + 0.999*m.b396) - 1.1*log(1 + m.x264/(0.001 + 0.999*m.b396)))*(0.001 + 0.999*
                         m.b396) <= 0)

m.c319 = Constraint(expr=(m.x313/(0.001 + 0.999*m.b397) - 1.1*log(1 + m.x265/(0.001 + 0.999*m.b397)))*(0.001 + 0.999*
                         m.b397) <= 0)
...
m.c386 = Constraint(expr=(m.x347/(0.001 + 0.999*m.b401) - log(1 + m.x284/(0.001 + 0.999*m.b401)))*(0.001 + 0.999*m.b401)
                          <= 0)

m.c387 = Constraint(expr=(m.x348/(0.001 + 0.999*m.b402) - log(1 + m.x285/(0.001 + 0.999*m.b402)))*(0.001 + 0.999*m.b402)
                          <= 0)

m.c388 = Constraint(expr=(m.x349/(0.001 + 0.999*m.b403) - log(1 + m.x286/(0.001 + 0.999*m.b403)))*(0.001 + 0.999*m.b403)
                          <= 0)
...
m.c413 = Constraint(expr=(m.x353/(0.001 + 0.999*m.b404) - 0.7*log(1 + m.x317/(0.001 + 0.999*m.b404)))*(0.001 + 0.999*
                         m.b404) <= 0)

m.c414 = Constraint(expr=(m.x354/(0.001 + 0.999*m.b405) - 0.7*log(1 + m.x318/(0.001 + 0.999*m.b405)))*(0.001 + 0.999*
                         m.b405) <= 0)

m.c415 = Constraint(expr=(m.x355/(0.001 + 0.999*m.b406) - 0.7*log(1 + m.x319/(0.001 + 0.999*m.b406)))*(0.001 + 0.999*
                         m.b406) <= 0)
...
m.c440 = Constraint(expr=(m.x359/(0.001 + 0.999*m.b407) - 0.65*log(1 + m.x323/(0.001 + 0.999*m.b407)))*(0.001 + 0.999*
                         m.b407) <= 0)

m.c441 = Constraint(expr=(m.x360/(0.001 + 0.999*m.b408) - 0.65*log(1 + m.x324/(0.001 + 0.999*m.b408)))*(0.001 + 0.999*
                         m.b408) <= 0)

m.c442 = Constraint(expr=(m.x361/(0.001 + 0.999*m.b409) - 0.65*log(1 + m.x325/(0.001 + 0.999*m.b409)))*(0.001 + 0.999*
                         m.b409) <= 0)

m.c443 = Constraint(expr=(m.x359/(0.001 + 0.999*m.b407) - 0.65*log(1 + m.x335/(0.001 + 0.999*m.b407)))*(0.001 + 0.999*
                         m.b407) <= 0)

m.c444 = Constraint(expr=(m.x360/(0.001 + 0.999*m.b408) - 0.65*log(1 + m.x336/(0.001 + 0.999*m.b408)))*(0.001 + 0.999*
                         m.b408) <= 0)

m.c445 = Constraint(expr=(m.x361/(0.001 + 0.999*m.b409) - 0.65*log(1 + m.x337/(0.001 + 0.999*m.b409)))*(0.001 + 0.999*
                         m.b409) <= 0)
