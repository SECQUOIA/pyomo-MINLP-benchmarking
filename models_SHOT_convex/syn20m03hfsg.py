...
m.c32 = Constraint(expr=(m.x209/(0.001 + 0.999*m.b455) - log(1 + m.x197/(0.001 + 0.999*m.b455)))*(0.001 + 0.999*m.b455)
                         <= 0)

m.c33 = Constraint(expr=(m.x210/(0.001 + 0.999*m.b456) - log(1 + m.x198/(0.001 + 0.999*m.b456)))*(0.001 + 0.999*m.b456)
                         <= 0)

m.c34 = Constraint(expr=(m.x211/(0.001 + 0.999*m.b457) - log(1 + m.x199/(0.001 + 0.999*m.b457)))*(0.001 + 0.999*m.b457)
                         <= 0)
...
m.c59 = Constraint(expr=(m.x215/(0.001 + 0.999*m.b458) - 1.2*log(1 + m.x203/(0.001 + 0.999*m.b458)))*(0.001 + 0.999*
                        m.b458) <= 0)

m.c60 = Constraint(expr=(m.x216/(0.001 + 0.999*m.b459) - 1.2*log(1 + m.x204/(0.001 + 0.999*m.b459)))*(0.001 + 0.999*
                        m.b459) <= 0)

m.c61 = Constraint(expr=(m.x217/(0.001 + 0.999*m.b460) - 1.2*log(1 + m.x205/(0.001 + 0.999*m.b460)))*(0.001 + 0.999*
                        m.b460) <= 0)
...
m.c113 = Constraint(expr=(m.x251/(0.001 + 0.999*m.b464) - 1.5*log(1 + m.x227/(0.001 + 0.999*m.b464)))*(0.001 + 0.999*
                         m.b464) <= 0)

m.c114 = Constraint(expr=(m.x252/(0.001 + 0.999*m.b465) - 1.5*log(1 + m.x228/(0.001 + 0.999*m.b465)))*(0.001 + 0.999*
                         m.b465) <= 0)

m.c115 = Constraint(expr=(m.x253/(0.001 + 0.999*m.b466) - 1.5*log(1 + m.x229/(0.001 + 0.999*m.b466)))*(0.001 + 0.999*
                         m.b466) <= 0)
...
m.c182 = Constraint(expr=(m.x299/(0.001 + 0.999*m.b470) - 1.25*log(1 + m.x269/(0.001 + 0.999*m.b470)))*(0.001 + 0.999*
                         m.b470) <= 0)

m.c183 = Constraint(expr=(m.x300/(0.001 + 0.999*m.b471) - 1.25*log(1 + m.x270/(0.001 + 0.999*m.b471)))*(0.001 + 0.999*
                         m.b471) <= 0)

m.c184 = Constraint(expr=(m.x301/(0.001 + 0.999*m.b472) - 1.25*log(1 + m.x271/(0.001 + 0.999*m.b472)))*(0.001 + 0.999*
                         m.b472) <= 0)
...
m.c209 = Constraint(expr=(m.x311/(0.001 + 0.999*m.b473) - 0.9*log(1 + m.x275/(0.001 + 0.999*m.b473)))*(0.001 + 0.999*
                         m.b473) <= 0)

m.c210 = Constraint(expr=(m.x312/(0.001 + 0.999*m.b474) - 0.9*log(1 + m.x276/(0.001 + 0.999*m.b474)))*(0.001 + 0.999*
                         m.b474) <= 0)

m.c211 = Constraint(expr=(m.x313/(0.001 + 0.999*m.b475) - 0.9*log(1 + m.x277/(0.001 + 0.999*m.b475)))*(0.001 + 0.999*
                         m.b475) <= 0)
...
m.c236 = Constraint(expr=(m.x323/(0.001 + 0.999*m.b476) - log(1 + m.x254/(0.001 + 0.999*m.b476)))*(0.001 + 0.999*m.b476)
                          <= 0)

m.c237 = Constraint(expr=(m.x324/(0.001 + 0.999*m.b477) - log(1 + m.x255/(0.001 + 0.999*m.b477)))*(0.001 + 0.999*m.b477)
                          <= 0)

m.c238 = Constraint(expr=(m.x325/(0.001 + 0.999*m.b478) - log(1 + m.x256/(0.001 + 0.999*m.b478)))*(0.001 + 0.999*m.b478)
                          <= 0)
...
m.c317 = Constraint(expr=(m.x341/(0.001 + 0.999*m.b485) - 1.1*log(1 + m.x293/(0.001 + 0.999*m.b485)))*(0.001 + 0.999*
                         m.b485) <= 0)

m.c318 = Constraint(expr=(m.x342/(0.001 + 0.999*m.b486) - 1.1*log(1 + m.x294/(0.001 + 0.999*m.b486)))*(0.001 + 0.999*
                         m.b486) <= 0)

m.c319 = Constraint(expr=(m.x343/(0.001 + 0.999*m.b487) - 1.1*log(1 + m.x295/(0.001 + 0.999*m.b487)))*(0.001 + 0.999*
                         m.b487) <= 0)
...
m.c386 = Constraint(expr=(m.x407/(0.001 + 0.999*m.b491) - log(1 + m.x314/(0.001 + 0.999*m.b491)))*(0.001 + 0.999*m.b491)
                          <= 0)

m.c387 = Constraint(expr=(m.x408/(0.001 + 0.999*m.b492) - log(1 + m.x315/(0.001 + 0.999*m.b492)))*(0.001 + 0.999*m.b492)
                          <= 0)

m.c388 = Constraint(expr=(m.x409/(0.001 + 0.999*m.b493) - log(1 + m.x316/(0.001 + 0.999*m.b493)))*(0.001 + 0.999*m.b493)
                          <= 0)
...
m.c413 = Constraint(expr=(m.x413/(0.001 + 0.999*m.b494) - 0.7*log(1 + m.x347/(0.001 + 0.999*m.b494)))*(0.001 + 0.999*
                         m.b494) <= 0)

m.c414 = Constraint(expr=(m.x414/(0.001 + 0.999*m.b495) - 0.7*log(1 + m.x348/(0.001 + 0.999*m.b495)))*(0.001 + 0.999*
                         m.b495) <= 0)

m.c415 = Constraint(expr=(m.x415/(0.001 + 0.999*m.b496) - 0.7*log(1 + m.x349/(0.001 + 0.999*m.b496)))*(0.001 + 0.999*
                         m.b496) <= 0)
...
m.c440 = Constraint(expr=(m.x419/(0.001 + 0.999*m.b497) - 0.65*log(1 + m.x353/(0.001 + 0.999*m.b497)))*(0.001 + 0.999*
                         m.b497) <= 0)

m.c441 = Constraint(expr=(m.x420/(0.001 + 0.999*m.b498) - 0.65*log(1 + m.x354/(0.001 + 0.999*m.b498)))*(0.001 + 0.999*
                         m.b498) <= 0)

m.c442 = Constraint(expr=(m.x421/(0.001 + 0.999*m.b499) - 0.65*log(1 + m.x355/(0.001 + 0.999*m.b499)))*(0.001 + 0.999*
                         m.b499) <= 0)

m.c443 = Constraint(expr=(m.x419/(0.001 + 0.999*m.b497) - 0.65*log(1 + m.x365/(0.001 + 0.999*m.b497)))*(0.001 + 0.999*
                         m.b497) <= 0)

m.c444 = Constraint(expr=(m.x420/(0.001 + 0.999*m.b498) - 0.65*log(1 + m.x366/(0.001 + 0.999*m.b498)))*(0.001 + 0.999*
                         m.b498) <= 0)

m.c445 = Constraint(expr=(m.x421/(0.001 + 0.999*m.b499) - 0.65*log(1 + m.x367/(0.001 + 0.999*m.b499)))*(0.001 + 0.999*
                         m.b499) <= 0)
...
m.c536 = Constraint(expr=(m.x437/(0.001 + 0.999*m.b506) - 0.75*log(1 + m.x383/(0.001 + 0.999*m.b506)))*(0.001 + 0.999*
                         m.b506) <= 0)

m.c537 = Constraint(expr=(m.x438/(0.001 + 0.999*m.b507) - 0.75*log(1 + m.x384/(0.001 + 0.999*m.b507)))*(0.001 + 0.999*
                         m.b507) <= 0)

m.c538 = Constraint(expr=(m.x439/(0.001 + 0.999*m.b508) - 0.75*log(1 + m.x385/(0.001 + 0.999*m.b508)))*(0.001 + 0.999*
                         m.b508) <= 0)
...
m.c563 = Constraint(expr=(m.x443/(0.001 + 0.999*m.b509) - 0.8*log(1 + m.x389/(0.001 + 0.999*m.b509)))*(0.001 + 0.999*
                         m.b509) <= 0)

m.c564 = Constraint(expr=(m.x444/(0.001 + 0.999*m.b510) - 0.8*log(1 + m.x390/(0.001 + 0.999*m.b510)))*(0.001 + 0.999*
                         m.b510) <= 0)

m.c565 = Constraint(expr=(m.x445/(0.001 + 0.999*m.b511) - 0.8*log(1 + m.x391/(0.001 + 0.999*m.b511)))*(0.001 + 0.999*
                         m.b511) <= 0)
...
m.c590 = Constraint(expr=(m.x449/(0.001 + 0.999*m.b512) - 0.85*log(1 + m.x395/(0.001 + 0.999*m.b512)))*(0.001 + 0.999*
                         m.b512) <= 0)

m.c591 = Constraint(expr=(m.x450/(0.001 + 0.999*m.b513) - 0.85*log(1 + m.x396/(0.001 + 0.999*m.b513)))*(0.001 + 0.999*
                         m.b513) <= 0)

m.c592 = Constraint(expr=(m.x451/(0.001 + 0.999*m.b514) - 0.85*log(1 + m.x397/(0.001 + 0.999*m.b514)))*(0.001 + 0.999*
                         m.b514) <= 0)
