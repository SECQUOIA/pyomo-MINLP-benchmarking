...
m.c22 = Constraint(expr=(m.x140/(0.001 + 0.999*m.b304) - log(1 + m.x132/(0.001 + 0.999*m.b304)))*(0.001 + 0.999*m.b304)
                         <= 0)

m.c23 = Constraint(expr=(m.x141/(0.001 + 0.999*m.b305) - log(1 + m.x133/(0.001 + 0.999*m.b305)))*(0.001 + 0.999*m.b305)
                         <= 0)
...
m.c40 = Constraint(expr=(m.x144/(0.001 + 0.999*m.b306) - 1.2*log(1 + m.x136/(0.001 + 0.999*m.b306)))*(0.001 + 0.999*
                        m.b306) <= 0)

m.c41 = Constraint(expr=(m.x145/(0.001 + 0.999*m.b307) - 1.2*log(1 + m.x137/(0.001 + 0.999*m.b307)))*(0.001 + 0.999*
                        m.b307) <= 0)
...
m.c76 = Constraint(expr=(m.x168/(0.001 + 0.999*m.b310) - 1.5*log(1 + m.x152/(0.001 + 0.999*m.b310)))*(0.001 + 0.999*
                        m.b310) <= 0)

m.c77 = Constraint(expr=(m.x169/(0.001 + 0.999*m.b311) - 1.5*log(1 + m.x153/(0.001 + 0.999*m.b311)))*(0.001 + 0.999*
                        m.b311) <= 0)
...
m.c122 = Constraint(expr=(m.x200/(0.001 + 0.999*m.b314) - 1.25*log(1 + m.x180/(0.001 + 0.999*m.b314)))*(0.001 + 0.999*
                         m.b314) <= 0)

m.c123 = Constraint(expr=(m.x201/(0.001 + 0.999*m.b315) - 1.25*log(1 + m.x181/(0.001 + 0.999*m.b315)))*(0.001 + 0.999*
                         m.b315) <= 0)
...
m.c140 = Constraint(expr=(m.x208/(0.001 + 0.999*m.b316) - 0.9*log(1 + m.x184/(0.001 + 0.999*m.b316)))*(0.001 + 0.999*
                         m.b316) <= 0)

m.c141 = Constraint(expr=(m.x209/(0.001 + 0.999*m.b317) - 0.9*log(1 + m.x185/(0.001 + 0.999*m.b317)))*(0.001 + 0.999*
                         m.b317) <= 0)
...
m.c158 = Constraint(expr=(m.x216/(0.001 + 0.999*m.b318) - log(1 + m.x170/(0.001 + 0.999*m.b318)))*(0.001 + 0.999*m.b318)
                          <= 0)

m.c159 = Constraint(expr=(m.x217/(0.001 + 0.999*m.b319) - log(1 + m.x171/(0.001 + 0.999*m.b319)))*(0.001 + 0.999*m.b319)
                          <= 0)
...
m.c212 = Constraint(expr=(m.x228/(0.001 + 0.999*m.b324) - 1.1*log(1 + m.x196/(0.001 + 0.999*m.b324)))*(0.001 + 0.999*
                         m.b324) <= 0)

m.c213 = Constraint(expr=(m.x229/(0.001 + 0.999*m.b325) - 1.1*log(1 + m.x197/(0.001 + 0.999*m.b325)))*(0.001 + 0.999*
                         m.b325) <= 0)
...
m.c258 = Constraint(expr=(m.x272/(0.001 + 0.999*m.b328) - log(1 + m.x210/(0.001 + 0.999*m.b328)))*(0.001 + 0.999*m.b328)
                          <= 0)

m.c259 = Constraint(expr=(m.x273/(0.001 + 0.999*m.b329) - log(1 + m.x211/(0.001 + 0.999*m.b329)))*(0.001 + 0.999*m.b329)
                          <= 0)
...
m.c276 = Constraint(expr=(m.x276/(0.001 + 0.999*m.b330) - 0.7*log(1 + m.x232/(0.001 + 0.999*m.b330)))*(0.001 + 0.999*
                         m.b330) <= 0)

m.c277 = Constraint(expr=(m.x277/(0.001 + 0.999*m.b331) - 0.7*log(1 + m.x233/(0.001 + 0.999*m.b331)))*(0.001 + 0.999*
                         m.b331) <= 0)
...
m.c294 = Constraint(expr=(m.x280/(0.001 + 0.999*m.b332) - 0.65*log(1 + m.x236/(0.001 + 0.999*m.b332)))*(0.001 + 0.999*
                         m.b332) <= 0)

m.c295 = Constraint(expr=(m.x281/(0.001 + 0.999*m.b333) - 0.65*log(1 + m.x237/(0.001 + 0.999*m.b333)))*(0.001 + 0.999*
                         m.b333) <= 0)

m.c296 = Constraint(expr=(m.x280/(0.001 + 0.999*m.b332) - 0.65*log(1 + m.x244/(0.001 + 0.999*m.b332)))*(0.001 + 0.999*
                         m.b332) <= 0)

m.c297 = Constraint(expr=(m.x281/(0.001 + 0.999*m.b333) - 0.65*log(1 + m.x245/(0.001 + 0.999*m.b333)))*(0.001 + 0.999*
                         m.b333) <= 0)
...
m.c358 = Constraint(expr=(m.x292/(0.001 + 0.999*m.b338) - 0.75*log(1 + m.x256/(0.001 + 0.999*m.b338)))*(0.001 + 0.999*
                         m.b338) <= 0)

m.c359 = Constraint(expr=(m.x293/(0.001 + 0.999*m.b339) - 0.75*log(1 + m.x257/(0.001 + 0.999*m.b339)))*(0.001 + 0.999*
                         m.b339) <= 0)
...
m.c376 = Constraint(expr=(m.x296/(0.001 + 0.999*m.b340) - 0.8*log(1 + m.x260/(0.001 + 0.999*m.b340)))*(0.001 + 0.999*
                         m.b340) <= 0)

m.c377 = Constraint(expr=(m.x297/(0.001 + 0.999*m.b341) - 0.8*log(1 + m.x261/(0.001 + 0.999*m.b341)))*(0.001 + 0.999*
                         m.b341) <= 0)
...
m.c394 = Constraint(expr=(m.x300/(0.001 + 0.999*m.b342) - 0.85*log(1 + m.x264/(0.001 + 0.999*m.b342)))*(0.001 + 0.999*
                         m.b342) <= 0)

m.c395 = Constraint(expr=(m.x301/(0.001 + 0.999*m.b343) - 0.85*log(1 + m.x265/(0.001 + 0.999*m.b343)))*(0.001 + 0.999*
                         m.b343) <= 0)
