...
m.c14 = Constraint(expr=(m.x74/(0.001 + 0.999*m.b128) - log(1 + m.x62/(0.001 + 0.999*m.b128)))*(0.001 + 0.999*m.b128)
                         <= 0)

m.c15 = Constraint(expr=(m.x75/(0.001 + 0.999*m.b129) - log(1 + m.x63/(0.001 + 0.999*m.b129)))*(0.001 + 0.999*m.b129)
                         <= 0)

m.c16 = Constraint(expr=(m.x76/(0.001 + 0.999*m.b130) - log(1 + m.x64/(0.001 + 0.999*m.b130)))*(0.001 + 0.999*m.b130)
                         <= 0)
...
m.c41 = Constraint(expr=(m.x80/(0.001 + 0.999*m.b131) - 1.2*log(1 + m.x68/(0.001 + 0.999*m.b131)))*(0.001 + 0.999*m.b131
                        ) <= 0)

m.c42 = Constraint(expr=(m.x81/(0.001 + 0.999*m.b132) - 1.2*log(1 + m.x69/(0.001 + 0.999*m.b132)))*(0.001 + 0.999*m.b132
                        ) <= 0)

m.c43 = Constraint(expr=(m.x82/(0.001 + 0.999*m.b133) - 1.2*log(1 + m.x70/(0.001 + 0.999*m.b133)))*(0.001 + 0.999*m.b133
                        ) <= 0)
...
m.c95 = Constraint(expr=(m.x116/(0.001 + 0.999*m.b137) - 1.5*log(1 + m.x92/(0.001 + 0.999*m.b137)))*(0.001 + 0.999*
                        m.b137) <= 0)

m.c96 = Constraint(expr=(m.x117/(0.001 + 0.999*m.b138) - 1.5*log(1 + m.x93/(0.001 + 0.999*m.b138)))*(0.001 + 0.999*
                        m.b138) <= 0)

m.c97 = Constraint(expr=(m.x118/(0.001 + 0.999*m.b139) - 1.5*log(1 + m.x94/(0.001 + 0.999*m.b139)))*(0.001 + 0.999*
                        m.b139) <= 0)
