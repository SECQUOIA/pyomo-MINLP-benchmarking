...
m.c8 = Constraint(expr=(m.x31/(0.001 + 0.999*m.b69) - log(1 + m.x27/(0.001 + 0.999*m.b69)))*(0.001 + 0.999*m.b69) <= 0)
...
m.c17 = Constraint(expr=(m.x33/(0.001 + 0.999*m.b70) - 1.2*log(1 + m.x29/(0.001 + 0.999*m.b70)))*(0.001 + 0.999*m.b70)
                         <= 0)
...
m.c35 = Constraint(expr=(m.x45/(0.001 + 0.999*m.b72) - 1.5*log(1 + m.x37/(0.001 + 0.999*m.b72)))*(0.001 + 0.999*m.b72)
                         <= 0)
...
m.c58 = Constraint(expr=(m.x59/(0.001 + 0.999*m.b74) - 1.25*log(1 + m.x51/(0.001 + 0.999*m.b74)))*(0.001 + 0.999*m.b74)
                         <= 0)
...
m.c67 = Constraint(expr=(m.x61/(0.001 + 0.999*m.b75) - 0.9*log(1 + m.x53/(0.001 + 0.999*m.b75)))*(0.001 + 0.999*m.b75)
                         <= 0)
...
m.c76 = Constraint(expr=(m.x63/(0.001 + 0.999*m.b76) - log(1 + m.x46/(0.001 + 0.999*m.b76)))*(0.001 + 0.999*m.b76) <= 0)
