...
m.c26 = Constraint(expr=(m.x158/(0.001 + 0.999*m.b310) - log(1 + m.x142/(0.001 + 0.999*m.b310)))*(0.001 + 0.999*m.b310)
                         <= 0)

m.c27 = Constraint(expr=(m.x159/(0.001 + 0.999*m.b311) - log(1 + m.x143/(0.001 + 0.999*m.b311)))*(0.001 + 0.999*m.b311)
                         <= 0)

m.c28 = Constraint(expr=(m.x160/(0.001 + 0.999*m.b312) - log(1 + m.x144/(0.001 + 0.999*m.b312)))*(0.001 + 0.999*m.b312)
                         <= 0)

m.c29 = Constraint(expr=(m.x161/(0.001 + 0.999*m.b313) - log(1 + m.x145/(0.001 + 0.999*m.b313)))*(0.001 + 0.999*m.b313)
                         <= 0)
...
m.c62 = Constraint(expr=(m.x166/(0.001 + 0.999*m.b314) - 1.2*log(1 + m.x150/(0.001 + 0.999*m.b314)))*(0.001 + 0.999*
                        m.b314) <= 0)

m.c63 = Constraint(expr=(m.x167/(0.001 + 0.999*m.b315) - 1.2*log(1 + m.x151/(0.001 + 0.999*m.b315)))*(0.001 + 0.999*
                        m.b315) <= 0)

m.c64 = Constraint(expr=(m.x168/(0.001 + 0.999*m.b316) - 1.2*log(1 + m.x152/(0.001 + 0.999*m.b316)))*(0.001 + 0.999*
                        m.b316) <= 0)

m.c65 = Constraint(expr=(m.x169/(0.001 + 0.999*m.b317) - 1.2*log(1 + m.x153/(0.001 + 0.999*m.b317)))*(0.001 + 0.999*
                        m.b317) <= 0)
...
m.c134 = Constraint(expr=(m.x214/(0.001 + 0.999*m.b322) - 1.5*log(1 + m.x182/(0.001 + 0.999*m.b322)))*(0.001 + 0.999*
                         m.b322) <= 0)

m.c135 = Constraint(expr=(m.x215/(0.001 + 0.999*m.b323) - 1.5*log(1 + m.x183/(0.001 + 0.999*m.b323)))*(0.001 + 0.999*
                         m.b323) <= 0)

m.c136 = Constraint(expr=(m.x216/(0.001 + 0.999*m.b324) - 1.5*log(1 + m.x184/(0.001 + 0.999*m.b324)))*(0.001 + 0.999*
                         m.b324) <= 0)

m.c137 = Constraint(expr=(m.x217/(0.001 + 0.999*m.b325) - 1.5*log(1 + m.x185/(0.001 + 0.999*m.b325)))*(0.001 + 0.999*
                         m.b325) <= 0)
...
m.c226 = Constraint(expr=(m.x270/(0.001 + 0.999*m.b330) - 1.25*log(1 + m.x238/(0.001 + 0.999*m.b330)))*(0.001 + 0.999*
                         m.b330) <= 0)

m.c227 = Constraint(expr=(m.x271/(0.001 + 0.999*m.b331) - 1.25*log(1 + m.x239/(0.001 + 0.999*m.b331)))*(0.001 + 0.999*
                         m.b331) <= 0)

m.c228 = Constraint(expr=(m.x272/(0.001 + 0.999*m.b332) - 1.25*log(1 + m.x240/(0.001 + 0.999*m.b332)))*(0.001 + 0.999*
                         m.b332) <= 0)

m.c229 = Constraint(expr=(m.x273/(0.001 + 0.999*m.b333) - 1.25*log(1 + m.x241/(0.001 + 0.999*m.b333)))*(0.001 + 0.999*
                         m.b333) <= 0)
...
m.c262 = Constraint(expr=(m.x278/(0.001 + 0.999*m.b334) - 0.9*log(1 + m.x246/(0.001 + 0.999*m.b334)))*(0.001 + 0.999*
                         m.b334) <= 0)

m.c263 = Constraint(expr=(m.x279/(0.001 + 0.999*m.b335) - 0.9*log(1 + m.x247/(0.001 + 0.999*m.b335)))*(0.001 + 0.999*
                         m.b335) <= 0)

m.c264 = Constraint(expr=(m.x280/(0.001 + 0.999*m.b336) - 0.9*log(1 + m.x248/(0.001 + 0.999*m.b336)))*(0.001 + 0.999*
                         m.b336) <= 0)

m.c265 = Constraint(expr=(m.x281/(0.001 + 0.999*m.b337) - 0.9*log(1 + m.x249/(0.001 + 0.999*m.b337)))*(0.001 + 0.999*
                         m.b337) <= 0)
...
m.c298 = Constraint(expr=(m.x286/(0.001 + 0.999*m.b338) - log(1 + m.x218/(0.001 + 0.999*m.b338)))*(0.001 + 0.999*m.b338)
                          <= 0)

m.c299 = Constraint(expr=(m.x287/(0.001 + 0.999*m.b339) - log(1 + m.x219/(0.001 + 0.999*m.b339)))*(0.001 + 0.999*m.b339)
                          <= 0)

m.c300 = Constraint(expr=(m.x288/(0.001 + 0.999*m.b340) - log(1 + m.x220/(0.001 + 0.999*m.b340)))*(0.001 + 0.999*m.b340)
                          <= 0)

m.c301 = Constraint(expr=(m.x289/(0.001 + 0.999*m.b341) - log(1 + m.x221/(0.001 + 0.999*m.b341)))*(0.001 + 0.999*m.b341)
                          <= 0)
