#  MINLP written by GAMS Convert at 01/15/21 11:37:30
#  
#  Equation counts
#      Total        E        G        L        N        X        C        B
...
m.c20 = Constraint(expr=(m.x119/(0.001 + 0.999*m.b233) - log(1 + m.x107/(0.001 + 0.999*m.b233)))*(0.001 + 0.999*m.b233)
                         <= 0)

m.c21 = Constraint(expr=(m.x120/(0.001 + 0.999*m.b234) - log(1 + m.x108/(0.001 + 0.999*m.b234)))*(0.001 + 0.999*m.b234)
                         <= 0)

m.c22 = Constraint(expr=(m.x121/(0.001 + 0.999*m.b235) - log(1 + m.x109/(0.001 + 0.999*m.b235)))*(0.001 + 0.999*m.b235)
                         <= 0)
...
m.c47 = Constraint(expr=(m.x125/(0.001 + 0.999*m.b236) - 1.2*log(1 + m.x113/(0.001 + 0.999*m.b236)))*(0.001 + 0.999*
                        m.b236) <= 0)

m.c48 = Constraint(expr=(m.x126/(0.001 + 0.999*m.b237) - 1.2*log(1 + m.x114/(0.001 + 0.999*m.b237)))*(0.001 + 0.999*
                        m.b237) <= 0)

m.c49 = Constraint(expr=(m.x127/(0.001 + 0.999*m.b238) - 1.2*log(1 + m.x115/(0.001 + 0.999*m.b238)))*(0.001 + 0.999*
                        m.b238) <= 0)
...
m.c101 = Constraint(expr=(m.x161/(0.001 + 0.999*m.b242) - 1.5*log(1 + m.x137/(0.001 + 0.999*m.b242)))*(0.001 + 0.999*
                         m.b242) <= 0)

m.c102 = Constraint(expr=(m.x162/(0.001 + 0.999*m.b243) - 1.5*log(1 + m.x138/(0.001 + 0.999*m.b243)))*(0.001 + 0.999*
                         m.b243) <= 0)

m.c103 = Constraint(expr=(m.x163/(0.001 + 0.999*m.b244) - 1.5*log(1 + m.x139/(0.001 + 0.999*m.b244)))*(0.001 + 0.999*
                         m.b244) <= 0)
...
m.c170 = Constraint(expr=(m.x203/(0.001 + 0.999*m.b248) - 1.25*log(1 + m.x179/(0.001 + 0.999*m.b248)))*(0.001 + 0.999*
                         m.b248) <= 0)

m.c171 = Constraint(expr=(m.x204/(0.001 + 0.999*m.b249) - 1.25*log(1 + m.x180/(0.001 + 0.999*m.b249)))*(0.001 + 0.999*
                         m.b249) <= 0)

m.c172 = Constraint(expr=(m.x205/(0.001 + 0.999*m.b250) - 1.25*log(1 + m.x181/(0.001 + 0.999*m.b250)))*(0.001 + 0.999*
                         m.b250) <= 0)
...
m.c197 = Constraint(expr=(m.x209/(0.001 + 0.999*m.b251) - 0.9*log(1 + m.x185/(0.001 + 0.999*m.b251)))*(0.001 + 0.999*
                         m.b251) <= 0)

m.c198 = Constraint(expr=(m.x210/(0.001 + 0.999*m.b252) - 0.9*log(1 + m.x186/(0.001 + 0.999*m.b252)))*(0.001 + 0.999*
                         m.b252) <= 0)

m.c199 = Constraint(expr=(m.x211/(0.001 + 0.999*m.b253) - 0.9*log(1 + m.x187/(0.001 + 0.999*m.b253)))*(0.001 + 0.999*
                         m.b253) <= 0)
...
m.c224 = Constraint(expr=(m.x215/(0.001 + 0.999*m.b254) - log(1 + m.x164/(0.001 + 0.999*m.b254)))*(0.001 + 0.999*m.b254)
                          <= 0)

m.c225 = Constraint(expr=(m.x216/(0.001 + 0.999*m.b255) - log(1 + m.x165/(0.001 + 0.999*m.b255)))*(0.001 + 0.999*m.b255)
                          <= 0)

m.c226 = Constraint(expr=(m.x217/(0.001 + 0.999*m.b256) - log(1 + m.x166/(0.001 + 0.999*m.b256)))*(0.001 + 0.999*m.b256)
                          <= 0)
