...
m.c1469 = Constraint(expr=(m.x1013/(0.001 + 0.999*m.b1127) - log(1 + m.x1001/(0.001 + 0.999*m.b1127)))*(0.001 + 0.999*
                          m.b1127) <= 0)

m.c1470 = Constraint(expr=(m.x1014/(0.001 + 0.999*m.b1128) - log(1 + m.x1002/(0.001 + 0.999*m.b1128)))*(0.001 + 0.999*
                          m.b1128) <= 0)

m.c1471 = Constraint(expr=(m.x1015/(0.001 + 0.999*m.b1129) - log(1 + m.x1003/(0.001 + 0.999*m.b1129)))*(0.001 + 0.999*
                          m.b1129) <= 0)
...
m.c1496 = Constraint(expr=(m.x1019/(0.001 + 0.999*m.b1130) - 1.2*log(1 + m.x1007/(0.001 + 0.999*m.b1130)))*(0.001 + 
                          0.999*m.b1130) <= 0)

m.c1497 = Constraint(expr=(m.x1020/(0.001 + 0.999*m.b1131) - 1.2*log(1 + m.x1008/(0.001 + 0.999*m.b1131)))*(0.001 + 
                          0.999*m.b1131) <= 0)

m.c1498 = Constraint(expr=(m.x1021/(0.001 + 0.999*m.b1132) - 1.2*log(1 + m.x1009/(0.001 + 0.999*m.b1132)))*(0.001 + 
                          0.999*m.b1132) <= 0)
...
m.c1550 = Constraint(expr=(m.x1055/(0.001 + 0.999*m.b1136) - 1.5*log(1 + m.x1031/(0.001 + 0.999*m.b1136)))*(0.001 + 
                          0.999*m.b1136) <= 0)

m.c1551 = Constraint(expr=(m.x1056/(0.001 + 0.999*m.b1137) - 1.5*log(1 + m.x1032/(0.001 + 0.999*m.b1137)))*(0.001 + 
                          0.999*m.b1137) <= 0)

m.c1552 = Constraint(expr=(m.x1057/(0.001 + 0.999*m.b1138) - 1.5*log(1 + m.x1033/(0.001 + 0.999*m.b1138)))*(0.001 + 
                          0.999*m.b1138) <= 0)
...
m.c1619 = Constraint(expr=(m.x1097/(0.001 + 0.999*m.b1142) - 1.25*log(1 + m.x1073/(0.001 + 0.999*m.b1142)))*(0.001 + 
                          0.999*m.b1142) <= 0)

m.c1620 = Constraint(expr=(m.x1098/(0.001 + 0.999*m.b1143) - 1.25*log(1 + m.x1074/(0.001 + 0.999*m.b1143)))*(0.001 + 
                          0.999*m.b1143) <= 0)

m.c1621 = Constraint(expr=(m.x1099/(0.001 + 0.999*m.b1144) - 1.25*log(1 + m.x1075/(0.001 + 0.999*m.b1144)))*(0.001 + 
                          0.999*m.b1144) <= 0)
...
m.c1646 = Constraint(expr=(m.x1103/(0.001 + 0.999*m.b1145) - 0.9*log(1 + m.x1079/(0.001 + 0.999*m.b1145)))*(0.001 + 
                          0.999*m.b1145) <= 0)

m.c1647 = Constraint(expr=(m.x1104/(0.001 + 0.999*m.b1146) - 0.9*log(1 + m.x1080/(0.001 + 0.999*m.b1146)))*(0.001 + 
                          0.999*m.b1146) <= 0)

m.c1648 = Constraint(expr=(m.x1105/(0.001 + 0.999*m.b1147) - 0.9*log(1 + m.x1081/(0.001 + 0.999*m.b1147)))*(0.001 + 
                          0.999*m.b1147) <= 0)
...
m.c1673 = Constraint(expr=(m.x1109/(0.001 + 0.999*m.b1148) - log(1 + m.x1058/(0.001 + 0.999*m.b1148)))*(0.001 + 0.999*
                          m.b1148) <= 0)

m.c1674 = Constraint(expr=(m.x1110/(0.001 + 0.999*m.b1149) - log(1 + m.x1059/(0.001 + 0.999*m.b1149)))*(0.001 + 0.999*
                          m.b1149) <= 0)

m.c1675 = Constraint(expr=(m.x1111/(0.001 + 0.999*m.b1150) - log(1 + m.x1060/(0.001 + 0.999*m.b1150)))*(0.001 + 0.999*
                          m.b1150) <= 0)
