...
m.x264 = Var(within=Reals,initialize=0)
m.x265 = Var(within=Reals,initialize=0)
m.x266 = Var(within=Reals,initialize=0)
m.x267 = Var(within=Reals,initialize=0)
m.x268 = Var(within=Reals,initialize=0)
m.x269 = Var(within=Reals,initialize=0)
m.x270 = Var(within=Reals,initialize=0)
