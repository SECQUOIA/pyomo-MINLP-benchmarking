...
m.c154 = Constraint(expr=(m.x218/(0.001 + 0.999*m.b410) - 0.9*log(1 + m.x194/(0.001 + 0.999*m.b410)))*(0.001 + 0.999*
                         m.b410) <= 0)

m.c155 = Constraint(expr=(m.x219/(0.001 + 0.999*m.b411) - 0.9*log(1 + m.x195/(0.001 + 0.999*m.b411)))*(0.001 + 0.999*
                         m.b411) <= 0)
...
m.c172 = Constraint(expr=(m.x226/(0.001 + 0.999*m.b412) - log(1 + m.x180/(0.001 + 0.999*m.b412)))*(0.001 + 0.999*m.b412)
                          <= 0)

m.c173 = Constraint(expr=(m.x227/(0.001 + 0.999*m.b413) - log(1 + m.x181/(0.001 + 0.999*m.b413)))*(0.001 + 0.999*m.b413)
                          <= 0)
...
m.c226 = Constraint(expr=(m.x238/(0.001 + 0.999*m.b418) - 1.1*log(1 + m.x206/(0.001 + 0.999*m.b418)))*(0.001 + 0.999*
                         m.b418) <= 0)

m.c227 = Constraint(expr=(m.x239/(0.001 + 0.999*m.b419) - 1.1*log(1 + m.x207/(0.001 + 0.999*m.b419)))*(0.001 + 0.999*
                         m.b419) <= 0)
...
m.c272 = Constraint(expr=(m.x282/(0.001 + 0.999*m.b422) - log(1 + m.x220/(0.001 + 0.999*m.b422)))*(0.001 + 0.999*m.b422)
                          <= 0)

m.c273 = Constraint(expr=(m.x283/(0.001 + 0.999*m.b423) - log(1 + m.x221/(0.001 + 0.999*m.b423)))*(0.001 + 0.999*m.b423)
                          <= 0)
...
m.c290 = Constraint(expr=(m.x286/(0.001 + 0.999*m.b424) - 0.7*log(1 + m.x242/(0.001 + 0.999*m.b424)))*(0.001 + 0.999*
                         m.b424) <= 0)

m.c291 = Constraint(expr=(m.x287/(0.001 + 0.999*m.b425) - 0.7*log(1 + m.x243/(0.001 + 0.999*m.b425)))*(0.001 + 0.999*
                         m.b425) <= 0)
...
m.c308 = Constraint(expr=(m.x290/(0.001 + 0.999*m.b426) - 0.65*log(1 + m.x246/(0.001 + 0.999*m.b426)))*(0.001 + 0.999*
                         m.b426) <= 0)

m.c309 = Constraint(expr=(m.x291/(0.001 + 0.999*m.b427) - 0.65*log(1 + m.x247/(0.001 + 0.999*m.b427)))*(0.001 + 0.999*
                         m.b427) <= 0)

m.c310 = Constraint(expr=(m.x290/(0.001 + 0.999*m.b426) - 0.65*log(1 + m.x254/(0.001 + 0.999*m.b426)))*(0.001 + 0.999*
                         m.b426) <= 0)

m.c311 = Constraint(expr=(m.x291/(0.001 + 0.999*m.b427) - 0.65*log(1 + m.x255/(0.001 + 0.999*m.b427)))*(0.001 + 0.999*
                         m.b427) <= 0)
...
m.c372 = Constraint(expr=(m.x302/(0.001 + 0.999*m.b432) - 0.75*log(1 + m.x266/(0.001 + 0.999*m.b432)))*(0.001 + 0.999*
                         m.b432) <= 0)

m.c373 = Constraint(expr=(m.x303/(0.001 + 0.999*m.b433) - 0.75*log(1 + m.x267/(0.001 + 0.999*m.b433)))*(0.001 + 0.999*
                         m.b433) <= 0)
...
m.c390 = Constraint(expr=(m.x306/(0.001 + 0.999*m.b434) - 0.8*log(1 + m.x270/(0.001 + 0.999*m.b434)))*(0.001 + 0.999*
                         m.b434) <= 0)

m.c391 = Constraint(expr=(m.x307/(0.001 + 0.999*m.b435) - 0.8*log(1 + m.x271/(0.001 + 0.999*m.b435)))*(0.001 + 0.999*
                         m.b435) <= 0)
...
m.c408 = Constraint(expr=(m.x310/(0.001 + 0.999*m.b436) - 0.85*log(1 + m.x274/(0.001 + 0.999*m.b436)))*(0.001 + 0.999*
                         m.b436) <= 0)

m.c409 = Constraint(expr=(m.x311/(0.001 + 0.999*m.b437) - 0.85*log(1 + m.x275/(0.001 + 0.999*m.b437)))*(0.001 + 0.999*
                         m.b437) <= 0)
...
m.c426 = Constraint(expr=(m.x322/(0.001 + 0.999*m.b438) - log(1 + m.x314/(0.001 + 0.999*m.b438)))*(0.001 + 0.999*m.b438)
                          <= 0)

m.c427 = Constraint(expr=(m.x323/(0.001 + 0.999*m.b439) - log(1 + m.x315/(0.001 + 0.999*m.b439)))*(0.001 + 0.999*m.b439)
                          <= 0)
...
m.c444 = Constraint(expr=(m.x326/(0.001 + 0.999*m.b440) - 1.2*log(1 + m.x318/(0.001 + 0.999*m.b440)))*(0.001 + 0.999*
                         m.b440) <= 0)

m.c445 = Constraint(expr=(m.x327/(0.001 + 0.999*m.b441) - 1.2*log(1 + m.x319/(0.001 + 0.999*m.b441)))*(0.001 + 0.999*
                         m.b441) <= 0)
...
m.c480 = Constraint(expr=(m.x350/(0.001 + 0.999*m.b444) - 1.5*log(1 + m.x334/(0.001 + 0.999*m.b444)))*(0.001 + 0.999*
                         m.b444) <= 0)

m.c481 = Constraint(expr=(m.x351/(0.001 + 0.999*m.b445) - 1.5*log(1 + m.x335/(0.001 + 0.999*m.b445)))*(0.001 + 0.999*
                         m.b445) <= 0)
...
m.c526 = Constraint(expr=(m.x378/(0.001 + 0.999*m.b448) - 1.25*log(1 + m.x362/(0.001 + 0.999*m.b448)))*(0.001 + 0.999*
                         m.b448) <= 0)

m.c527 = Constraint(expr=(m.x379/(0.001 + 0.999*m.b449) - 1.25*log(1 + m.x363/(0.001 + 0.999*m.b449)))*(0.001 + 0.999*
                         m.b449) <= 0)
...
m.c544 = Constraint(expr=(m.x382/(0.001 + 0.999*m.b450) - 0.9*log(1 + m.x366/(0.001 + 0.999*m.b450)))*(0.001 + 0.999*
                         m.b450) <= 0)

m.c545 = Constraint(expr=(m.x383/(0.001 + 0.999*m.b451) - 0.9*log(1 + m.x367/(0.001 + 0.999*m.b451)))*(0.001 + 0.999*
                         m.b451) <= 0)
...
m.c562 = Constraint(expr=(m.x386/(0.001 + 0.999*m.b452) - log(1 + m.x352/(0.001 + 0.999*m.b452)))*(0.001 + 0.999*m.b452)
                          <= 0)

m.c563 = Constraint(expr=(m.x387/(0.001 + 0.999*m.b453) - log(1 + m.x353/(0.001 + 0.999*m.b453)))*(0.001 + 0.999*m.b453)
                          <= 0)
