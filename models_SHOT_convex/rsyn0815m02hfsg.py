...
m.c916 = Constraint(expr=(m.x716/(0.001 + 0.999*m.b840) - log(1 + m.x708/(0.001 + 0.999*m.b840)))*(0.001 + 0.999*m.b840)
                          <= 0)

m.c917 = Constraint(expr=(m.x717/(0.001 + 0.999*m.b841) - log(1 + m.x709/(0.001 + 0.999*m.b841)))*(0.001 + 0.999*m.b841)
                          <= 0)
...
m.c934 = Constraint(expr=(m.x720/(0.001 + 0.999*m.b842) - 1.2*log(1 + m.x712/(0.001 + 0.999*m.b842)))*(0.001 + 0.999*
                         m.b842) <= 0)

m.c935 = Constraint(expr=(m.x721/(0.001 + 0.999*m.b843) - 1.2*log(1 + m.x713/(0.001 + 0.999*m.b843)))*(0.001 + 0.999*
                         m.b843) <= 0)
...
m.c970 = Constraint(expr=(m.x744/(0.001 + 0.999*m.b846) - 1.5*log(1 + m.x728/(0.001 + 0.999*m.b846)))*(0.001 + 0.999*
                         m.b846) <= 0)

m.c971 = Constraint(expr=(m.x745/(0.001 + 0.999*m.b847) - 1.5*log(1 + m.x729/(0.001 + 0.999*m.b847)))*(0.001 + 0.999*
                         m.b847) <= 0)
...
m.c1016 = Constraint(expr=(m.x776/(0.001 + 0.999*m.b850) - 1.25*log(1 + m.x756/(0.001 + 0.999*m.b850)))*(0.001 + 0.999*
                          m.b850) <= 0)

m.c1017 = Constraint(expr=(m.x777/(0.001 + 0.999*m.b851) - 1.25*log(1 + m.x757/(0.001 + 0.999*m.b851)))*(0.001 + 0.999*
                          m.b851) <= 0)
...
m.c1034 = Constraint(expr=(m.x784/(0.001 + 0.999*m.b852) - 0.9*log(1 + m.x760/(0.001 + 0.999*m.b852)))*(0.001 + 0.999*
                          m.b852) <= 0)

m.c1035 = Constraint(expr=(m.x785/(0.001 + 0.999*m.b853) - 0.9*log(1 + m.x761/(0.001 + 0.999*m.b853)))*(0.001 + 0.999*
                          m.b853) <= 0)
...
m.c1052 = Constraint(expr=(m.x792/(0.001 + 0.999*m.b854) - log(1 + m.x746/(0.001 + 0.999*m.b854)))*(0.001 + 0.999*m.b854
                          ) <= 0)

m.c1053 = Constraint(expr=(m.x793/(0.001 + 0.999*m.b855) - log(1 + m.x747/(0.001 + 0.999*m.b855)))*(0.001 + 0.999*m.b855
                          ) <= 0)
...
m.c1106 = Constraint(expr=(m.x804/(0.001 + 0.999*m.b860) - 1.1*log(1 + m.x772/(0.001 + 0.999*m.b860)))*(0.001 + 0.999*
                          m.b860) <= 0)

m.c1107 = Constraint(expr=(m.x805/(0.001 + 0.999*m.b861) - 1.1*log(1 + m.x773/(0.001 + 0.999*m.b861)))*(0.001 + 0.999*
                          m.b861) <= 0)
...
m.c1152 = Constraint(expr=(m.x828/(0.001 + 0.999*m.b864) - log(1 + m.x786/(0.001 + 0.999*m.b864)))*(0.001 + 0.999*m.b864
                          ) <= 0)

m.c1153 = Constraint(expr=(m.x829/(0.001 + 0.999*m.b865) - log(1 + m.x787/(0.001 + 0.999*m.b865)))*(0.001 + 0.999*m.b865
                          ) <= 0)
...
m.c1170 = Constraint(expr=(m.x832/(0.001 + 0.999*m.b866) - 0.7*log(1 + m.x808/(0.001 + 0.999*m.b866)))*(0.001 + 0.999*
                          m.b866) <= 0)

m.c1171 = Constraint(expr=(m.x833/(0.001 + 0.999*m.b867) - 0.7*log(1 + m.x809/(0.001 + 0.999*m.b867)))*(0.001 + 0.999*
                          m.b867) <= 0)
...
m.c1188 = Constraint(expr=(m.x836/(0.001 + 0.999*m.b868) - 0.65*log(1 + m.x812/(0.001 + 0.999*m.b868)))*(0.001 + 0.999*
                          m.b868) <= 0)

m.c1189 = Constraint(expr=(m.x837/(0.001 + 0.999*m.b869) - 0.65*log(1 + m.x813/(0.001 + 0.999*m.b869)))*(0.001 + 0.999*
                          m.b869) <= 0)

m.c1190 = Constraint(expr=(m.x836/(0.001 + 0.999*m.b868) - 0.65*log(1 + m.x820/(0.001 + 0.999*m.b868)))*(0.001 + 0.999*
                          m.b868) <= 0)

m.c1191 = Constraint(expr=(m.x837/(0.001 + 0.999*m.b869) - 0.65*log(1 + m.x821/(0.001 + 0.999*m.b869)))*(0.001 + 0.999*
                          m.b869) <= 0)
