...
m.c377 = Constraint(expr=(m.x287/(0.001 + 0.999*m.b305) - log(1 + m.x283/(0.001 + 0.999*m.b305)))*(0.001 + 0.999*m.b305)
                          <= 0)
...
m.c386 = Constraint(expr=(m.x289/(0.001 + 0.999*m.b306) - 1.2*log(1 + m.x285/(0.001 + 0.999*m.b306)))*(0.001 + 0.999*
                         m.b306) <= 0)
...
m.c404 = Constraint(expr=(m.x301/(0.001 + 0.999*m.b308) - 1.5*log(1 + m.x293/(0.001 + 0.999*m.b308)))*(0.001 + 0.999*
                         m.b308) <= 0)
