...
m.c6 = Constraint(expr=(m.x21/(0.001 + 0.999*m.b39) - log(1 + m.x17/(0.001 + 0.999*m.b39)))*(0.001 + 0.999*m.b39) <= 0)
...
m.c15 = Constraint(expr=(m.x23/(0.001 + 0.999*m.b40) - 1.2*log(1 + m.x19/(0.001 + 0.999*m.b40)))*(0.001 + 0.999*m.b40)
                         <= 0)
...
m.c33 = Constraint(expr=(m.x35/(0.001 + 0.999*m.b42) - 1.5*log(1 + m.x27/(0.001 + 0.999*m.b42)))*(0.001 + 0.999*m.b42)
                         <= 0)
