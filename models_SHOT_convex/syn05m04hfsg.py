...
m.c18 = Constraint(expr=(m.x98/(0.001 + 0.999*m.b170) - log(1 + m.x82/(0.001 + 0.999*m.b170)))*(0.001 + 0.999*m.b170)
                         <= 0)

m.c19 = Constraint(expr=(m.x99/(0.001 + 0.999*m.b171) - log(1 + m.x83/(0.001 + 0.999*m.b171)))*(0.001 + 0.999*m.b171)
                         <= 0)

m.c20 = Constraint(expr=(m.x100/(0.001 + 0.999*m.b172) - log(1 + m.x84/(0.001 + 0.999*m.b172)))*(0.001 + 0.999*m.b172)
                         <= 0)

m.c21 = Constraint(expr=(m.x101/(0.001 + 0.999*m.b173) - log(1 + m.x85/(0.001 + 0.999*m.b173)))*(0.001 + 0.999*m.b173)
                         <= 0)
...
m.c54 = Constraint(expr=(m.x106/(0.001 + 0.999*m.b174) - 1.2*log(1 + m.x90/(0.001 + 0.999*m.b174)))*(0.001 + 0.999*
                        m.b174) <= 0)

m.c55 = Constraint(expr=(m.x107/(0.001 + 0.999*m.b175) - 1.2*log(1 + m.x91/(0.001 + 0.999*m.b175)))*(0.001 + 0.999*
                        m.b175) <= 0)

m.c56 = Constraint(expr=(m.x108/(0.001 + 0.999*m.b176) - 1.2*log(1 + m.x92/(0.001 + 0.999*m.b176)))*(0.001 + 0.999*
                        m.b176) <= 0)

m.c57 = Constraint(expr=(m.x109/(0.001 + 0.999*m.b177) - 1.2*log(1 + m.x93/(0.001 + 0.999*m.b177)))*(0.001 + 0.999*
                        m.b177) <= 0)
...
m.c126 = Constraint(expr=(m.x154/(0.001 + 0.999*m.b182) - 1.5*log(1 + m.x122/(0.001 + 0.999*m.b182)))*(0.001 + 0.999*
                         m.b182) <= 0)

m.c127 = Constraint(expr=(m.x155/(0.001 + 0.999*m.b183) - 1.5*log(1 + m.x123/(0.001 + 0.999*m.b183)))*(0.001 + 0.999*
                         m.b183) <= 0)

m.c128 = Constraint(expr=(m.x156/(0.001 + 0.999*m.b184) - 1.5*log(1 + m.x124/(0.001 + 0.999*m.b184)))*(0.001 + 0.999*
                         m.b184) <= 0)

m.c129 = Constraint(expr=(m.x157/(0.001 + 0.999*m.b185) - 1.5*log(1 + m.x125/(0.001 + 0.999*m.b185)))*(0.001 + 0.999*
                         m.b185) <= 0)
