...
m.c379 = Constraint(expr=(m.x297/(0.001 + 0.999*m.b335) - log(1 + m.x293/(0.001 + 0.999*m.b335)))*(0.001 + 0.999*m.b335)
                          <= 0)
...
m.c388 = Constraint(expr=(m.x299/(0.001 + 0.999*m.b336) - 1.2*log(1 + m.x295/(0.001 + 0.999*m.b336)))*(0.001 + 0.999*
                         m.b336) <= 0)
...
m.c406 = Constraint(expr=(m.x311/(0.001 + 0.999*m.b338) - 1.5*log(1 + m.x303/(0.001 + 0.999*m.b338)))*(0.001 + 0.999*
                         m.b338) <= 0)
...
m.c429 = Constraint(expr=(m.x325/(0.001 + 0.999*m.b340) - 1.25*log(1 + m.x317/(0.001 + 0.999*m.b340)))*(0.001 + 0.999*
                         m.b340) <= 0)
...
m.c438 = Constraint(expr=(m.x327/(0.001 + 0.999*m.b341) - 0.9*log(1 + m.x319/(0.001 + 0.999*m.b341)))*(0.001 + 0.999*
                         m.b341) <= 0)
...
m.c447 = Constraint(expr=(m.x329/(0.001 + 0.999*m.b342) - log(1 + m.x312/(0.001 + 0.999*m.b342)))*(0.001 + 0.999*m.b342)
                          <= 0)
