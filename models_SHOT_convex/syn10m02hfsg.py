...
m.c14 = Constraint(expr=(m.x80/(0.001 + 0.999*m.b156) - log(1 + m.x72/(0.001 + 0.999*m.b156)))*(0.001 + 0.999*m.b156)
                         <= 0)

m.c15 = Constraint(expr=(m.x81/(0.001 + 0.999*m.b157) - log(1 + m.x73/(0.001 + 0.999*m.b157)))*(0.001 + 0.999*m.b157)
                         <= 0)
...
m.c32 = Constraint(expr=(m.x84/(0.001 + 0.999*m.b158) - 1.2*log(1 + m.x76/(0.001 + 0.999*m.b158)))*(0.001 + 0.999*m.b158
                        ) <= 0)

m.c33 = Constraint(expr=(m.x85/(0.001 + 0.999*m.b159) - 1.2*log(1 + m.x77/(0.001 + 0.999*m.b159)))*(0.001 + 0.999*m.b159
                        ) <= 0)
...
m.c68 = Constraint(expr=(m.x108/(0.001 + 0.999*m.b162) - 1.5*log(1 + m.x92/(0.001 + 0.999*m.b162)))*(0.001 + 0.999*
                        m.b162) <= 0)

m.c69 = Constraint(expr=(m.x109/(0.001 + 0.999*m.b163) - 1.5*log(1 + m.x93/(0.001 + 0.999*m.b163)))*(0.001 + 0.999*
                        m.b163) <= 0)
...
m.c114 = Constraint(expr=(m.x136/(0.001 + 0.999*m.b166) - 1.25*log(1 + m.x120/(0.001 + 0.999*m.b166)))*(0.001 + 0.999*
                         m.b166) <= 0)

m.c115 = Constraint(expr=(m.x137/(0.001 + 0.999*m.b167) - 1.25*log(1 + m.x121/(0.001 + 0.999*m.b167)))*(0.001 + 0.999*
                         m.b167) <= 0)
...
m.c132 = Constraint(expr=(m.x140/(0.001 + 0.999*m.b168) - 0.9*log(1 + m.x124/(0.001 + 0.999*m.b168)))*(0.001 + 0.999*
                         m.b168) <= 0)

m.c133 = Constraint(expr=(m.x141/(0.001 + 0.999*m.b169) - 0.9*log(1 + m.x125/(0.001 + 0.999*m.b169)))*(0.001 + 0.999*
                         m.b169) <= 0)
...
m.c150 = Constraint(expr=(m.x144/(0.001 + 0.999*m.b170) - log(1 + m.x110/(0.001 + 0.999*m.b170)))*(0.001 + 0.999*m.b170)
                          <= 0)

m.c151 = Constraint(expr=(m.x145/(0.001 + 0.999*m.b171) - log(1 + m.x111/(0.001 + 0.999*m.b171)))*(0.001 + 0.999*m.b171)
                          <= 0)
