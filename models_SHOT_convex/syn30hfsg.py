...
m.c19 = Constraint(expr=(m.x76/(0.001 + 0.999*m.b200) - log(1 + m.x72/(0.001 + 0.999*m.b200)))*(0.001 + 0.999*m.b200)
                         <= 0)
...
m.c28 = Constraint(expr=(m.x78/(0.001 + 0.999*m.b201) - 1.2*log(1 + m.x74/(0.001 + 0.999*m.b201)))*(0.001 + 0.999*m.b201
                        ) <= 0)
...
m.c46 = Constraint(expr=(m.x90/(0.001 + 0.999*m.b203) - 1.5*log(1 + m.x82/(0.001 + 0.999*m.b203)))*(0.001 + 0.999*m.b203
                        ) <= 0)
...
m.c69 = Constraint(expr=(m.x106/(0.001 + 0.999*m.b205) - 1.25*log(1 + m.x96/(0.001 + 0.999*m.b205)))*(0.001 + 0.999*
                        m.b205) <= 0)
...
m.c78 = Constraint(expr=(m.x110/(0.001 + 0.999*m.b206) - 0.9*log(1 + m.x98/(0.001 + 0.999*m.b206)))*(0.001 + 0.999*
                        m.b206) <= 0)
...
m.c87 = Constraint(expr=(m.x114/(0.001 + 0.999*m.b207) - log(1 + m.x91/(0.001 + 0.999*m.b207)))*(0.001 + 0.999*m.b207)
                         <= 0)
...
m.c114 = Constraint(expr=(m.x120/(0.001 + 0.999*m.b210) - 1.1*log(1 + m.x104/(0.001 + 0.999*m.b210)))*(0.001 + 0.999*
                         m.b210) <= 0)
...
m.c137 = Constraint(expr=(m.x142/(0.001 + 0.999*m.b212) - log(1 + m.x111/(0.001 + 0.999*m.b212)))*(0.001 + 0.999*m.b212)
                          <= 0)
...
m.c146 = Constraint(expr=(m.x144/(0.001 + 0.999*m.b213) - 0.7*log(1 + m.x122/(0.001 + 0.999*m.b213)))*(0.001 + 0.999*
                         m.b213) <= 0)
...
m.c155 = Constraint(expr=(m.x146/(0.001 + 0.999*m.b214) - 0.65*log(1 + m.x124/(0.001 + 0.999*m.b214)))*(0.001 + 0.999*
                         m.b214) <= 0)

m.c156 = Constraint(expr=(m.x146/(0.001 + 0.999*m.b214) - 0.65*log(1 + m.x128/(0.001 + 0.999*m.b214)))*(0.001 + 0.999*
                         m.b214) <= 0)
...
m.c187 = Constraint(expr=(m.x152/(0.001 + 0.999*m.b217) - 0.75*log(1 + m.x134/(0.001 + 0.999*m.b217)))*(0.001 + 0.999*
                         m.b217) <= 0)
...
m.c196 = Constraint(expr=(m.x154/(0.001 + 0.999*m.b218) - 0.8*log(1 + m.x136/(0.001 + 0.999*m.b218)))*(0.001 + 0.999*
                         m.b218) <= 0)
...
m.c205 = Constraint(expr=(m.x156/(0.001 + 0.999*m.b219) - 0.85*log(1 + m.x138/(0.001 + 0.999*m.b219)))*(0.001 + 0.999*
                         m.b219) <= 0)
...
m.c214 = Constraint(expr=(m.x162/(0.001 + 0.999*m.b220) - log(1 + m.x158/(0.001 + 0.999*m.b220)))*(0.001 + 0.999*m.b220)
                          <= 0)
...
m.c223 = Constraint(expr=(m.x164/(0.001 + 0.999*m.b221) - 1.2*log(1 + m.x160/(0.001 + 0.999*m.b221)))*(0.001 + 0.999*
                         m.b221) <= 0)
...
m.c241 = Constraint(expr=(m.x176/(0.001 + 0.999*m.b223) - 1.5*log(1 + m.x168/(0.001 + 0.999*m.b223)))*(0.001 + 0.999*
                         m.b223) <= 0)
...
m.c264 = Constraint(expr=(m.x190/(0.001 + 0.999*m.b225) - 1.25*log(1 + m.x182/(0.001 + 0.999*m.b225)))*(0.001 + 0.999*
                         m.b225) <= 0)
...
m.c273 = Constraint(expr=(m.x192/(0.001 + 0.999*m.b226) - 0.9*log(1 + m.x184/(0.001 + 0.999*m.b226)))*(0.001 + 0.999*
                         m.b226) <= 0)
...
m.c282 = Constraint(expr=(m.x194/(0.001 + 0.999*m.b227) - log(1 + m.x177/(0.001 + 0.999*m.b227)))*(0.001 + 0.999*m.b227)
                          <= 0)
