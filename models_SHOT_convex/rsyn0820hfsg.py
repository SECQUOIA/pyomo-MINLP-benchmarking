...
m.c383 = Constraint(expr=(m.x317/(0.001 + 0.999*m.b399) - log(1 + m.x313/(0.001 + 0.999*m.b399)))*(0.001 + 0.999*m.b399)
                          <= 0)
...
m.c392 = Constraint(expr=(m.x319/(0.001 + 0.999*m.b400) - 1.2*log(1 + m.x315/(0.001 + 0.999*m.b400)))*(0.001 + 0.999*
                         m.b400) <= 0)
...
m.c410 = Constraint(expr=(m.x331/(0.001 + 0.999*m.b402) - 1.5*log(1 + m.x323/(0.001 + 0.999*m.b402)))*(0.001 + 0.999*
                         m.b402) <= 0)
...
m.c433 = Constraint(expr=(m.x347/(0.001 + 0.999*m.b404) - 1.25*log(1 + m.x337/(0.001 + 0.999*m.b404)))*(0.001 + 0.999*
                         m.b404) <= 0)
...
m.c442 = Constraint(expr=(m.x351/(0.001 + 0.999*m.b405) - 0.9*log(1 + m.x339/(0.001 + 0.999*m.b405)))*(0.001 + 0.999*
                         m.b405) <= 0)
...
m.c451 = Constraint(expr=(m.x355/(0.001 + 0.999*m.b406) - log(1 + m.x332/(0.001 + 0.999*m.b406)))*(0.001 + 0.999*m.b406)
                          <= 0)
...
m.c478 = Constraint(expr=(m.x361/(0.001 + 0.999*m.b409) - 1.1*log(1 + m.x345/(0.001 + 0.999*m.b409)))*(0.001 + 0.999*
                         m.b409) <= 0)
...
m.c501 = Constraint(expr=(m.x383/(0.001 + 0.999*m.b411) - log(1 + m.x352/(0.001 + 0.999*m.b411)))*(0.001 + 0.999*m.b411)
                          <= 0)
...
m.c510 = Constraint(expr=(m.x385/(0.001 + 0.999*m.b412) - 0.7*log(1 + m.x363/(0.001 + 0.999*m.b412)))*(0.001 + 0.999*
                         m.b412) <= 0)
...
m.c519 = Constraint(expr=(m.x387/(0.001 + 0.999*m.b413) - 0.65*log(1 + m.x365/(0.001 + 0.999*m.b413)))*(0.001 + 0.999*
                         m.b413) <= 0)

m.c520 = Constraint(expr=(m.x387/(0.001 + 0.999*m.b413) - 0.65*log(1 + m.x369/(0.001 + 0.999*m.b413)))*(0.001 + 0.999*
                         m.b413) <= 0)
...
m.c551 = Constraint(expr=(m.x393/(0.001 + 0.999*m.b416) - 0.75*log(1 + m.x375/(0.001 + 0.999*m.b416)))*(0.001 + 0.999*
                         m.b416) <= 0)
...
m.c560 = Constraint(expr=(m.x395/(0.001 + 0.999*m.b417) - 0.8*log(1 + m.x377/(0.001 + 0.999*m.b417)))*(0.001 + 0.999*
                         m.b417) <= 0)
...
m.c569 = Constraint(expr=(m.x397/(0.001 + 0.999*m.b418) - 0.85*log(1 + m.x379/(0.001 + 0.999*m.b418)))*(0.001 + 0.999*
                         m.b418) <= 0)
