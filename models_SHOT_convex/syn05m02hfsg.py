#  MINLP written by GAMS Convert at 01/15/21 11:37:29
#  
#  Equation counts
#      Total        E        G        L        N        X        C        B
#        152       71        6       75        0        0        0        0
...
m.c10 = Constraint(expr=(m.x50/(0.001 + 0.999*m.b86) - log(1 + m.x42/(0.001 + 0.999*m.b86)))*(0.001 + 0.999*m.b86) <= 0)

m.c11 = Constraint(expr=(m.x51/(0.001 + 0.999*m.b87) - log(1 + m.x43/(0.001 + 0.999*m.b87)))*(0.001 + 0.999*m.b87) <= 0)
...
m.c28 = Constraint(expr=(m.x54/(0.001 + 0.999*m.b88) - 1.2*log(1 + m.x46/(0.001 + 0.999*m.b88)))*(0.001 + 0.999*m.b88)
                         <= 0)

m.c29 = Constraint(expr=(m.x55/(0.001 + 0.999*m.b89) - 1.2*log(1 + m.x47/(0.001 + 0.999*m.b89)))*(0.001 + 0.999*m.b89)
                         <= 0)
...
m.c64 = Constraint(expr=(m.x78/(0.001 + 0.999*m.b92) - 1.5*log(1 + m.x62/(0.001 + 0.999*m.b92)))*(0.001 + 0.999*m.b92)
                         <= 0)

m.c65 = Constraint(expr=(m.x79/(0.001 + 0.999*m.b93) - 1.5*log(1 + m.x63/(0.001 + 0.999*m.b93)))*(0.001 + 0.999*m.b93)
                         <= 0)
