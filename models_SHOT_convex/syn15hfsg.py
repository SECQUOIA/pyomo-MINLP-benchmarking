...
m.c12 = Constraint(expr=(m.x46/(0.001 + 0.999*m.b108) - log(1 + m.x42/(0.001 + 0.999*m.b108)))*(0.001 + 0.999*m.b108)
                         <= 0)
...
m.c21 = Constraint(expr=(m.x48/(0.001 + 0.999*m.b109) - 1.2*log(1 + m.x44/(0.001 + 0.999*m.b109)))*(0.001 + 0.999*m.b109
                        ) <= 0)
...
m.c39 = Constraint(expr=(m.x60/(0.001 + 0.999*m.b111) - 1.5*log(1 + m.x52/(0.001 + 0.999*m.b111)))*(0.001 + 0.999*m.b111
                        ) <= 0)
...
m.c62 = Constraint(expr=(m.x76/(0.001 + 0.999*m.b113) - 1.25*log(1 + m.x66/(0.001 + 0.999*m.b113)))*(0.001 + 0.999*
                        m.b113) <= 0)
...
m.c71 = Constraint(expr=(m.x80/(0.001 + 0.999*m.b114) - 0.9*log(1 + m.x68/(0.001 + 0.999*m.b114)))*(0.001 + 0.999*m.b114
                        ) <= 0)
...
m.c80 = Constraint(expr=(m.x84/(0.001 + 0.999*m.b115) - log(1 + m.x61/(0.001 + 0.999*m.b115)))*(0.001 + 0.999*m.b115)
                         <= 0)
...
m.c107 = Constraint(expr=(m.x90/(0.001 + 0.999*m.b118) - 1.1*log(1 + m.x74/(0.001 + 0.999*m.b118)))*(0.001 + 0.999*
                         m.b118) <= 0)
...
m.c130 = Constraint(expr=(m.x102/(0.001 + 0.999*m.b120) - log(1 + m.x81/(0.001 + 0.999*m.b120)))*(0.001 + 0.999*m.b120)
                          <= 0)
...
m.c139 = Constraint(expr=(m.x104/(0.001 + 0.999*m.b121) - 0.7*log(1 + m.x92/(0.001 + 0.999*m.b121)))*(0.001 + 0.999*
                         m.b121) <= 0)
...
m.c148 = Constraint(expr=(m.x106/(0.001 + 0.999*m.b122) - 0.65*log(1 + m.x94/(0.001 + 0.999*m.b122)))*(0.001 + 0.999*
                         m.b122) <= 0)

m.c149 = Constraint(expr=(m.x106/(0.001 + 0.999*m.b122) - 0.65*log(1 + m.x98/(0.001 + 0.999*m.b122)))*(0.001 + 0.999*
                         m.b122) <= 0)
