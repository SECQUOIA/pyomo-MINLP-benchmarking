#  MINLP written by GAMS Convert at 01/15/21 11:37:22
#  
#  Equation counts
#      Total        E        G        L        N        X        C        B
...
m.c2162 = Constraint(expr=(m.x1570/(0.001 + 0.999*m.b2242) - log(1 + m.x1554/(0.001 + 0.999*m.b2242)))*(0.001 + 0.999*
                          m.b2242) <= 0)

m.c2163 = Constraint(expr=(m.x1571/(0.001 + 0.999*m.b2243) - log(1 + m.x1555/(0.001 + 0.999*m.b2243)))*(0.001 + 0.999*
                          m.b2243) <= 0)

m.c2164 = Constraint(expr=(m.x1572/(0.001 + 0.999*m.b2244) - log(1 + m.x1556/(0.001 + 0.999*m.b2244)))*(0.001 + 0.999*
                          m.b2244) <= 0)

m.c2165 = Constraint(expr=(m.x1573/(0.001 + 0.999*m.b2245) - log(1 + m.x1557/(0.001 + 0.999*m.b2245)))*(0.001 + 0.999*
                          m.b2245) <= 0)
...
m.c2198 = Constraint(expr=(m.x1578/(0.001 + 0.999*m.b2246) - 1.2*log(1 + m.x1562/(0.001 + 0.999*m.b2246)))*(0.001 + 
                          0.999*m.b2246) <= 0)

m.c2199 = Constraint(expr=(m.x1579/(0.001 + 0.999*m.b2247) - 1.2*log(1 + m.x1563/(0.001 + 0.999*m.b2247)))*(0.001 + 
                          0.999*m.b2247) <= 0)

m.c2200 = Constraint(expr=(m.x1580/(0.001 + 0.999*m.b2248) - 1.2*log(1 + m.x1564/(0.001 + 0.999*m.b2248)))*(0.001 + 
                          0.999*m.b2248) <= 0)

m.c2201 = Constraint(expr=(m.x1581/(0.001 + 0.999*m.b2249) - 1.2*log(1 + m.x1565/(0.001 + 0.999*m.b2249)))*(0.001 + 
                          0.999*m.b2249) <= 0)
...
m.c2270 = Constraint(expr=(m.x1626/(0.001 + 0.999*m.b2254) - 1.5*log(1 + m.x1594/(0.001 + 0.999*m.b2254)))*(0.001 + 
                          0.999*m.b2254) <= 0)

m.c2271 = Constraint(expr=(m.x1627/(0.001 + 0.999*m.b2255) - 1.5*log(1 + m.x1595/(0.001 + 0.999*m.b2255)))*(0.001 + 
                          0.999*m.b2255) <= 0)

m.c2272 = Constraint(expr=(m.x1628/(0.001 + 0.999*m.b2256) - 1.5*log(1 + m.x1596/(0.001 + 0.999*m.b2256)))*(0.001 + 
                          0.999*m.b2256) <= 0)

m.c2273 = Constraint(expr=(m.x1629/(0.001 + 0.999*m.b2257) - 1.5*log(1 + m.x1597/(0.001 + 0.999*m.b2257)))*(0.001 + 
                          0.999*m.b2257) <= 0)
...
m.c2362 = Constraint(expr=(m.x1690/(0.001 + 0.999*m.b2262) - 1.25*log(1 + m.x1650/(0.001 + 0.999*m.b2262)))*(0.001 + 
                          0.999*m.b2262) <= 0)

m.c2363 = Constraint(expr=(m.x1691/(0.001 + 0.999*m.b2263) - 1.25*log(1 + m.x1651/(0.001 + 0.999*m.b2263)))*(0.001 + 
                          0.999*m.b2263) <= 0)

m.c2364 = Constraint(expr=(m.x1692/(0.001 + 0.999*m.b2264) - 1.25*log(1 + m.x1652/(0.001 + 0.999*m.b2264)))*(0.001 + 
                          0.999*m.b2264) <= 0)

m.c2365 = Constraint(expr=(m.x1693/(0.001 + 0.999*m.b2265) - 1.25*log(1 + m.x1653/(0.001 + 0.999*m.b2265)))*(0.001 + 
                          0.999*m.b2265) <= 0)
...
m.c2398 = Constraint(expr=(m.x1706/(0.001 + 0.999*m.b2266) - 0.9*log(1 + m.x1658/(0.001 + 0.999*m.b2266)))*(0.001 + 
                          0.999*m.b2266) <= 0)

m.c2399 = Constraint(expr=(m.x1707/(0.001 + 0.999*m.b2267) - 0.9*log(1 + m.x1659/(0.001 + 0.999*m.b2267)))*(0.001 + 
                          0.999*m.b2267) <= 0)

m.c2400 = Constraint(expr=(m.x1708/(0.001 + 0.999*m.b2268) - 0.9*log(1 + m.x1660/(0.001 + 0.999*m.b2268)))*(0.001 + 
                          0.999*m.b2268) <= 0)

m.c2401 = Constraint(expr=(m.x1709/(0.001 + 0.999*m.b2269) - 0.9*log(1 + m.x1661/(0.001 + 0.999*m.b2269)))*(0.001 + 
                          0.999*m.b2269) <= 0)
...
m.c2434 = Constraint(expr=(m.x1722/(0.001 + 0.999*m.b2270) - log(1 + m.x1630/(0.001 + 0.999*m.b2270)))*(0.001 + 0.999*
                          m.b2270) <= 0)

m.c2435 = Constraint(expr=(m.x1723/(0.001 + 0.999*m.b2271) - log(1 + m.x1631/(0.001 + 0.999*m.b2271)))*(0.001 + 0.999*
                          m.b2271) <= 0)

m.c2436 = Constraint(expr=(m.x1724/(0.001 + 0.999*m.b2272) - log(1 + m.x1632/(0.001 + 0.999*m.b2272)))*(0.001 + 0.999*
                          m.b2272) <= 0)

m.c2437 = Constraint(expr=(m.x1725/(0.001 + 0.999*m.b2273) - log(1 + m.x1633/(0.001 + 0.999*m.b2273)))*(0.001 + 0.999*
                          m.b2273) <= 0)
...
m.c2542 = Constraint(expr=(m.x1746/(0.001 + 0.999*m.b2282) - 1.1*log(1 + m.x1682/(0.001 + 0.999*m.b2282)))*(0.001 + 
                          0.999*m.b2282) <= 0)

m.c2543 = Constraint(expr=(m.x1747/(0.001 + 0.999*m.b2283) - 1.1*log(1 + m.x1683/(0.001 + 0.999*m.b2283)))*(0.001 + 
                          0.999*m.b2283) <= 0)

m.c2544 = Constraint(expr=(m.x1748/(0.001 + 0.999*m.b2284) - 1.1*log(1 + m.x1684/(0.001 + 0.999*m.b2284)))*(0.001 + 
                          0.999*m.b2284) <= 0)

m.c2545 = Constraint(expr=(m.x1749/(0.001 + 0.999*m.b2285) - 1.1*log(1 + m.x1685/(0.001 + 0.999*m.b2285)))*(0.001 + 
                          0.999*m.b2285) <= 0)
...
m.c2634 = Constraint(expr=(m.x1834/(0.001 + 0.999*m.b2290) - log(1 + m.x1710/(0.001 + 0.999*m.b2290)))*(0.001 + 0.999*
                          m.b2290) <= 0)

m.c2635 = Constraint(expr=(m.x1835/(0.001 + 0.999*m.b2291) - log(1 + m.x1711/(0.001 + 0.999*m.b2291)))*(0.001 + 0.999*
                          m.b2291) <= 0)

m.c2636 = Constraint(expr=(m.x1836/(0.001 + 0.999*m.b2292) - log(1 + m.x1712/(0.001 + 0.999*m.b2292)))*(0.001 + 0.999*
                          m.b2292) <= 0)

m.c2637 = Constraint(expr=(m.x1837/(0.001 + 0.999*m.b2293) - log(1 + m.x1713/(0.001 + 0.999*m.b2293)))*(0.001 + 0.999*
                          m.b2293) <= 0)
...
m.c2670 = Constraint(expr=(m.x1842/(0.001 + 0.999*m.b2294) - 0.7*log(1 + m.x1754/(0.001 + 0.999*m.b2294)))*(0.001 + 
                          0.999*m.b2294) <= 0)

m.c2671 = Constraint(expr=(m.x1843/(0.001 + 0.999*m.b2295) - 0.7*log(1 + m.x1755/(0.001 + 0.999*m.b2295)))*(0.001 + 
                          0.999*m.b2295) <= 0)

m.c2672 = Constraint(expr=(m.x1844/(0.001 + 0.999*m.b2296) - 0.7*log(1 + m.x1756/(0.001 + 0.999*m.b2296)))*(0.001 + 
                          0.999*m.b2296) <= 0)

m.c2673 = Constraint(expr=(m.x1845/(0.001 + 0.999*m.b2297) - 0.7*log(1 + m.x1757/(0.001 + 0.999*m.b2297)))*(0.001 + 
                          0.999*m.b2297) <= 0)
...
m.c2706 = Constraint(expr=(m.x1850/(0.001 + 0.999*m.b2298) - 0.65*log(1 + m.x1762/(0.001 + 0.999*m.b2298)))*(0.001 + 
                          0.999*m.b2298) <= 0)

m.c2707 = Constraint(expr=(m.x1851/(0.001 + 0.999*m.b2299) - 0.65*log(1 + m.x1763/(0.001 + 0.999*m.b2299)))*(0.001 + 
                          0.999*m.b2299) <= 0)

m.c2708 = Constraint(expr=(m.x1852/(0.001 + 0.999*m.b2300) - 0.65*log(1 + m.x1764/(0.001 + 0.999*m.b2300)))*(0.001 + 
                          0.999*m.b2300) <= 0)

m.c2709 = Constraint(expr=(m.x1853/(0.001 + 0.999*m.b2301) - 0.65*log(1 + m.x1765/(0.001 + 0.999*m.b2301)))*(0.001 + 
                          0.999*m.b2301) <= 0)

m.c2710 = Constraint(expr=(m.x1850/(0.001 + 0.999*m.b2298) - 0.65*log(1 + m.x1778/(0.001 + 0.999*m.b2298)))*(0.001 + 
                          0.999*m.b2298) <= 0)

m.c2711 = Constraint(expr=(m.x1851/(0.001 + 0.999*m.b2299) - 0.65*log(1 + m.x1779/(0.001 + 0.999*m.b2299)))*(0.001 + 
                          0.999*m.b2299) <= 0)

m.c2712 = Constraint(expr=(m.x1852/(0.001 + 0.999*m.b2300) - 0.65*log(1 + m.x1780/(0.001 + 0.999*m.b2300)))*(0.001 + 
                          0.999*m.b2300) <= 0)

m.c2713 = Constraint(expr=(m.x1853/(0.001 + 0.999*m.b2301) - 0.65*log(1 + m.x1781/(0.001 + 0.999*m.b2301)))*(0.001 + 
                          0.999*m.b2301) <= 0)
...
m.c2834 = Constraint(expr=(m.x1874/(0.001 + 0.999*m.b2310) - 0.75*log(1 + m.x1802/(0.001 + 0.999*m.b2310)))*(0.001 + 
                          0.999*m.b2310) <= 0)

m.c2835 = Constraint(expr=(m.x1875/(0.001 + 0.999*m.b2311) - 0.75*log(1 + m.x1803/(0.001 + 0.999*m.b2311)))*(0.001 + 
                          0.999*m.b2311) <= 0)

m.c2836 = Constraint(expr=(m.x1876/(0.001 + 0.999*m.b2312) - 0.75*log(1 + m.x1804/(0.001 + 0.999*m.b2312)))*(0.001 + 
                          0.999*m.b2312) <= 0)

m.c2837 = Constraint(expr=(m.x1877/(0.001 + 0.999*m.b2313) - 0.75*log(1 + m.x1805/(0.001 + 0.999*m.b2313)))*(0.001 + 
                          0.999*m.b2313) <= 0)
...
m.c2870 = Constraint(expr=(m.x1882/(0.001 + 0.999*m.b2314) - 0.8*log(1 + m.x1810/(0.001 + 0.999*m.b2314)))*(0.001 + 
                          0.999*m.b2314) <= 0)

m.c2871 = Constraint(expr=(m.x1883/(0.001 + 0.999*m.b2315) - 0.8*log(1 + m.x1811/(0.001 + 0.999*m.b2315)))*(0.001 + 
                          0.999*m.b2315) <= 0)

m.c2872 = Constraint(expr=(m.x1884/(0.001 + 0.999*m.b2316) - 0.8*log(1 + m.x1812/(0.001 + 0.999*m.b2316)))*(0.001 + 
                          0.999*m.b2316) <= 0)

m.c2873 = Constraint(expr=(m.x1885/(0.001 + 0.999*m.b2317) - 0.8*log(1 + m.x1813/(0.001 + 0.999*m.b2317)))*(0.001 + 
                          0.999*m.b2317) <= 0)
...
m.c2906 = Constraint(expr=(m.x1890/(0.001 + 0.999*m.b2318) - 0.85*log(1 + m.x1818/(0.001 + 0.999*m.b2318)))*(0.001 + 
                          0.999*m.b2318) <= 0)

m.c2907 = Constraint(expr=(m.x1891/(0.001 + 0.999*m.b2319) - 0.85*log(1 + m.x1819/(0.001 + 0.999*m.b2319)))*(0.001 + 
                          0.999*m.b2319) <= 0)

m.c2908 = Constraint(expr=(m.x1892/(0.001 + 0.999*m.b2320) - 0.85*log(1 + m.x1820/(0.001 + 0.999*m.b2320)))*(0.001 + 
                          0.999*m.b2320) <= 0)

m.c2909 = Constraint(expr=(m.x1893/(0.001 + 0.999*m.b2321) - 0.85*log(1 + m.x1821/(0.001 + 0.999*m.b2321)))*(0.001 + 
                          0.999*m.b2321) <= 0)
...
m.c2942 = Constraint(expr=(m.x1914/(0.001 + 0.999*m.b2322) - log(1 + m.x1898/(0.001 + 0.999*m.b2322)))*(0.001 + 0.999*
                          m.b2322) <= 0)

m.c2943 = Constraint(expr=(m.x1915/(0.001 + 0.999*m.b2323) - log(1 + m.x1899/(0.001 + 0.999*m.b2323)))*(0.001 + 0.999*
                          m.b2323) <= 0)

m.c2944 = Constraint(expr=(m.x1916/(0.001 + 0.999*m.b2324) - log(1 + m.x1900/(0.001 + 0.999*m.b2324)))*(0.001 + 0.999*
                          m.b2324) <= 0)

m.c2945 = Constraint(expr=(m.x1917/(0.001 + 0.999*m.b2325) - log(1 + m.x1901/(0.001 + 0.999*m.b2325)))*(0.001 + 0.999*
                          m.b2325) <= 0)
...
m.c2978 = Constraint(expr=(m.x1922/(0.001 + 0.999*m.b2326) - 1.2*log(1 + m.x1906/(0.001 + 0.999*m.b2326)))*(0.001 + 
                          0.999*m.b2326) <= 0)

m.c2979 = Constraint(expr=(m.x1923/(0.001 + 0.999*m.b2327) - 1.2*log(1 + m.x1907/(0.001 + 0.999*m.b2327)))*(0.001 + 
                          0.999*m.b2327) <= 0)

m.c2980 = Constraint(expr=(m.x1924/(0.001 + 0.999*m.b2328) - 1.2*log(1 + m.x1908/(0.001 + 0.999*m.b2328)))*(0.001 + 
                          0.999*m.b2328) <= 0)

m.c2981 = Constraint(expr=(m.x1925/(0.001 + 0.999*m.b2329) - 1.2*log(1 + m.x1909/(0.001 + 0.999*m.b2329)))*(0.001 + 
                          0.999*m.b2329) <= 0)
...
m.c3050 = Constraint(expr=(m.x1970/(0.001 + 0.999*m.b2334) - 1.5*log(1 + m.x1938/(0.001 + 0.999*m.b2334)))*(0.001 + 
                          0.999*m.b2334) <= 0)

m.c3051 = Constraint(expr=(m.x1971/(0.001 + 0.999*m.b2335) - 1.5*log(1 + m.x1939/(0.001 + 0.999*m.b2335)))*(0.001 + 
                          0.999*m.b2335) <= 0)

m.c3052 = Constraint(expr=(m.x1972/(0.001 + 0.999*m.b2336) - 1.5*log(1 + m.x1940/(0.001 + 0.999*m.b2336)))*(0.001 + 
                          0.999*m.b2336) <= 0)

m.c3053 = Constraint(expr=(m.x1973/(0.001 + 0.999*m.b2337) - 1.5*log(1 + m.x1941/(0.001 + 0.999*m.b2337)))*(0.001 + 
                          0.999*m.b2337) <= 0)
...
m.c3142 = Constraint(expr=(m.x2034/(0.001 + 0.999*m.b2342) - 1.25*log(1 + m.x1994/(0.001 + 0.999*m.b2342)))*(0.001 + 
                          0.999*m.b2342) <= 0)

m.c3143 = Constraint(expr=(m.x2035/(0.001 + 0.999*m.b2343) - 1.25*log(1 + m.x1995/(0.001 + 0.999*m.b2343)))*(0.001 + 
                          0.999*m.b2343) <= 0)

m.c3144 = Constraint(expr=(m.x2036/(0.001 + 0.999*m.b2344) - 1.25*log(1 + m.x1996/(0.001 + 0.999*m.b2344)))*(0.001 + 
                          0.999*m.b2344) <= 0)

m.c3145 = Constraint(expr=(m.x2037/(0.001 + 0.999*m.b2345) - 1.25*log(1 + m.x1997/(0.001 + 0.999*m.b2345)))*(0.001 + 
                          0.999*m.b2345) <= 0)
...
m.c3178 = Constraint(expr=(m.x2050/(0.001 + 0.999*m.b2346) - 0.9*log(1 + m.x2002/(0.001 + 0.999*m.b2346)))*(0.001 + 
                          0.999*m.b2346) <= 0)

m.c3179 = Constraint(expr=(m.x2051/(0.001 + 0.999*m.b2347) - 0.9*log(1 + m.x2003/(0.001 + 0.999*m.b2347)))*(0.001 + 
                          0.999*m.b2347) <= 0)

m.c3180 = Constraint(expr=(m.x2052/(0.001 + 0.999*m.b2348) - 0.9*log(1 + m.x2004/(0.001 + 0.999*m.b2348)))*(0.001 + 
                          0.999*m.b2348) <= 0)

m.c3181 = Constraint(expr=(m.x2053/(0.001 + 0.999*m.b2349) - 0.9*log(1 + m.x2005/(0.001 + 0.999*m.b2349)))*(0.001 + 
                          0.999*m.b2349) <= 0)
...
m.c3214 = Constraint(expr=(m.x2066/(0.001 + 0.999*m.b2350) - log(1 + m.x1974/(0.001 + 0.999*m.b2350)))*(0.001 + 0.999*
                          m.b2350) <= 0)

m.c3215 = Constraint(expr=(m.x2067/(0.001 + 0.999*m.b2351) - log(1 + m.x1975/(0.001 + 0.999*m.b2351)))*(0.001 + 0.999*
                          m.b2351) <= 0)

m.c3216 = Constraint(expr=(m.x2068/(0.001 + 0.999*m.b2352) - log(1 + m.x1976/(0.001 + 0.999*m.b2352)))*(0.001 + 0.999*
                          m.b2352) <= 0)

m.c3217 = Constraint(expr=(m.x2069/(0.001 + 0.999*m.b2353) - log(1 + m.x1977/(0.001 + 0.999*m.b2353)))*(0.001 + 0.999*
                          m.b2353) <= 0)
...
m.c3322 = Constraint(expr=(m.x2090/(0.001 + 0.999*m.b2362) - 1.1*log(1 + m.x2026/(0.001 + 0.999*m.b2362)))*(0.001 + 
                          0.999*m.b2362) <= 0)

m.c3323 = Constraint(expr=(m.x2091/(0.001 + 0.999*m.b2363) - 1.1*log(1 + m.x2027/(0.001 + 0.999*m.b2363)))*(0.001 + 
                          0.999*m.b2363) <= 0)

m.c3324 = Constraint(expr=(m.x2092/(0.001 + 0.999*m.b2364) - 1.1*log(1 + m.x2028/(0.001 + 0.999*m.b2364)))*(0.001 + 
                          0.999*m.b2364) <= 0)

m.c3325 = Constraint(expr=(m.x2093/(0.001 + 0.999*m.b2365) - 1.1*log(1 + m.x2029/(0.001 + 0.999*m.b2365)))*(0.001 + 
                          0.999*m.b2365) <= 0)
...
m.c3414 = Constraint(expr=(m.x2178/(0.001 + 0.999*m.b2370) - log(1 + m.x2054/(0.001 + 0.999*m.b2370)))*(0.001 + 0.999*
                          m.b2370) <= 0)

m.c3415 = Constraint(expr=(m.x2179/(0.001 + 0.999*m.b2371) - log(1 + m.x2055/(0.001 + 0.999*m.b2371)))*(0.001 + 0.999*
                          m.b2371) <= 0)

m.c3416 = Constraint(expr=(m.x2180/(0.001 + 0.999*m.b2372) - log(1 + m.x2056/(0.001 + 0.999*m.b2372)))*(0.001 + 0.999*
                          m.b2372) <= 0)

m.c3417 = Constraint(expr=(m.x2181/(0.001 + 0.999*m.b2373) - log(1 + m.x2057/(0.001 + 0.999*m.b2373)))*(0.001 + 0.999*
                          m.b2373) <= 0)
...
m.c3450 = Constraint(expr=(m.x2186/(0.001 + 0.999*m.b2374) - 0.7*log(1 + m.x2098/(0.001 + 0.999*m.b2374)))*(0.001 + 
                          0.999*m.b2374) <= 0)

m.c3451 = Constraint(expr=(m.x2187/(0.001 + 0.999*m.b2375) - 0.7*log(1 + m.x2099/(0.001 + 0.999*m.b2375)))*(0.001 + 
                          0.999*m.b2375) <= 0)

m.c3452 = Constraint(expr=(m.x2188/(0.001 + 0.999*m.b2376) - 0.7*log(1 + m.x2100/(0.001 + 0.999*m.b2376)))*(0.001 + 
                          0.999*m.b2376) <= 0)

m.c3453 = Constraint(expr=(m.x2189/(0.001 + 0.999*m.b2377) - 0.7*log(1 + m.x2101/(0.001 + 0.999*m.b2377)))*(0.001 + 
                          0.999*m.b2377) <= 0)
...
m.c3486 = Constraint(expr=(m.x2194/(0.001 + 0.999*m.b2378) - 0.65*log(1 + m.x2106/(0.001 + 0.999*m.b2378)))*(0.001 + 
                          0.999*m.b2378) <= 0)

m.c3487 = Constraint(expr=(m.x2195/(0.001 + 0.999*m.b2379) - 0.65*log(1 + m.x2107/(0.001 + 0.999*m.b2379)))*(0.001 + 
                          0.999*m.b2379) <= 0)

m.c3488 = Constraint(expr=(m.x2196/(0.001 + 0.999*m.b2380) - 0.65*log(1 + m.x2108/(0.001 + 0.999*m.b2380)))*(0.001 + 
                          0.999*m.b2380) <= 0)

m.c3489 = Constraint(expr=(m.x2197/(0.001 + 0.999*m.b2381) - 0.65*log(1 + m.x2109/(0.001 + 0.999*m.b2381)))*(0.001 + 
                          0.999*m.b2381) <= 0)

m.c3490 = Constraint(expr=(m.x2194/(0.001 + 0.999*m.b2378) - 0.65*log(1 + m.x2122/(0.001 + 0.999*m.b2378)))*(0.001 + 
                          0.999*m.b2378) <= 0)

m.c3491 = Constraint(expr=(m.x2195/(0.001 + 0.999*m.b2379) - 0.65*log(1 + m.x2123/(0.001 + 0.999*m.b2379)))*(0.001 + 
                          0.999*m.b2379) <= 0)

m.c3492 = Constraint(expr=(m.x2196/(0.001 + 0.999*m.b2380) - 0.65*log(1 + m.x2124/(0.001 + 0.999*m.b2380)))*(0.001 + 
                          0.999*m.b2380) <= 0)

m.c3493 = Constraint(expr=(m.x2197/(0.001 + 0.999*m.b2381) - 0.65*log(1 + m.x2125/(0.001 + 0.999*m.b2381)))*(0.001 + 
                          0.999*m.b2381) <= 0)
...
m.c3614 = Constraint(expr=(m.x2218/(0.001 + 0.999*m.b2390) - 0.75*log(1 + m.x2146/(0.001 + 0.999*m.b2390)))*(0.001 + 
                          0.999*m.b2390) <= 0)

m.c3615 = Constraint(expr=(m.x2219/(0.001 + 0.999*m.b2391) - 0.75*log(1 + m.x2147/(0.001 + 0.999*m.b2391)))*(0.001 + 
                          0.999*m.b2391) <= 0)

m.c3616 = Constraint(expr=(m.x2220/(0.001 + 0.999*m.b2392) - 0.75*log(1 + m.x2148/(0.001 + 0.999*m.b2392)))*(0.001 + 
                          0.999*m.b2392) <= 0)

m.c3617 = Constraint(expr=(m.x2221/(0.001 + 0.999*m.b2393) - 0.75*log(1 + m.x2149/(0.001 + 0.999*m.b2393)))*(0.001 + 
                          0.999*m.b2393) <= 0)
...
m.c3650 = Constraint(expr=(m.x2226/(0.001 + 0.999*m.b2394) - 0.8*log(1 + m.x2154/(0.001 + 0.999*m.b2394)))*(0.001 + 
                          0.999*m.b2394) <= 0)

m.c3651 = Constraint(expr=(m.x2227/(0.001 + 0.999*m.b2395) - 0.8*log(1 + m.x2155/(0.001 + 0.999*m.b2395)))*(0.001 + 
                          0.999*m.b2395) <= 0)

m.c3652 = Constraint(expr=(m.x2228/(0.001 + 0.999*m.b2396) - 0.8*log(1 + m.x2156/(0.001 + 0.999*m.b2396)))*(0.001 + 
                          0.999*m.b2396) <= 0)

m.c3653 = Constraint(expr=(m.x2229/(0.001 + 0.999*m.b2397) - 0.8*log(1 + m.x2157/(0.001 + 0.999*m.b2397)))*(0.001 + 
                          0.999*m.b2397) <= 0)
...
m.c3686 = Constraint(expr=(m.x2234/(0.001 + 0.999*m.b2398) - 0.85*log(1 + m.x2162/(0.001 + 0.999*m.b2398)))*(0.001 + 
                          0.999*m.b2398) <= 0)

m.c3687 = Constraint(expr=(m.x2235/(0.001 + 0.999*m.b2399) - 0.85*log(1 + m.x2163/(0.001 + 0.999*m.b2399)))*(0.001 + 
                          0.999*m.b2399) <= 0)

m.c3688 = Constraint(expr=(m.x2236/(0.001 + 0.999*m.b2400) - 0.85*log(1 + m.x2164/(0.001 + 0.999*m.b2400)))*(0.001 + 
                          0.999*m.b2400) <= 0)

m.c3689 = Constraint(expr=(m.x2237/(0.001 + 0.999*m.b2401) - 0.85*log(1 + m.x2165/(0.001 + 0.999*m.b2401)))*(0.001 + 
                          0.999*m.b2401) <= 0)
