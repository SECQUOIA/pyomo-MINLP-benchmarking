#  MINLP written by GAMS Convert at 08/20/20 01:30:47
#
#  Equation counts
#      Total        E        G        L        N        X        C        B
...
m.obj = Objective(expr=0.1*m.x266 + 0.6*m.x267 + 0.2*m.x268 + 0.5*m.x269 + 0.1*m.x270 + 0.6*m.x271 + 0.2*m.x272
                  + 0.5*m.x273 + 0.1*m.x298 + 0.6*m.x299 + 0.2 *
                  m.x300 + 0.5*m.x301 + 0.1*m.x302 + 0.6*m.x303
                  + 0.2*m.x304 + 0.5*m.x305 + 0.1*m.x330 + 0.6 *
                  m.x331 + 0.2*m.x332 + 0.5*m.x333 + 0.1*m.x334
                  + 0.6*m.x335 + 0.2*m.x336 + 0.5*m.x337 + 0.1 *
                  m.x362 + 0.6*m.x363 + 0.2*m.x364 + 0.5*m.x365
                  + 0.1*m.x366 + 0.6*m.x367 + 0.2*m.x368 + 0.5 *
                  m.x369 + 0.1*m.x394 + 0.6*m.x395 + 0.2*m.x396
                  + 0.5*m.x397 + 0.1*m.x398 + 0.6*m.x399 + 0.2 *
                  m.x400 + 0.5*m.x401 + 0.1*m.x426 + 0.6*m.x427
...
m.c78 = Constraint(expr=m.b2 - m.b3 + m.b10 -
                   m.b11 + m.b18 - m.b19 - m.b27 >= 0)

m.c79 = Constraint(expr=m.b2 - m.b3 + m.b10 - m.b11 +
                   m.b18 - m.b19 + m.b26 - m.b27 - m.b35 >= 0)

m.c80 = Constraint(expr=m.b2 - m.b3 + m.b10 - m.b11 + m.b18 -
...
m.c739 = Constraint(expr=- m.x194 + m.x196 + m.x197 -
                    m.x202 + m.x204 + m.x205 + m.x450 == 25)

m.c740 = Constraint(expr=- m.x195 + m.x198 + m.x199 -
                    m.x203 + m.x206 + m.x207 + m.x451 == 75)

m.c741 = Constraint(expr=- m.x196 - m.x198 + m.x200 -
                    m.x204 - m.x206 + m.x208 + m.x452 == 50)

m.c742 = Constraint(expr=- m.x197 - m.x199 + m.x201 -
                    m.x205 - m.x207 + m.x209 + m.x453 == 50)
...
m.c750 = Constraint(expr=- m.x200 - m.x201 - m.x208 -
                    m.x209 - m.x216 - m.x217 + m.x461 == 0)
...
m.c757 = Constraint(expr=- m.x200 - m.x201 - m.x208 -
                    m.x209 - m.x216 - m.x217 - m.x224 - m.x225 + m.x468 == 0)

m.c758 = Constraint(expr=m.x194 + m.x202 + m.x210 +
                    m.x218 + m.x226 + m.x469 == 100)

m.c759 = Constraint(expr=m.x195 + m.x203 + m.x211 +
                    m.x219 + m.x227 + m.x470 == 100)
...
m.c829 = Constraint(expr=- m.x242 + m.x250 + m.x254 -
                    m.x274 + m.x282 + m.x286 + m.x540 == 25)

m.c830 = Constraint(expr=- m.x243 + m.x251 + m.x255 -
                    m.x275 + m.x283 + m.x287 + m.x541 == 0)

m.c831 = Constraint(expr=- m.x244 + m.x252 + m.x256 -
                    m.x276 + m.x284 + m.x288 + m.x542 == 0)

m.c832 = Constraint(expr=- m.x245 + m.x253 + m.x257 -
                    m.x277 + m.x285 + m.x289 + m.x543 == 0)

m.c833 = Constraint(expr=- m.x246 + m.x258 + m.x262 -
                    m.x278 + m.x290 + m.x294 + m.x544 == 0)

m.c834 = Constraint(expr=- m.x247 + m.x259 + m.x263 -
                    m.x279 + m.x291 + m.x295 + m.x545 == 75)

m.c835 = Constraint(expr=- m.x248 + m.x260 + m.x264 -
                    m.x280 + m.x292 + m.x296 + m.x546 == 0)

m.c836 = Constraint(expr=- m.x249 + m.x261 + m.x265 -
                    m.x281 + m.x293 + m.x297 + m.x547 == 0)

m.c837 = Constraint(expr=- m.x250 - m.x258 + m.x266 -
                    m.x282 - m.x290 + m.x298 + m.x548 == 0)

m.c838 = Constraint(expr=- m.x251 - m.x259 + m.x267 -
                    m.x283 - m.x291 + m.x299 + m.x549 == 0)

m.c839 = Constraint(expr=- m.x252 - m.x260 + m.x268 -
                    m.x284 - m.x292 + m.x300 + m.x550 == 50)

m.c840 = Constraint(expr=- m.x253 - m.x261 + m.x269 -
                    m.x285 - m.x293 + m.x301 + m.x551 == 0)

m.c841 = Constraint(expr=- m.x254 - m.x262 + m.x270 -
                    m.x286 - m.x294 + m.x302 + m.x552 == 0)

m.c842 = Constraint(expr=- m.x255 - m.x263 + m.x271 -
                    m.x287 - m.x295 + m.x303 + m.x553 == 0)

m.c843 = Constraint(expr=- m.x256 - m.x264 + m.x272 -
                    m.x288 - m.x296 + m.x304 + m.x554 == 0)

m.c844 = Constraint(expr=- m.x257 - m.x265 + m.x273 -
                    m.x289 - m.x297 + m.x305 + m.x555 == 50)
...
m.c873 = Constraint(expr=- m.x266 - m.x270 - m.x298 -
                    m.x302 - m.x330 - m.x334 + m.x584 == 0)

m.c874 = Constraint(expr=- m.x267 - m.x271 - m.x299 -
                    m.x303 - m.x331 - m.x335 + m.x585 == 0)

m.c875 = Constraint(expr=- m.x268 - m.x272 - m.x300 -
                    m.x304 - m.x332 - m.x336 + m.x586 == 0)

m.c876 = Constraint(expr=- m.x269 - m.x273 - m.x301 -
                    m.x305 - m.x333 - m.x337 + m.x587 == 0)
...
m.c901 = Constraint(expr=- m.x266 - m.x270 - m.x298 -
                    m.x302 - m.x330 - m.x334 - m.x362 - m.x366 + m.x612 == 0)

m.c902 = Constraint(expr=- m.x267 - m.x271 - m.x299 -
                    m.x303 - m.x331 - m.x335 - m.x363 - m.x367 + m.x613 == 0)

m.c903 = Constraint(expr=- m.x268 - m.x272 - m.x300 -
                    m.x304 - m.x332 - m.x336 - m.x364 - m.x368 + m.x614 == 0)

m.c904 = Constraint(expr=- m.x269 - m.x273 - m.x301 -
                    m.x305 - m.x333 - m.x337 - m.x365 - m.x369 + m.x615 == 0)

m.c905 = Constraint(expr=m.x242 + m.x274 + m.x306 +
                    m.x338 + m.x370 + m.x616 == 100)

m.c906 = Constraint(expr=m.x243 + m.x275 + m.x307 +
                    m.x339 + m.x371 + m.x617 == 0)

m.c907 = Constraint(expr=m.x244 + m.x276 + m.x308 +
                    m.x340 + m.x372 + m.x618 == 0)

m.c908 = Constraint(expr=m.x245 + m.x277 + m.x309 +
                    m.x341 + m.x373 + m.x619 == 0)

m.c909 = Constraint(expr=m.x246 + m.x278 + m.x310 +
                    m.x342 + m.x374 + m.x620 == 0)

m.c910 = Constraint(expr=m.x247 + m.x279 + m.x311 +
                    m.x343 + m.x375 + m.x621 == 100)

m.c911 = Constraint(expr=m.x248 + m.x280 + m.x312 +
                    m.x344 + m.x376 + m.x622 == 0)

m.c912 = Constraint(expr=m.x249 + m.x281 + m.x313 +
                    m.x345 + m.x377 + m.x623 == 0)
...
m.c1222 = Constraint(expr=m.x200 + m.x208 + m.x216 +
                     m.x224 + m.x232 + m.x240 >= 100)

m.c1223 = Constraint(expr=m.x201 + m.x209 + m.x217 +
                     m.x225 + m.x233 + m.x241 >= 100)

m.c1224 = Constraint(expr=m.x200 + m.x208 + m.x216 +
                     m.x224 + m.x232 + m.x240 <= 100)

m.c1225 = Constraint(expr=m.x201 + m.x209 + m.x217 +
                     m.x225 + m.x233 + m.x241 <= 100)

m.c1226 = Constraint(expr=- 0.15*m.x200 + 0.1*m.x266 +
                     0.6*m.x267 + 0.2*m.x268 + 0.5*m.x269 >= 0)

m.c1227 = Constraint(expr=- 0.45*m.x201 + 0.1*m.x270 +
                     0.6*m.x271 + 0.2*m.x272 + 0.5*m.x273 >= 0)

m.c1228 = Constraint(expr=- 0.15*m.x208 + 0.1*m.x298 +
                     0.6*m.x299 + 0.2*m.x300 + 0.5*m.x301 >= 0)

m.c1229 = Constraint(expr=- 0.45*m.x209 + 0.1*m.x302 +
                     0.6*m.x303 + 0.2*m.x304 + 0.5*m.x305 >= 0)

m.c1230 = Constraint(expr=- 0.15*m.x216 + 0.1*m.x330 +
                     0.6*m.x331 + 0.2*m.x332 + 0.5*m.x333 >= 0)

m.c1231 = Constraint(expr=- 0.45*m.x217 + 0.1*m.x334 +
                     0.6*m.x335 + 0.2*m.x336 + 0.5*m.x337 >= 0)

m.c1232 = Constraint(expr=- 0.15*m.x224 + 0.1*m.x362 +
                     0.6*m.x363 + 0.2*m.x364 + 0.5*m.x365 >= 0)

m.c1233 = Constraint(expr=- 0.45*m.x225 + 0.1*m.x366 +
                     0.6*m.x367 + 0.2*m.x368 + 0.5*m.x369 >= 0)

m.c1234 = Constraint(expr=- 0.15*m.x232 + 0.1*m.x394 +
                     0.6*m.x395 + 0.2*m.x396 + 0.5*m.x397 >= 0)

m.c1235 = Constraint(expr=- 0.45*m.x233 + 0.1*m.x398 +
                     0.6*m.x399 + 0.2*m.x400 + 0.5*m.x401 >= 0)

m.c1236 = Constraint(expr=- 0.15*m.x240 + 0.1*m.x426 +
                     0.6*m.x427 + 0.2*m.x428 + 0.5*m.x429 >= 0)

m.c1237 = Constraint(expr=- 0.45*m.x241 + 0.1*m.x430 +
                     0.6*m.x431 + 0.2*m.x432 + 0.5*m.x433 >= 0)

m.c1238 = Constraint(expr=- 0.25*m.x200 + 0.1*m.x266 +
                     0.6*m.x267 + 0.2*m.x268 + 0.5*m.x269 <= 0)

m.c1239 = Constraint(expr=- 0.55*m.x201 + 0.1*m.x270 +
                     0.6*m.x271 + 0.2*m.x272 + 0.5*m.x273 <= 0)

m.c1240 = Constraint(expr=- 0.25*m.x208 + 0.1*m.x298 +
                     0.6*m.x299 + 0.2*m.x300 + 0.5*m.x301 <= 0)

m.c1241 = Constraint(expr=- 0.55*m.x209 + 0.1*m.x302 +
                     0.6*m.x303 + 0.2*m.x304 + 0.5*m.x305 <= 0)

m.c1242 = Constraint(expr=- 0.25*m.x216 + 0.1*m.x330 +
                     0.6*m.x331 + 0.2*m.x332 + 0.5*m.x333 <= 0)

m.c1243 = Constraint(expr=- 0.55*m.x217 + 0.1*m.x334 +
                     0.6*m.x335 + 0.2*m.x336 + 0.5*m.x337 <= 0)

m.c1244 = Constraint(expr=- 0.25*m.x224 + 0.1*m.x362 +
                     0.6*m.x363 + 0.2*m.x364 + 0.5*m.x365 <= 0)

m.c1245 = Constraint(expr=- 0.55*m.x225 + 0.1*m.x366 +
                     0.6*m.x367 + 0.2*m.x368 + 0.5*m.x369 <= 0)

m.c1246 = Constraint(expr=- 0.25*m.x232 + 0.1*m.x394 +
                     0.6*m.x395 + 0.2*m.x396 + 0.5*m.x397 <= 0)

m.c1247 = Constraint(expr=- 0.55*m.x233 + 0.1*m.x398 +
                     0.6*m.x399 + 0.2*m.x400 + 0.5*m.x401 <= 0)

m.c1248 = Constraint(expr=- 0.25*m.x240 + 0.1*m.x426 +
                     0.6*m.x427 + 0.2*m.x428 + 0.5*m.x429 <= 0)

m.c1249 = Constraint(expr=- 0.55*m.x241 + 0.1*m.x430 +
                     0.6*m.x431 + 0.2*m.x432 + 0.5*m.x433 <= 0)

m.c1250 = Constraint(expr=- m.x194 - m.x202 - m.x210 -
                     m.x218 - m.x226 - m.x234 >= -100)

m.c1251 = Constraint(expr=- m.x195 - m.x203 - m.x211 -
                     m.x219 - m.x227 - m.x235 >= -100)
...
m.c1257 = Constraint(expr=- m.x194 - m.x202 - m.x210 -
                     m.x218 - m.x226 - m.x234 <= 0)

m.c1258 = Constraint(expr=- m.x195 - m.x203 - m.x211 -
                     m.x219 - m.x227 - m.x235 <= 0)
...
m.c1263 = Constraint(expr=- m.x242 - m.x274 - m.x306 -
                     m.x338 - m.x370 - m.x402 >= -100)

m.c1264 = Constraint(expr=- m.x243 - m.x275 - m.x307 -
                     m.x339 - m.x371 - m.x403 >= 0)

m.c1265 = Constraint(expr=- m.x244 - m.x276 - m.x308 -
                     m.x340 - m.x372 - m.x404 >= 0)

m.c1266 = Constraint(expr=- m.x245 - m.x277 - m.x309 -
                     m.x341 - m.x373 - m.x405 >= 0)

m.c1267 = Constraint(expr=- m.x246 - m.x278 - m.x310 -
                     m.x342 - m.x374 - m.x406 >= 0)

m.c1268 = Constraint(expr=- m.x247 - m.x279 - m.x311 -
                     m.x343 - m.x375 - m.x407 >= -100)

m.c1269 = Constraint(expr=- m.x248 - m.x280 - m.x312 -
                     m.x344 - m.x376 - m.x408 >= 0)

m.c1270 = Constraint(expr=- m.x249 - m.x281 - m.x313 -
                     m.x345 - m.x377 - m.x409 >= 0)
...
m.c1291 = Constraint(expr=- m.x242 - m.x274 - m.x306 -
                     m.x338 - m.x370 - m.x402 <= 0)

m.c1292 = Constraint(expr=- m.x243 - m.x275 - m.x307 -
                     m.x339 - m.x371 - m.x403 <= 100)

m.c1293 = Constraint(expr=- m.x244 - m.x276 - m.x308 -
                     m.x340 - m.x372 - m.x404 <= 100)

m.c1294 = Constraint(expr=- m.x245 - m.x277 - m.x309 -
                     m.x341 - m.x373 - m.x405 <= 100)

m.c1295 = Constraint(expr=- m.x246 - m.x278 - m.x310 -
                     m.x342 - m.x374 - m.x406 <= 100)

m.c1296 = Constraint(expr=- m.x247 - m.x279 - m.x311 -
                     m.x343 - m.x375 - m.x407 <= 0)

m.c1297 = Constraint(expr=- m.x248 - m.x280 - m.x312 -
                     m.x344 - m.x376 - m.x408 <= 100)

m.c1298 = Constraint(expr=- m.x249 - m.x281 - m.x313 -
                     m.x345 - m.x377 - m.x409 <= 100)
...
m.c1315 = Constraint(expr=8*m.b10 + 8*m.b11 - m.x58 -
                     m.x59 + m.x146 + m.x147 <= 8)

m.c1316 = Constraint(expr=8*m.b10 + 8*m.b12 - m.x58 -
                     m.x60 + m.x146 + m.x148 <= 8)

m.c1317 = Constraint(expr=8*m.b10 + 8*m.b13 - m.x58 -
                     m.x61 + m.x146 + m.x149 <= 8)

m.c1318 = Constraint(expr=8*m.b11 + 8*m.b14 - m.x59 -
                     m.x62 + m.x147 + m.x150 <= 8)

m.c1319 = Constraint(expr=8*m.b11 + 8*m.b15 - m.x59 -
                     m.x63 + m.x147 + m.x151 <= 8)

m.c1320 = Constraint(expr=8*m.b12 + 8*m.b16 - m.x60 -
                     m.x64 + m.x148 + m.x152 <= 8)

m.c1321 = Constraint(expr=8*m.b13 + 8*m.b17 - m.x61 -
                     m.x65 + m.x149 + m.x153 <= 8)

m.c1322 = Constraint(expr=8*m.b14 + 8*m.b16 - m.x62 -
                     m.x64 + m.x150 + m.x152 <= 8)

m.c1323 = Constraint(expr=8*m.b15 + 8*m.b17 - m.x63 -
                     m.x65 + m.x151 + m.x153 <= 8)

m.c1324 = Constraint(expr=8*m.b16 + 8*m.b17 - m.x64 -
                     m.x65 + m.x152 + m.x153 <= 8)

m.c1325 = Constraint(expr=8*m.b18 + 8*m.b19 - m.x66 -
                     m.x67 + m.x106 + m.x107 + m.x146 + m.x147 <= 8)

m.c1326 = Constraint(expr=8*m.b18 + 8*m.b20 - m.x66 -
                     m.x68 + m.x106 + m.x108 + m.x146 + m.x148 <= 8)

m.c1327 = Constraint(expr=8*m.b18 + 8*m.b21 - m.x66 -
                     m.x69 + m.x106 + m.x109 + m.x146 + m.x149 <= 8)

m.c1328 = Constraint(expr=8*m.b19 + 8*m.b22 - m.x67 -
                     m.x70 + m.x107 + m.x110 + m.x147 + m.x150 <= 8)

m.c1329 = Constraint(expr=8*m.b19 + 8*m.b23 - m.x67 -
                     m.x71 + m.x107 + m.x111 + m.x147 + m.x151 <= 8)

m.c1330 = Constraint(expr=8*m.b20 + 8*m.b24 - m.x68 -
                     m.x72 + m.x108 + m.x112 + m.x148 + m.x152 <= 8)

m.c1331 = Constraint(expr=8*m.b21 + 8*m.b25 - m.x69 -
                     m.x73 + m.x109 + m.x113 + m.x149 + m.x153 <= 8)

m.c1332 = Constraint(expr=8*m.b22 + 8*m.b24 - m.x70 -
                     m.x72 + m.x110 + m.x112 + m.x150 + m.x152 <= 8)

m.c1333 = Constraint(expr=8*m.b23 + 8*m.b25 - m.x71 -
                     m.x73 + m.x111 + m.x113 + m.x151 + m.x153 <= 8)

m.c1334 = Constraint(expr=8*m.b24 + 8*m.b25 - m.x72 -
                     m.x73 + m.x112 + m.x113 + m.x152 + m.x153 <= 8)
...
m.c1365 = Constraint(expr=8*m.b18 + 8*m.b19 - m.x66 -
                     m.x67 + m.x154 + m.x155 <= 8)

m.c1366 = Constraint(expr=8*m.b18 + 8*m.b20 - m.x66 -
                     m.x68 + m.x154 + m.x156 <= 8)

m.c1367 = Constraint(expr=8*m.b18 + 8*m.b21 - m.x66 -
                     m.x69 + m.x154 + m.x157 <= 8)

m.c1368 = Constraint(expr=8*m.b19 + 8*m.b22 - m.x67 -
                     m.x70 + m.x155 + m.x158 <= 8)

m.c1369 = Constraint(expr=8*m.b19 + 8*m.b23 - m.x67 -
                     m.x71 + m.x155 + m.x159 <= 8)

m.c1370 = Constraint(expr=8*m.b20 + 8*m.b24 - m.x68 -
                     m.x72 + m.x156 + m.x160 <= 8)

m.c1371 = Constraint(expr=8*m.b21 + 8*m.b25 - m.x69 -
                     m.x73 + m.x157 + m.x161 <= 8)

m.c1372 = Constraint(expr=8*m.b22 + 8*m.b24 - m.x70 -
                     m.x72 + m.x158 + m.x160 <= 8)

m.c1373 = Constraint(expr=8*m.b23 + 8*m.b25 - m.x71 -
                     m.x73 + m.x159 + m.x161 <= 8)

m.c1374 = Constraint(expr=8*m.b24 + 8*m.b25 - m.x72 -
                     m.x73 + m.x160 + m.x161 <= 8)

m.c1375 = Constraint(expr=8*m.b26 + 8*m.b27 - m.x74 -
                     m.x75 + m.x114 + m.x115 + m.x154 + m.x155 <= 8)

m.c1376 = Constraint(expr=8*m.b26 + 8*m.b28 - m.x74 -
                     m.x76 + m.x114 + m.x116 + m.x154 + m.x156 <= 8)

m.c1377 = Constraint(expr=8*m.b26 + 8*m.b29 - m.x74 -
                     m.x77 + m.x114 + m.x117 + m.x154 + m.x157 <= 8)

m.c1378 = Constraint(expr=8*m.b27 + 8*m.b30 - m.x75 -
                     m.x78 + m.x115 + m.x118 + m.x155 + m.x158 <= 8)

m.c1379 = Constraint(expr=8*m.b27 + 8*m.b31 - m.x75 -
                     m.x79 + m.x115 + m.x119 + m.x155 + m.x159 <= 8)

m.c1380 = Constraint(expr=8*m.b28 + 8*m.b32 - m.x76 -
                     m.x80 + m.x116 + m.x120 + m.x156 + m.x160 <= 8)

m.c1381 = Constraint(expr=8*m.b29 + 8*m.b33 - m.x77 -
                     m.x81 + m.x117 + m.x121 + m.x157 + m.x161 <= 8)

m.c1382 = Constraint(expr=8*m.b30 + 8*m.b32 - m.x78 -
                     m.x80 + m.x118 + m.x120 + m.x158 + m.x160 <= 8)

m.c1383 = Constraint(expr=8*m.b31 + 8*m.b33 - m.x79 -
                     m.x81 + m.x119 + m.x121 + m.x159 + m.x161 <= 8)

m.c1384 = Constraint(expr=8*m.b32 + 8*m.b33 - m.x80 -
                     m.x81 + m.x120 + m.x121 + m.x160 + m.x161 <= 8)
...
m.c1405 = Constraint(expr=8*m.b26 + 8*m.b27 - m.x74 -
                     m.x75 + m.x162 + m.x163 <= 8)

m.c1406 = Constraint(expr=8*m.b26 + 8*m.b28 - m.x74 -
                     m.x76 + m.x162 + m.x164 <= 8)

m.c1407 = Constraint(expr=8*m.b26 + 8*m.b29 - m.x74 -
                     m.x77 + m.x162 + m.x165 <= 8)

m.c1408 = Constraint(expr=8*m.b27 + 8*m.b30 - m.x75 -
                     m.x78 + m.x163 + m.x166 <= 8)

m.c1409 = Constraint(expr=8*m.b27 + 8*m.b31 - m.x75 -
                     m.x79 + m.x163 + m.x167 <= 8)

m.c1410 = Constraint(expr=8*m.b28 + 8*m.b32 - m.x76 -
                     m.x80 + m.x164 + m.x168 <= 8)

m.c1411 = Constraint(expr=8*m.b29 + 8*m.b33 - m.x77 -
                     m.x81 + m.x165 + m.x169 <= 8)

m.c1412 = Constraint(expr=8*m.b30 + 8*m.b32 - m.x78 -
                     m.x80 + m.x166 + m.x168 <= 8)

m.c1413 = Constraint(expr=8*m.b31 + 8*m.b33 - m.x79 -
                     m.x81 + m.x167 + m.x169 <= 8)

m.c1414 = Constraint(expr=8*m.b32 + 8*m.b33 - m.x80 -
                     m.x81 + m.x168 + m.x169 <= 8)

m.c1415 = Constraint(expr=8*m.b34 + 8*m.b35 - m.x82 -
                     m.x83 + m.x122 + m.x123 + m.x162 + m.x163 <= 8)

m.c1416 = Constraint(expr=8*m.b34 + 8*m.b36 - m.x82 -
                     m.x84 + m.x122 + m.x124 + m.x162 + m.x164 <= 8)

m.c1417 = Constraint(expr=8*m.b34 + 8*m.b37 - m.x82 -
                     m.x85 + m.x122 + m.x125 + m.x162 + m.x165 <= 8)

m.c1418 = Constraint(expr=8*m.b35 + 8*m.b38 - m.x83 -
                     m.x86 + m.x123 + m.x126 + m.x163 + m.x166 <= 8)

m.c1419 = Constraint(expr=8*m.b35 + 8*m.b39 - m.x83 -
                     m.x87 + m.x123 + m.x127 + m.x163 + m.x167 <= 8)

m.c1420 = Constraint(expr=8*m.b36 + 8*m.b40 - m.x84 -
                     m.x88 + m.x124 + m.x128 + m.x164 + m.x168 <= 8)

m.c1421 = Constraint(expr=8*m.b37 + 8*m.b41 - m.x85 -
                     m.x89 + m.x125 + m.x129 + m.x165 + m.x169 <= 8)

m.c1422 = Constraint(expr=8*m.b38 + 8*m.b40 - m.x86 -
                     m.x88 + m.x126 + m.x128 + m.x166 + m.x168 <= 8)

m.c1423 = Constraint(expr=8*m.b39 + 8*m.b41 - m.x87 -
                     m.x89 + m.x127 + m.x129 + m.x167 + m.x169 <= 8)

m.c1424 = Constraint(expr=8*m.b40 + 8*m.b41 - m.x88 -
                     m.x89 + m.x128 + m.x129 + m.x168 + m.x169 <= 8)
...
m.c1435 = Constraint(expr=8*m.b34 + 8*m.b35 - m.x82 -
                     m.x83 + m.x170 + m.x171 <= 8)

m.c1436 = Constraint(expr=8*m.b34 + 8*m.b36 - m.x82 -
                     m.x84 + m.x170 + m.x172 <= 8)

m.c1437 = Constraint(expr=8*m.b34 + 8*m.b37 - m.x82 -
                     m.x85 + m.x170 + m.x173 <= 8)

m.c1438 = Constraint(expr=8*m.b35 + 8*m.b38 - m.x83 -
                     m.x86 + m.x171 + m.x174 <= 8)

m.c1439 = Constraint(expr=8*m.b35 + 8*m.b39 - m.x83 -
                     m.x87 + m.x171 + m.x175 <= 8)

m.c1440 = Constraint(expr=8*m.b36 + 8*m.b40 - m.x84 -
                     m.x88 + m.x172 + m.x176 <= 8)

m.c1441 = Constraint(expr=8*m.b37 + 8*m.b41 - m.x85 -
                     m.x89 + m.x173 + m.x177 <= 8)

m.c1442 = Constraint(expr=8*m.b38 + 8*m.b40 - m.x86 -
                     m.x88 + m.x174 + m.x176 <= 8)

m.c1443 = Constraint(expr=8*m.b39 + 8*m.b41 - m.x87 -
                     m.x89 + m.x175 + m.x177 <= 8)

m.c1444 = Constraint(expr=8*m.b40 + 8*m.b41 - m.x88 -
                     m.x89 + m.x176 + m.x177 <= 8)

m.c1445 = Constraint(expr=8*m.b42 + 8*m.b43 - m.x90 -
                     m.x91 + m.x130 + m.x131 + m.x170 + m.x171 <= 8)

m.c1446 = Constraint(expr=8*m.b42 + 8*m.b44 - m.x90 -
                     m.x92 + m.x130 + m.x132 + m.x170 + m.x172 <= 8)

m.c1447 = Constraint(expr=8*m.b42 + 8*m.b45 - m.x90 -
                     m.x93 + m.x130 + m.x133 + m.x170 + m.x173 <= 8)

m.c1448 = Constraint(expr=8*m.b43 + 8*m.b46 - m.x91 -
                     m.x94 + m.x131 + m.x134 + m.x171 + m.x174 <= 8)

m.c1449 = Constraint(expr=8*m.b43 + 8*m.b47 - m.x91 -
                     m.x95 + m.x131 + m.x135 + m.x171 + m.x175 <= 8)

m.c1450 = Constraint(expr=8*m.b44 + 8*m.b48 - m.x92 -
                     m.x96 + m.x132 + m.x136 + m.x172 + m.x176 <= 8)

m.c1451 = Constraint(expr=8*m.b45 + 8*m.b49 - m.x93 -
                     m.x97 + m.x133 + m.x137 + m.x173 + m.x177 <= 8)

m.c1452 = Constraint(expr=8*m.b46 + 8*m.b48 - m.x94 -
                     m.x96 + m.x134 + m.x136 + m.x174 + m.x176 <= 8)

m.c1453 = Constraint(expr=8*m.b47 + 8*m.b49 - m.x95 -
                     m.x97 + m.x135 + m.x137 + m.x175 + m.x177 <= 8)

m.c1454 = Constraint(expr=8*m.b48 + 8*m.b49 - m.x96 -
                     m.x97 + m.x136 + m.x137 + m.x176 + m.x177 <= 8)

m.c1455 = Constraint(expr=8*m.b42 + 8*m.b43 - m.x90 -
                     m.x91 + m.x178 + m.x179 <= 8)

m.c1456 = Constraint(expr=8*m.b42 + 8*m.b44 - m.x90 -
                     m.x92 + m.x178 + m.x180 <= 8)

m.c1457 = Constraint(expr=8*m.b42 + 8*m.b45 - m.x90 -
                     m.x93 + m.x178 + m.x181 <= 8)

m.c1458 = Constraint(expr=8*m.b43 + 8*m.b46 - m.x91 -
                     m.x94 + m.x179 + m.x182 <= 8)

m.c1459 = Constraint(expr=8*m.b43 + 8*m.b47 - m.x91 -
                     m.x95 + m.x179 + m.x183 <= 8)

m.c1460 = Constraint(expr=8*m.b44 + 8*m.b48 - m.x92 -
                     m.x96 + m.x180 + m.x184 <= 8)

m.c1461 = Constraint(expr=8*m.b45 + 8*m.b49 - m.x93 -
                     m.x97 + m.x181 + m.x185 <= 8)

m.c1462 = Constraint(expr=8*m.b46 + 8*m.b48 - m.x94 -
                     m.x96 + m.x182 + m.x184 <= 8)

m.c1463 = Constraint(expr=8*m.b47 + 8*m.b49 - m.x95 -
                     m.x97 + m.x183 + m.x185 <= 8)

m.c1464 = Constraint(expr=8*m.b48 + 8*m.b49 - m.x96 -
                     m.x97 + m.x184 + m.x185 <= 8)
