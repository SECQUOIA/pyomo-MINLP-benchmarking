...
m.obj = Objective(expr=0.1*m.x346 + 0.6*m.x347 + 0.2*m.x348 + 0.5*m.x349 + 0.1*m.x350 + 0.6*m.x351 + 0.2*m.x352
                  + 0.5*m.x353 + 0.1*m.x378 + 0.6*m.x379 + 0.2 *
                  m.x380 + 0.5*m.x381 + 0.1*m.x382 + 0.6*m.x383
                  + 0.2*m.x384 + 0.5*m.x385 + 0.1*m.x410 + 0.6 *
                  m.x411 + 0.2*m.x412 + 0.5*m.x413 + 0.1*m.x414
                  + 0.6*m.x415 + 0.2*m.x416 + 0.5*m.x417 + 0.1 *
                  m.x442 + 0.6*m.x443 + 0.2*m.x444 + 0.5*m.x445
                  + 0.1*m.x446 + 0.6*m.x447 + 0.2*m.x448 + 0.5 *
                  m.x449 + 0.1*m.x474 + 0.6*m.x475 + 0.2*m.x476
                  + 0.5*m.x477 + 0.1*m.x478 + 0.6*m.x479 + 0.2 *
                  m.x480 + 0.5*m.x481 + 0.1*m.x506 + 0.6*m.x507
                  + 0.2*m.x508 + 0.5*m.x509 + 0.1*m.x510 + 0.6 *
                  m.x511 + 0.2*m.x512 + 0.5*m.x513 + 0.1*m.x538
                  + 0.6*m.x539 + 0.2*m.x540 + 0.5*m.x541 + 0.1 *
                  m.x542 + 0.6*m.x543 + 0.2*m.x544 + 0.5*m.x545
                  + 0.1*m.x570 + 0.6*m.x571 + 0.2*m.x572 + 0.5 *
                  m.x573 + 0.1*m.x574 + 0.6*m.x575 + 0.2*m.x576
...
m.c82 = Constraint(expr=m.b2 + m.b10 + m.b18 + m.b26 +
                   m.b34 + m.b42 + m.b50 + m.b58 >= 1)

m.c83 = Constraint(expr=m.b3 + m.b11 + m.b19 + m.b27 +
                   m.b35 + m.b43 + m.b51 + m.b59 >= 1)

m.c84 = Constraint(expr=m.b8 + m.b16 + m.b24 + m.b32 +
                   m.b40 + m.b48 + m.b56 + m.b64 >= 1)

m.c85 = Constraint(expr=m.b9 + m.b17 + m.b25 + m.b33 +
                   m.b41 + m.b49 + m.b57 + m.b65 >= 1)

m.c86 = Constraint(expr=m.b8 + m.b9 + m.b16 + m.b17 + m.b24 + m.b25 + m.b32 + m.b33 + m.b40 + m.b41 + m.b48 + m.b49
                   + m.b56 + m.b57 + m.b64 + m.b65 >= 3)

m.c87 = Constraint(expr=m.b2 + m.b10 + m.b18 + m.b26 +
                   m.b34 + m.b42 + m.b50 + m.b58 <= 1)

m.c88 = Constraint(expr=m.b3 + m.b11 + m.b19 + m.b27 +
                   m.b35 + m.b43 + m.b51 + m.b59 <= 1)

m.c89 = Constraint(expr=m.b8 + m.b16 + m.b24 + m.b32 +
                   m.b40 + m.b48 + m.b56 + m.b64 <= 2)

m.c90 = Constraint(expr=m.b9 + m.b17 + m.b25 + m.b33 +
                   m.b41 + m.b49 + m.b57 + m.b65 <= 2)
...
m.c98 = Constraint(expr=m.b2 - m.b3 + m.b10 -
                   m.b11 + m.b18 - m.b19 - m.b27 >= 0)

m.c99 = Constraint(expr=m.b2 - m.b3 + m.b10 - m.b11 +
                   m.b18 - m.b19 + m.b26 - m.b27 - m.b35 >= 0)

m.c100 = Constraint(expr=m.b2 - m.b3 + m.b10 - m.b11 +
...
m.c975 = Constraint(expr=- m.x258 + m.x260 + m.x261 -
                    m.x266 + m.x268 + m.x269 + m.x594 == 25)

m.c976 = Constraint(expr=- m.x259 + m.x262 + m.x263 -
                    m.x267 + m.x270 + m.x271 + m.x595 == 75)

m.c977 = Constraint(expr=- m.x260 - m.x262 + m.x264 -
                    m.x268 - m.x270 + m.x272 + m.x596 == 50)

m.c978 = Constraint(expr=- m.x261 - m.x263 + m.x265 -
                    m.x269 - m.x271 + m.x273 + m.x597 == 50)
...
m.c986 = Constraint(expr=- m.x264 - m.x265 - m.x272 -
                    m.x273 - m.x280 - m.x281 + m.x605 == 0)
...
m.c993 = Constraint(expr=- m.x264 - m.x265 - m.x272 -
                    m.x273 - m.x280 - m.x281 - m.x288 - m.x289 + m.x612 == 0)

m.c994 = Constraint(expr=m.x258 + m.x266 + m.x274 +
                    m.x282 + m.x290 + m.x613 == 100)

m.c995 = Constraint(expr=m.x259 + m.x267 + m.x275 +
                    m.x283 + m.x291 + m.x614 == 100)
...
m.c1001 = Constraint(expr=m.x258 + m.x266 + m.x274 +
                     m.x282 + m.x290 + m.x298 + m.x620 == 100)

m.c1002 = Constraint(expr=m.x259 + m.x267 + m.x275 +
                     m.x283 + m.x291 + m.x299 + m.x621 == 100)
...
m.c1008 = Constraint(expr=m.x258 + m.x266 + m.x274 +
                     m.x282 + m.x290 + m.x298 + m.x306 + m.x627 == 100)

m.c1009 = Constraint(expr=m.x259 + m.x267 + m.x275 +
                     m.x283 + m.x291 + m.x299 + m.x307 + m.x628 == 100)

m.c1010 = Constraint(expr=- m.x258 + m.x260 + m.x261 - m.x266 + m.x268 + m.x269 - m.x274 + m.x276 + m.x277 - m.x282
                     + m.x284 + m.x285 - m.x290 + m.x292 + m.x293 -
                     m.x298 + m.x300 + m.x301 - m.x306 + m.x308
                     + m.x309 + m.x629 == 25)

m.c1011 = Constraint(expr=- m.x259 + m.x262 + m.x263 - m.x267 + m.x270 + m.x271 - m.x275 + m.x278 + m.x279 - m.x283
                     + m.x286 + m.x287 - m.x291 + m.x294 + m.x295 -
                     m.x299 + m.x302 + m.x303 - m.x307 + m.x310
                     + m.x311 + m.x630 == 75)

m.c1012 = Constraint(expr=- m.x260 - m.x262 + m.x264 - m.x268 - m.x270 + m.x272 - m.x276 - m.x278 + m.x280 - m.x284
                     - m.x286 + m.x288 - m.x292 - m.x294 + m.x296 -
                     m.x300 - m.x302 + m.x304 - m.x308 - m.x310
                     + m.x312 + m.x631 == 50)

m.c1013 = Constraint(expr=- m.x261 - m.x263 + m.x265 - m.x269 - m.x271 + m.x273 - m.x277 - m.x279 + m.x281 - m.x285
                     - m.x287 + m.x289 - m.x293 - m.x295 + m.x297 -
                     m.x301 - m.x303 + m.x305 - m.x309 - m.x311
                     + m.x313 + m.x632 == 50)
...
m.c1079 = Constraint(expr=- m.x322 + m.x330 + m.x334 -
                     m.x354 + m.x362 + m.x366 + m.x698 == 25)

m.c1080 = Constraint(expr=- m.x323 + m.x331 + m.x335 -
                     m.x355 + m.x363 + m.x367 + m.x699 == 0)

m.c1081 = Constraint(expr=- m.x324 + m.x332 + m.x336 -
                     m.x356 + m.x364 + m.x368 + m.x700 == 0)

m.c1082 = Constraint(expr=- m.x325 + m.x333 + m.x337 -
                     m.x357 + m.x365 + m.x369 + m.x701 == 0)

m.c1083 = Constraint(expr=- m.x326 + m.x338 + m.x342 -
                     m.x358 + m.x370 + m.x374 + m.x702 == 0)

m.c1084 = Constraint(expr=- m.x327 + m.x339 + m.x343 -
                     m.x359 + m.x371 + m.x375 + m.x703 == 75)

m.c1085 = Constraint(expr=- m.x328 + m.x340 + m.x344 -
                     m.x360 + m.x372 + m.x376 + m.x704 == 0)

m.c1086 = Constraint(expr=- m.x329 + m.x341 + m.x345 -
                     m.x361 + m.x373 + m.x377 + m.x705 == 0)

m.c1087 = Constraint(expr=- m.x330 - m.x338 + m.x346 -
                     m.x362 - m.x370 + m.x378 + m.x706 == 0)

m.c1088 = Constraint(expr=- m.x331 - m.x339 + m.x347 -
                     m.x363 - m.x371 + m.x379 + m.x707 == 0)

m.c1089 = Constraint(expr=- m.x332 - m.x340 + m.x348 -
                     m.x364 - m.x372 + m.x380 + m.x708 == 50)

m.c1090 = Constraint(expr=- m.x333 - m.x341 + m.x349 -
                     m.x365 - m.x373 + m.x381 + m.x709 == 0)

m.c1091 = Constraint(expr=- m.x334 - m.x342 + m.x350 -
                     m.x366 - m.x374 + m.x382 + m.x710 == 0)

m.c1092 = Constraint(expr=- m.x335 - m.x343 + m.x351 -
                     m.x367 - m.x375 + m.x383 + m.x711 == 0)

m.c1093 = Constraint(expr=- m.x336 - m.x344 + m.x352 -
                     m.x368 - m.x376 + m.x384 + m.x712 == 0)

m.c1094 = Constraint(expr=- m.x337 - m.x345 + m.x353 -
                     m.x369 - m.x377 + m.x385 + m.x713 == 50)
...
m.c1123 = Constraint(expr=- m.x346 - m.x350 - m.x378 -
                     m.x382 - m.x410 - m.x414 + m.x742 == 0)

m.c1124 = Constraint(expr=- m.x347 - m.x351 - m.x379 -
                     m.x383 - m.x411 - m.x415 + m.x743 == 0)

m.c1125 = Constraint(expr=- m.x348 - m.x352 - m.x380 -
                     m.x384 - m.x412 - m.x416 + m.x744 == 0)

m.c1126 = Constraint(expr=- m.x349 - m.x353 - m.x381 -
                     m.x385 - m.x413 - m.x417 + m.x745 == 0)
...
m.c1151 = Constraint(expr=- m.x346 - m.x350 - m.x378 -
                     m.x382 - m.x410 - m.x414 - m.x442 - m.x446 + m.x770 == 0)

m.c1152 = Constraint(expr=- m.x347 - m.x351 - m.x379 -
                     m.x383 - m.x411 - m.x415 - m.x443 - m.x447 + m.x771 == 0)

m.c1153 = Constraint(expr=- m.x348 - m.x352 - m.x380 -
                     m.x384 - m.x412 - m.x416 - m.x444 - m.x448 + m.x772 == 0)

m.c1154 = Constraint(expr=- m.x349 - m.x353 - m.x381 -
                     m.x385 - m.x413 - m.x417 - m.x445 - m.x449 + m.x773 == 0)

m.c1155 = Constraint(expr=m.x322 + m.x354 + m.x386 +
                     m.x418 + m.x450 + m.x774 == 100)

m.c1156 = Constraint(expr=m.x323 + m.x355 + m.x387 +
                     m.x419 + m.x451 + m.x775 == 0)

m.c1157 = Constraint(expr=m.x324 + m.x356 + m.x388 +
                     m.x420 + m.x452 + m.x776 == 0)

m.c1158 = Constraint(expr=m.x325 + m.x357 + m.x389 +
                     m.x421 + m.x453 + m.x777 == 0)

m.c1159 = Constraint(expr=m.x326 + m.x358 + m.x390 +
                     m.x422 + m.x454 + m.x778 == 0)

m.c1160 = Constraint(expr=m.x327 + m.x359 + m.x391 +
                     m.x423 + m.x455 + m.x779 == 100)

m.c1161 = Constraint(expr=m.x328 + m.x360 + m.x392 +
                     m.x424 + m.x456 + m.x780 == 0)

m.c1162 = Constraint(expr=m.x329 + m.x361 + m.x393 +
                     m.x425 + m.x457 + m.x781 == 0)
...
m.c1183 = Constraint(expr=m.x322 + m.x354 + m.x386 +
                     m.x418 + m.x450 + m.x482 + m.x802 == 100)

m.c1184 = Constraint(expr=m.x323 + m.x355 + m.x387 +
                     m.x419 + m.x451 + m.x483 + m.x803 == 0)

m.c1185 = Constraint(expr=m.x324 + m.x356 + m.x388 +
                     m.x420 + m.x452 + m.x484 + m.x804 == 0)

m.c1186 = Constraint(expr=m.x325 + m.x357 + m.x389 +
                     m.x421 + m.x453 + m.x485 + m.x805 == 0)

m.c1187 = Constraint(expr=m.x326 + m.x358 + m.x390 +
                     m.x422 + m.x454 + m.x486 + m.x806 == 0)

m.c1188 = Constraint(expr=m.x327 + m.x359 + m.x391 +
                     m.x423 + m.x455 + m.x487 + m.x807 == 100)

m.c1189 = Constraint(expr=m.x328 + m.x360 + m.x392 +
                     m.x424 + m.x456 + m.x488 + m.x808 == 0)

m.c1190 = Constraint(expr=m.x329 + m.x361 + m.x393 +
                     m.x425 + m.x457 + m.x489 + m.x809 == 0)
...
m.c1211 = Constraint(expr=m.x322 + m.x354 + m.x386 +
                     m.x418 + m.x450 + m.x482 + m.x514 + m.x830 == 100)

m.c1212 = Constraint(expr=m.x323 + m.x355 + m.x387 +
                     m.x419 + m.x451 + m.x483 + m.x515 + m.x831 == 0)

m.c1213 = Constraint(expr=m.x324 + m.x356 + m.x388 +
                     m.x420 + m.x452 + m.x484 + m.x516 + m.x832 == 0)

m.c1214 = Constraint(expr=m.x325 + m.x357 + m.x389 +
                     m.x421 + m.x453 + m.x485 + m.x517 + m.x833 == 0)

m.c1215 = Constraint(expr=m.x326 + m.x358 + m.x390 +
                     m.x422 + m.x454 + m.x486 + m.x518 + m.x834 == 0)

m.c1216 = Constraint(expr=m.x327 + m.x359 + m.x391 +
                     m.x423 + m.x455 + m.x487 + m.x519 + m.x835 == 100)

m.c1217 = Constraint(expr=m.x328 + m.x360 + m.x392 +
                     m.x424 + m.x456 + m.x488 + m.x520 + m.x836 == 0)

m.c1218 = Constraint(expr=m.x329 + m.x361 + m.x393 +
                     m.x425 + m.x457 + m.x489 + m.x521 + m.x837 == 0)

m.c1219 = Constraint(expr=- m.x322 + m.x330 + m.x334 - m.x354 + m.x362 + m.x366 - m.x386 + m.x394 + m.x398 - m.x418
                     + m.x426 + m.x430 - m.x450 + m.x458 + m.x462 -
                     m.x482 + m.x490 + m.x494 - m.x514 + m.x522
                     + m.x526 + m.x838 == 25)

m.c1220 = Constraint(expr=- m.x323 + m.x331 + m.x335 - m.x355 + m.x363 + m.x367 - m.x387 + m.x395 + m.x399 - m.x419
                     + m.x427 + m.x431 - m.x451 + m.x459 + m.x463 -
                     m.x483 + m.x491 + m.x495 - m.x515 + m.x523
                     + m.x527 + m.x839 == 0)

m.c1221 = Constraint(expr=- m.x324 + m.x332 + m.x336 - m.x356 + m.x364 + m.x368 - m.x388 + m.x396 + m.x400 - m.x420
                     + m.x428 + m.x432 - m.x452 + m.x460 + m.x464 -
                     m.x484 + m.x492 + m.x496 - m.x516 + m.x524
                     + m.x528 + m.x840 == 0)

m.c1222 = Constraint(expr=- m.x325 + m.x333 + m.x337 - m.x357 + m.x365 + m.x369 - m.x389 + m.x397 + m.x401 - m.x421
                     + m.x429 + m.x433 - m.x453 + m.x461 + m.x465 -
...
m.c1624 = Constraint(expr=m.x264 + m.x272 + m.x280 +
                     m.x288 + m.x296 + m.x304 + m.x312 + m.x320 >= 100)

m.c1625 = Constraint(expr=m.x265 + m.x273 + m.x281 +
                     m.x289 + m.x297 + m.x305 + m.x313 + m.x321 >= 100)

m.c1626 = Constraint(expr=m.x264 + m.x272 + m.x280 +
                     m.x288 + m.x296 + m.x304 + m.x312 + m.x320 <= 100)

m.c1627 = Constraint(expr=m.x265 + m.x273 + m.x281 +
                     m.x289 + m.x297 + m.x305 + m.x313 + m.x321 <= 100)

m.c1628 = Constraint(expr=- 0.15*m.x264 + 0.1*m.x346 +
                     0.6*m.x347 + 0.2*m.x348 + 0.5*m.x349 >= 0)

m.c1629 = Constraint(expr=- 0.45*m.x265 + 0.1*m.x350 +
                     0.6*m.x351 + 0.2*m.x352 + 0.5*m.x353 >= 0)

m.c1630 = Constraint(expr=- 0.15*m.x272 + 0.1*m.x378 +
                     0.6*m.x379 + 0.2*m.x380 + 0.5*m.x381 >= 0)

m.c1631 = Constraint(expr=- 0.45*m.x273 + 0.1*m.x382 +
                     0.6*m.x383 + 0.2*m.x384 + 0.5*m.x385 >= 0)

m.c1632 = Constraint(expr=- 0.15*m.x280 + 0.1*m.x410 +
                     0.6*m.x411 + 0.2*m.x412 + 0.5*m.x413 >= 0)

m.c1633 = Constraint(expr=- 0.45*m.x281 + 0.1*m.x414 +
                     0.6*m.x415 + 0.2*m.x416 + 0.5*m.x417 >= 0)

m.c1634 = Constraint(expr=- 0.15*m.x288 + 0.1*m.x442 +
                     0.6*m.x443 + 0.2*m.x444 + 0.5*m.x445 >= 0)

m.c1635 = Constraint(expr=- 0.45*m.x289 + 0.1*m.x446 +
                     0.6*m.x447 + 0.2*m.x448 + 0.5*m.x449 >= 0)

m.c1636 = Constraint(expr=- 0.15*m.x296 + 0.1*m.x474 +
                     0.6*m.x475 + 0.2*m.x476 + 0.5*m.x477 >= 0)

m.c1637 = Constraint(expr=- 0.45*m.x297 + 0.1*m.x478 +
                     0.6*m.x479 + 0.2*m.x480 + 0.5*m.x481 >= 0)

m.c1638 = Constraint(expr=- 0.15*m.x304 + 0.1*m.x506 +
                     0.6*m.x507 + 0.2*m.x508 + 0.5*m.x509 >= 0)

m.c1639 = Constraint(expr=- 0.45*m.x305 + 0.1*m.x510 +
                     0.6*m.x511 + 0.2*m.x512 + 0.5*m.x513 >= 0)

m.c1640 = Constraint(expr=- 0.15*m.x312 + 0.1*m.x538 +
                     0.6*m.x539 + 0.2*m.x540 + 0.5*m.x541 >= 0)

m.c1641 = Constraint(expr=- 0.45*m.x313 + 0.1*m.x542 +
                     0.6*m.x543 + 0.2*m.x544 + 0.5*m.x545 >= 0)

m.c1642 = Constraint(expr=- 0.15*m.x320 + 0.1*m.x570 +
                     0.6*m.x571 + 0.2*m.x572 + 0.5*m.x573 >= 0)

m.c1643 = Constraint(expr=- 0.45*m.x321 + 0.1*m.x574 +
                     0.6*m.x575 + 0.2*m.x576 + 0.5*m.x577 >= 0)

m.c1644 = Constraint(expr=- 0.25*m.x264 + 0.1*m.x346 +
                     0.6*m.x347 + 0.2*m.x348 + 0.5*m.x349 <= 0)

m.c1645 = Constraint(expr=- 0.55*m.x265 + 0.1*m.x350 +
                     0.6*m.x351 + 0.2*m.x352 + 0.5*m.x353 <= 0)

m.c1646 = Constraint(expr=- 0.25*m.x272 + 0.1*m.x378 +
                     0.6*m.x379 + 0.2*m.x380 + 0.5*m.x381 <= 0)

m.c1647 = Constraint(expr=- 0.55*m.x273 + 0.1*m.x382 +
                     0.6*m.x383 + 0.2*m.x384 + 0.5*m.x385 <= 0)

m.c1648 = Constraint(expr=- 0.25*m.x280 + 0.1*m.x410 +
                     0.6*m.x411 + 0.2*m.x412 + 0.5*m.x413 <= 0)

m.c1649 = Constraint(expr=- 0.55*m.x281 + 0.1*m.x414 +
                     0.6*m.x415 + 0.2*m.x416 + 0.5*m.x417 <= 0)

m.c1650 = Constraint(expr=- 0.25*m.x288 + 0.1*m.x442 +
                     0.6*m.x443 + 0.2*m.x444 + 0.5*m.x445 <= 0)

m.c1651 = Constraint(expr=- 0.55*m.x289 + 0.1*m.x446 +
                     0.6*m.x447 + 0.2*m.x448 + 0.5*m.x449 <= 0)

m.c1652 = Constraint(expr=- 0.25*m.x296 + 0.1*m.x474 +
                     0.6*m.x475 + 0.2*m.x476 + 0.5*m.x477 <= 0)

m.c1653 = Constraint(expr=- 0.55*m.x297 + 0.1*m.x478 +
                     0.6*m.x479 + 0.2*m.x480 + 0.5*m.x481 <= 0)

m.c1654 = Constraint(expr=- 0.25*m.x304 + 0.1*m.x506 +
                     0.6*m.x507 + 0.2*m.x508 + 0.5*m.x509 <= 0)

m.c1655 = Constraint(expr=- 0.55*m.x305 + 0.1*m.x510 +
                     0.6*m.x511 + 0.2*m.x512 + 0.5*m.x513 <= 0)

m.c1656 = Constraint(expr=- 0.25*m.x312 + 0.1*m.x538 +
                     0.6*m.x539 + 0.2*m.x540 + 0.5*m.x541 <= 0)

m.c1657 = Constraint(expr=- 0.55*m.x313 + 0.1*m.x542 +
                     0.6*m.x543 + 0.2*m.x544 + 0.5*m.x545 <= 0)

m.c1658 = Constraint(expr=- 0.25*m.x320 + 0.1*m.x570 +
                     0.6*m.x571 + 0.2*m.x572 + 0.5*m.x573 <= 0)

m.c1659 = Constraint(expr=- 0.55*m.x321 + 0.1*m.x574 +
                     0.6*m.x575 + 0.2*m.x576 + 0.5*m.x577 <= 0)

m.c1660 = Constraint(expr=- m.x258 - m.x266 - m.x274 -
                     m.x282 - m.x290 - m.x298 - m.x306 - m.x314 >= -100)

m.c1661 = Constraint(expr=- m.x259 - m.x267 - m.x275 -
                     m.x283 - m.x291 - m.x299 - m.x307 - m.x315 >= -100)
...
m.c1667 = Constraint(expr=- m.x258 - m.x266 - m.x274 -
                     m.x282 - m.x290 - m.x298 - m.x306 - m.x314 <= 0)

m.c1668 = Constraint(expr=- m.x259 - m.x267 - m.x275 -
                     m.x283 - m.x291 - m.x299 - m.x307 - m.x315 <= 0)
...
m.c1673 = Constraint(expr=- m.x322 - m.x354 - m.x386 -
                     m.x418 - m.x450 - m.x482 - m.x514 - m.x546 >= -100)

m.c1674 = Constraint(expr=- m.x323 - m.x355 - m.x387 -
                     m.x419 - m.x451 - m.x483 - m.x515 - m.x547 >= 0)

m.c1675 = Constraint(expr=- m.x324 - m.x356 - m.x388 -
                     m.x420 - m.x452 - m.x484 - m.x516 - m.x548 >= 0)

m.c1676 = Constraint(expr=- m.x325 - m.x357 - m.x389 -
                     m.x421 - m.x453 - m.x485 - m.x517 - m.x549 >= 0)

m.c1677 = Constraint(expr=- m.x326 - m.x358 - m.x390 -
                     m.x422 - m.x454 - m.x486 - m.x518 - m.x550 >= 0)

m.c1678 = Constraint(expr=- m.x327 - m.x359 - m.x391 -
                     m.x423 - m.x455 - m.x487 - m.x519 - m.x551 >= -100)

m.c1679 = Constraint(expr=- m.x328 - m.x360 - m.x392 -
                     m.x424 - m.x456 - m.x488 - m.x520 - m.x552 >= 0)

m.c1680 = Constraint(expr=- m.x329 - m.x361 - m.x393 -
                     m.x425 - m.x457 - m.x489 - m.x521 - m.x553 >= 0)
...
m.c1701 = Constraint(expr=- m.x322 - m.x354 - m.x386 -
                     m.x418 - m.x450 - m.x482 - m.x514 - m.x546 <= 0)

m.c1702 = Constraint(expr=- m.x323 - m.x355 - m.x387 -
                     m.x419 - m.x451 - m.x483 - m.x515 - m.x547 <= 100)

m.c1703 = Constraint(expr=- m.x324 - m.x356 - m.x388 -
                     m.x420 - m.x452 - m.x484 - m.x516 - m.x548 <= 100)

m.c1704 = Constraint(expr=- m.x325 - m.x357 - m.x389 -
                     m.x421 - m.x453 - m.x485 - m.x517 - m.x549 <= 100)

m.c1705 = Constraint(expr=- m.x326 - m.x358 - m.x390 -
                     m.x422 - m.x454 - m.x486 - m.x518 - m.x550 <= 100)

m.c1706 = Constraint(expr=- m.x327 - m.x359 - m.x391 -
                     m.x423 - m.x455 - m.x487 - m.x519 - m.x551 <= 0)

m.c1707 = Constraint(expr=- m.x328 - m.x360 - m.x392 -
                     m.x424 - m.x456 - m.x488 - m.x520 - m.x552 <= 100)

m.c1708 = Constraint(expr=- m.x329 - m.x361 - m.x393 -
                     m.x425 - m.x457 - m.x489 - m.x521 - m.x553 <= 100)
...
m.c1725 = Constraint(expr=8*m.b10 + 8*m.b11 - m.x74 -
                     m.x75 + m.x194 + m.x195 <= 8)

m.c1726 = Constraint(expr=8*m.b10 + 8*m.b12 - m.x74 -
                     m.x76 + m.x194 + m.x196 <= 8)

m.c1727 = Constraint(expr=8*m.b10 + 8*m.b13 - m.x74 -
                     m.x77 + m.x194 + m.x197 <= 8)

m.c1728 = Constraint(expr=8*m.b11 + 8*m.b14 - m.x75 -
                     m.x78 + m.x195 + m.x198 <= 8)

m.c1729 = Constraint(expr=8*m.b11 + 8*m.b15 - m.x75 -
                     m.x79 + m.x195 + m.x199 <= 8)

m.c1730 = Constraint(expr=8*m.b12 + 8*m.b16 - m.x76 -
                     m.x80 + m.x196 + m.x200 <= 8)

m.c1731 = Constraint(expr=8*m.b13 + 8*m.b17 - m.x77 -
                     m.x81 + m.x197 + m.x201 <= 8)

m.c1732 = Constraint(expr=8*m.b14 + 8*m.b16 - m.x78 -
                     m.x80 + m.x198 + m.x200 <= 8)

m.c1733 = Constraint(expr=8*m.b15 + 8*m.b17 - m.x79 -
                     m.x81 + m.x199 + m.x201 <= 8)

m.c1734 = Constraint(expr=8*m.b16 + 8*m.b17 - m.x80 -
                     m.x81 + m.x200 + m.x201 <= 8)

m.c1735 = Constraint(expr=8*m.b18 + 8*m.b19 - m.x82 -
                     m.x83 + m.x138 + m.x139 + m.x194 + m.x195 <= 8)

m.c1736 = Constraint(expr=8*m.b18 + 8*m.b20 - m.x82 -
                     m.x84 + m.x138 + m.x140 + m.x194 + m.x196 <= 8)

m.c1737 = Constraint(expr=8*m.b18 + 8*m.b21 - m.x82 -
                     m.x85 + m.x138 + m.x141 + m.x194 + m.x197 <= 8)

m.c1738 = Constraint(expr=8*m.b19 + 8*m.b22 - m.x83 -
                     m.x86 + m.x139 + m.x142 + m.x195 + m.x198 <= 8)

m.c1739 = Constraint(expr=8*m.b19 + 8*m.b23 - m.x83 -
                     m.x87 + m.x139 + m.x143 + m.x195 + m.x199 <= 8)

m.c1740 = Constraint(expr=8*m.b20 + 8*m.b24 - m.x84 -
                     m.x88 + m.x140 + m.x144 + m.x196 + m.x200 <= 8)

m.c1741 = Constraint(expr=8*m.b21 + 8*m.b25 - m.x85 -
                     m.x89 + m.x141 + m.x145 + m.x197 + m.x201 <= 8)

m.c1742 = Constraint(expr=8*m.b22 + 8*m.b24 - m.x86 -
                     m.x88 + m.x142 + m.x144 + m.x198 + m.x200 <= 8)

m.c1743 = Constraint(expr=8*m.b23 + 8*m.b25 - m.x87 -
                     m.x89 + m.x143 + m.x145 + m.x199 + m.x201 <= 8)

m.c1744 = Constraint(expr=8*m.b24 + 8*m.b25 - m.x88 -
                     m.x89 + m.x144 + m.x145 + m.x200 + m.x201 <= 8)
...
m.c1795 = Constraint(expr=8*m.b18 + 8*m.b19 - m.x82 -
                     m.x83 + m.x202 + m.x203 <= 8)

m.c1796 = Constraint(expr=8*m.b18 + 8*m.b20 - m.x82 -
                     m.x84 + m.x202 + m.x204 <= 8)

m.c1797 = Constraint(expr=8*m.b18 + 8*m.b21 - m.x82 -
                     m.x85 + m.x202 + m.x205 <= 8)

m.c1798 = Constraint(expr=8*m.b19 + 8*m.b22 - m.x83 -
                     m.x86 + m.x203 + m.x206 <= 8)

m.c1799 = Constraint(expr=8*m.b19 + 8*m.b23 - m.x83 -
                     m.x87 + m.x203 + m.x207 <= 8)

m.c1800 = Constraint(expr=8*m.b20 + 8*m.b24 - m.x84 -
                     m.x88 + m.x204 + m.x208 <= 8)

m.c1801 = Constraint(expr=8*m.b21 + 8*m.b25 - m.x85 -
                     m.x89 + m.x205 + m.x209 <= 8)

m.c1802 = Constraint(expr=8*m.b22 + 8*m.b24 - m.x86 -
                     m.x88 + m.x206 + m.x208 <= 8)

m.c1803 = Constraint(expr=8*m.b23 + 8*m.b25 - m.x87 -
                     m.x89 + m.x207 + m.x209 <= 8)

m.c1804 = Constraint(expr=8*m.b24 + 8*m.b25 - m.x88 -
                     m.x89 + m.x208 + m.x209 <= 8)

m.c1805 = Constraint(expr=8*m.b26 + 8*m.b27 - m.x90 -
                     m.x91 + m.x146 + m.x147 + m.x202 + m.x203 <= 8)

m.c1806 = Constraint(expr=8*m.b26 + 8*m.b28 - m.x90 -
                     m.x92 + m.x146 + m.x148 + m.x202 + m.x204 <= 8)

m.c1807 = Constraint(expr=8*m.b26 + 8*m.b29 - m.x90 -
                     m.x93 + m.x146 + m.x149 + m.x202 + m.x205 <= 8)

m.c1808 = Constraint(expr=8*m.b27 + 8*m.b30 - m.x91 -
                     m.x94 + m.x147 + m.x150 + m.x203 + m.x206 <= 8)

m.c1809 = Constraint(expr=8*m.b27 + 8*m.b31 - m.x91 -
                     m.x95 + m.x147 + m.x151 + m.x203 + m.x207 <= 8)

m.c1810 = Constraint(expr=8*m.b28 + 8*m.b32 - m.x92 -
                     m.x96 + m.x148 + m.x152 + m.x204 + m.x208 <= 8)

m.c1811 = Constraint(expr=8*m.b29 + 8*m.b33 - m.x93 -
                     m.x97 + m.x149 + m.x153 + m.x205 + m.x209 <= 8)

m.c1812 = Constraint(expr=8*m.b30 + 8*m.b32 - m.x94 -
                     m.x96 + m.x150 + m.x152 + m.x206 + m.x208 <= 8)

m.c1813 = Constraint(expr=8*m.b31 + 8*m.b33 - m.x95 -
                     m.x97 + m.x151 + m.x153 + m.x207 + m.x209 <= 8)

m.c1814 = Constraint(expr=8*m.b32 + 8*m.b33 - m.x96 -
                     m.x97 + m.x152 + m.x153 + m.x208 + m.x209 <= 8)
...
m.c1855 = Constraint(expr=8*m.b26 + 8*m.b27 - m.x90 -
                     m.x91 + m.x210 + m.x211 <= 8)

m.c1856 = Constraint(expr=8*m.b26 + 8*m.b28 - m.x90 -
                     m.x92 + m.x210 + m.x212 <= 8)

m.c1857 = Constraint(expr=8*m.b26 + 8*m.b29 - m.x90 -
                     m.x93 + m.x210 + m.x213 <= 8)

m.c1858 = Constraint(expr=8*m.b27 + 8*m.b30 - m.x91 -
                     m.x94 + m.x211 + m.x214 <= 8)

m.c1859 = Constraint(expr=8*m.b27 + 8*m.b31 - m.x91 -
                     m.x95 + m.x211 + m.x215 <= 8)

m.c1860 = Constraint(expr=8*m.b28 + 8*m.b32 - m.x92 -
                     m.x96 + m.x212 + m.x216 <= 8)

m.c1861 = Constraint(expr=8*m.b29 + 8*m.b33 - m.x93 -
                     m.x97 + m.x213 + m.x217 <= 8)

m.c1862 = Constraint(expr=8*m.b30 + 8*m.b32 - m.x94 -
                     m.x96 + m.x214 + m.x216 <= 8)

m.c1863 = Constraint(expr=8*m.b31 + 8*m.b33 - m.x95 -
                     m.x97 + m.x215 + m.x217 <= 8)

m.c1864 = Constraint(expr=8*m.b32 + 8*m.b33 - m.x96 -
                     m.x97 + m.x216 + m.x217 <= 8)

m.c1865 = Constraint(expr=8*m.b34 + 8*m.b35 - m.x98 -
                     m.x99 + m.x154 + m.x155 + m.x210 + m.x211 <= 8)

m.c1866 = Constraint(expr=8*m.b34 + 8*m.b36 - m.x98 -
                     m.x100 + m.x154 + m.x156 + m.x210 + m.x212 <= 8)

m.c1867 = Constraint(expr=8*m.b34 + 8*m.b37 - m.x98 -
                     m.x101 + m.x154 + m.x157 + m.x210 + m.x213 <= 8)

m.c1868 = Constraint(expr=8*m.b35 + 8*m.b38 - m.x99 -
                     m.x102 + m.x155 + m.x158 + m.x211 + m.x214 <= 8)

m.c1869 = Constraint(expr=8*m.b35 + 8*m.b39 - m.x99 -
                     m.x103 + m.x155 + m.x159 + m.x211 + m.x215 <= 8)

m.c1870 = Constraint(expr=8*m.b36 + 8*m.b40 - m.x100 -
                     m.x104 + m.x156 + m.x160 + m.x212 + m.x216 <= 8)

m.c1871 = Constraint(expr=8*m.b37 + 8*m.b41 - m.x101 -
                     m.x105 + m.x157 + m.x161 + m.x213 + m.x217 <= 8)

m.c1872 = Constraint(expr=8*m.b38 + 8*m.b40 - m.x102 -
                     m.x104 + m.x158 + m.x160 + m.x214 + m.x216 <= 8)

m.c1873 = Constraint(expr=8*m.b39 + 8*m.b41 - m.x103 -
                     m.x105 + m.x159 + m.x161 + m.x215 + m.x217 <= 8)

m.c1874 = Constraint(expr=8*m.b40 + 8*m.b41 - m.x104 -
                     m.x105 + m.x160 + m.x161 + m.x216 + m.x217 <= 8)
...
m.c1905 = Constraint(expr=8*m.b34 + 8*m.b35 - m.x98 -
                     m.x99 + m.x218 + m.x219 <= 8)

m.c1906 = Constraint(expr=8*m.b34 + 8*m.b36 - m.x98 -
                     m.x100 + m.x218 + m.x220 <= 8)

m.c1907 = Constraint(expr=8*m.b34 + 8*m.b37 - m.x98 -
                     m.x101 + m.x218 + m.x221 <= 8)

m.c1908 = Constraint(expr=8*m.b35 + 8*m.b38 - m.x99 -
                     m.x102 + m.x219 + m.x222 <= 8)

m.c1909 = Constraint(expr=8*m.b35 + 8*m.b39 - m.x99 -
                     m.x103 + m.x219 + m.x223 <= 8)

m.c1910 = Constraint(expr=8*m.b36 + 8*m.b40 - m.x100 -
                     m.x104 + m.x220 + m.x224 <= 8)

m.c1911 = Constraint(expr=8*m.b37 + 8*m.b41 - m.x101 -
                     m.x105 + m.x221 + m.x225 <= 8)

m.c1912 = Constraint(expr=8*m.b38 + 8*m.b40 - m.x102 -
                     m.x104 + m.x222 + m.x224 <= 8)

m.c1913 = Constraint(expr=8*m.b39 + 8*m.b41 - m.x103 -
                     m.x105 + m.x223 + m.x225 <= 8)

m.c1914 = Constraint(expr=8*m.b40 + 8*m.b41 - m.x104 -
                     m.x105 + m.x224 + m.x225 <= 8)

m.c1915 = Constraint(expr=8*m.b42 + 8*m.b43 - m.x106 -
                     m.x107 + m.x162 + m.x163 + m.x218 + m.x219 <= 8)

m.c1916 = Constraint(expr=8*m.b42 + 8*m.b44 - m.x106 -
                     m.x108 + m.x162 + m.x164 + m.x218 + m.x220 <= 8)

m.c1917 = Constraint(expr=8*m.b42 + 8*m.b45 - m.x106 -
                     m.x109 + m.x162 + m.x165 + m.x218 + m.x221 <= 8)

m.c1918 = Constraint(expr=8*m.b43 + 8*m.b46 - m.x107 -
                     m.x110 + m.x163 + m.x166 + m.x219 + m.x222 <= 8)

m.c1919 = Constraint(expr=8*m.b43 + 8*m.b47 - m.x107 -
                     m.x111 + m.x163 + m.x167 + m.x219 + m.x223 <= 8)

m.c1920 = Constraint(expr=8*m.b44 + 8*m.b48 - m.x108 -
                     m.x112 + m.x164 + m.x168 + m.x220 + m.x224 <= 8)

m.c1921 = Constraint(expr=8*m.b45 + 8*m.b49 - m.x109 -
                     m.x113 + m.x165 + m.x169 + m.x221 + m.x225 <= 8)

m.c1922 = Constraint(expr=8*m.b46 + 8*m.b48 - m.x110 -
                     m.x112 + m.x166 + m.x168 + m.x222 + m.x224 <= 8)

m.c1923 = Constraint(expr=8*m.b47 + 8*m.b49 - m.x111 -
                     m.x113 + m.x167 + m.x169 + m.x223 + m.x225 <= 8)

m.c1924 = Constraint(expr=8*m.b48 + 8*m.b49 - m.x112 -
                     m.x113 + m.x168 + m.x169 + m.x224 + m.x225 <= 8)
...
m.c1945 = Constraint(expr=8*m.b42 + 8*m.b43 - m.x106 -
                     m.x107 + m.x226 + m.x227 <= 8)

m.c1946 = Constraint(expr=8*m.b42 + 8*m.b44 - m.x106 -
                     m.x108 + m.x226 + m.x228 <= 8)

m.c1947 = Constraint(expr=8*m.b42 + 8*m.b45 - m.x106 -
                     m.x109 + m.x226 + m.x229 <= 8)

m.c1948 = Constraint(expr=8*m.b43 + 8*m.b46 - m.x107 -
                     m.x110 + m.x227 + m.x230 <= 8)

m.c1949 = Constraint(expr=8*m.b43 + 8*m.b47 - m.x107 -
                     m.x111 + m.x227 + m.x231 <= 8)

m.c1950 = Constraint(expr=8*m.b44 + 8*m.b48 - m.x108 -
                     m.x112 + m.x228 + m.x232 <= 8)

m.c1951 = Constraint(expr=8*m.b45 + 8*m.b49 - m.x109 -
                     m.x113 + m.x229 + m.x233 <= 8)

m.c1952 = Constraint(expr=8*m.b46 + 8*m.b48 - m.x110 -
                     m.x112 + m.x230 + m.x232 <= 8)

m.c1953 = Constraint(expr=8*m.b47 + 8*m.b49 - m.x111 -
                     m.x113 + m.x231 + m.x233 <= 8)

m.c1954 = Constraint(expr=8*m.b48 + 8*m.b49 - m.x112 -
                     m.x113 + m.x232 + m.x233 <= 8)

m.c1955 = Constraint(expr=8*m.b50 + 8*m.b51 - m.x114 -
                     m.x115 + m.x170 + m.x171 + m.x226 + m.x227 <= 8)

m.c1956 = Constraint(expr=8*m.b50 + 8*m.b52 - m.x114 -
                     m.x116 + m.x170 + m.x172 + m.x226 + m.x228 <= 8)

m.c1957 = Constraint(expr=8*m.b50 + 8*m.b53 - m.x114 -
                     m.x117 + m.x170 + m.x173 + m.x226 + m.x229 <= 8)

m.c1958 = Constraint(expr=8*m.b51 + 8*m.b54 - m.x115 -
                     m.x118 + m.x171 + m.x174 + m.x227 + m.x230 <= 8)

m.c1959 = Constraint(expr=8*m.b51 + 8*m.b55 - m.x115 -
                     m.x119 + m.x171 + m.x175 + m.x227 + m.x231 <= 8)

m.c1960 = Constraint(expr=8*m.b52 + 8*m.b56 - m.x116 -
                     m.x120 + m.x172 + m.x176 + m.x228 + m.x232 <= 8)

m.c1961 = Constraint(expr=8*m.b53 + 8*m.b57 - m.x117 -
                     m.x121 + m.x173 + m.x177 + m.x229 + m.x233 <= 8)

m.c1962 = Constraint(expr=8*m.b54 + 8*m.b56 - m.x118 -
                     m.x120 + m.x174 + m.x176 + m.x230 + m.x232 <= 8)

m.c1963 = Constraint(expr=8*m.b55 + 8*m.b57 - m.x119 -
                     m.x121 + m.x175 + m.x177 + m.x231 + m.x233 <= 8)

m.c1964 = Constraint(expr=8*m.b56 + 8*m.b57 - m.x120 -
                     m.x121 + m.x176 + m.x177 + m.x232 + m.x233 <= 8)
...
m.c1975 = Constraint(expr=8*m.b50 + 8*m.b51 - m.x114 -
                     m.x115 + m.x234 + m.x235 <= 8)

m.c1976 = Constraint(expr=8*m.b50 + 8*m.b52 - m.x114 -
                     m.x116 + m.x234 + m.x236 <= 8)

m.c1977 = Constraint(expr=8*m.b50 + 8*m.b53 - m.x114 -
                     m.x117 + m.x234 + m.x237 <= 8)

m.c1978 = Constraint(expr=8*m.b51 + 8*m.b54 - m.x115 -
                     m.x118 + m.x235 + m.x238 <= 8)

m.c1979 = Constraint(expr=8*m.b51 + 8*m.b55 - m.x115 -
                     m.x119 + m.x235 + m.x239 <= 8)

m.c1980 = Constraint(expr=8*m.b52 + 8*m.b56 - m.x116 -
                     m.x120 + m.x236 + m.x240 <= 8)

m.c1981 = Constraint(expr=8*m.b53 + 8*m.b57 - m.x117 -
                     m.x121 + m.x237 + m.x241 <= 8)

m.c1982 = Constraint(expr=8*m.b54 + 8*m.b56 - m.x118 -
                     m.x120 + m.x238 + m.x240 <= 8)

m.c1983 = Constraint(expr=8*m.b55 + 8*m.b57 - m.x119 -
                     m.x121 + m.x239 + m.x241 <= 8)

m.c1984 = Constraint(expr=8*m.b56 + 8*m.b57 - m.x120 -
                     m.x121 + m.x240 + m.x241 <= 8)

m.c1985 = Constraint(expr=8*m.b58 + 8*m.b59 - m.x122 -
                     m.x123 + m.x178 + m.x179 + m.x234 + m.x235 <= 8)

m.c1986 = Constraint(expr=8*m.b58 + 8*m.b60 - m.x122 -
                     m.x124 + m.x178 + m.x180 + m.x234 + m.x236 <= 8)

m.c1987 = Constraint(expr=8*m.b58 + 8*m.b61 - m.x122 -
                     m.x125 + m.x178 + m.x181 + m.x234 + m.x237 <= 8)

m.c1988 = Constraint(expr=8*m.b59 + 8*m.b62 - m.x123 -
                     m.x126 + m.x179 + m.x182 + m.x235 + m.x238 <= 8)

m.c1989 = Constraint(expr=8*m.b59 + 8*m.b63 - m.x123 -
                     m.x127 + m.x179 + m.x183 + m.x235 + m.x239 <= 8)

m.c1990 = Constraint(expr=8*m.b60 + 8*m.b64 - m.x124 -
                     m.x128 + m.x180 + m.x184 + m.x236 + m.x240 <= 8)

m.c1991 = Constraint(expr=8*m.b61 + 8*m.b65 - m.x125 -
                     m.x129 + m.x181 + m.x185 + m.x237 + m.x241 <= 8)

m.c1992 = Constraint(expr=8*m.b62 + 8*m.b64 - m.x126 -
                     m.x128 + m.x182 + m.x184 + m.x238 + m.x240 <= 8)

m.c1993 = Constraint(expr=8*m.b63 + 8*m.b65 - m.x127 -
                     m.x129 + m.x183 + m.x185 + m.x239 + m.x241 <= 8)

m.c1994 = Constraint(expr=8*m.b64 + 8*m.b65 - m.x128 -
                     m.x129 + m.x184 + m.x185 + m.x240 + m.x241 <= 8)

m.c1995 = Constraint(expr=8*m.b58 + 8*m.b59 - m.x122 -
                     m.x123 + m.x242 + m.x243 <= 8)

m.c1996 = Constraint(expr=8*m.b58 + 8*m.b60 - m.x122 -
                     m.x124 + m.x242 + m.x244 <= 8)

m.c1997 = Constraint(expr=8*m.b58 + 8*m.b61 - m.x122 -
                     m.x125 + m.x242 + m.x245 <= 8)

m.c1998 = Constraint(expr=8*m.b59 + 8*m.b62 - m.x123 -
                     m.x126 + m.x243 + m.x246 <= 8)

m.c1999 = Constraint(expr=8*m.b59 + 8*m.b63 - m.x123 -
                     m.x127 + m.x243 + m.x247 <= 8)

m.c2000 = Constraint(expr=8*m.b60 + 8*m.b64 - m.x124 -
                     m.x128 + m.x244 + m.x248 <= 8)

m.c2001 = Constraint(expr=8*m.b61 + 8*m.b65 - m.x125 -
                     m.x129 + m.x245 + m.x249 <= 8)

m.c2002 = Constraint(expr=8*m.b62 + 8*m.b64 - m.x126 -
                     m.x128 + m.x246 + m.x248 <= 8)

m.c2003 = Constraint(expr=8*m.b63 + 8*m.b65 - m.x127 -
                     m.x129 + m.x247 + m.x249 <= 8)

m.c2004 = Constraint(expr=8*m.b64 + 8*m.b65 - m.x128 -
                     m.x129 + m.x248 + m.x249 <= 8)
