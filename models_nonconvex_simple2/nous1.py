...
m.c23 = Constraint(expr=m.x12*m.x34 + m.x14*m.x37 + m.x16 *
                   m.x40 + m.x18*m.x43 + 0.333333333333333*m.x20 == 30)

m.c24 = Constraint(expr=m.x12*m.x35 + m.x14*m.x38 + m.x16 *
                   m.x41 + m.x18*m.x44 + 0.333333333333333*m.x20 == 50)

m.c25 = Constraint(expr=m.x12*m.x36 + m.x14*m.x39 + m.x16 *
                   m.x42 + m.x18*m.x45 + 0.333333333333333*m.x20 == 30)

m.c26 = Constraint(expr=m.x13*m.x34 + m.x15*m.x37 + m.x17 *
                   m.x40 + m.x19*m.x43 + 0.333333333333333*m.x21 == 70)

m.c27 = Constraint(expr=m.x13*m.x35 + m.x15*m.x38 + m.x17 *
                   m.x41 + m.x19*m.x44 + 0.333333333333333*m.x21 == 50)

m.c28 = Constraint(expr=m.x13*m.x36 + m.x15*m.x39 + m.x17 *
                   m.x42 + m.x19*m.x45 + 0.333333333333333*m.x21 == 70)
