...
m.x2 = Var(within=Reals,bounds=(-9.98224908514663,15),initialize=0)
m.x3 = Var(within=Reals,bounds=(0.000117760330057457,5.72649360184566),initialize=0.000117760330057457)
m.x4 = Var(within=Reals,bounds=(0.000184834977784856,15),initialize=0.000184834977784856)
...
m.x28 = Var(within=Reals,bounds=(71.4094021436986,965.279886771274),initialize=250)
...
m.x44 = Var(within=Reals,bounds=(0,0.2),initialize=0)
m.x45 = Var(within=Reals,bounds=(0,0.1),initialize=0)
m.x46 = Var(within=Reals,bounds=(0,0.01),initialize=0)
...
m.x76 = Var(within=Reals,bounds=(0,0.973),initialize=0.631288202460475)
m.x77 = Var(within=Reals,bounds=(0,0.9964),initialize=0)
...
m.x100 = Var(within=Reals,bounds=(64.5007008990703,77.2227743679247),initialize=64.5007008990703)
...
m.x111 = Var(within=Reals,bounds=(0.235127309588761,0.811908497892596),initialize=0.301041609410609)
...
m.x114 = Var(within=Reals,bounds=(0.000960400687475034,0.00432018103288118),initialize=0.00151455376117237)
m.x115 = Var(within=Reals,bounds=(1.74971545292808,3.11123279137614),initialize=2.00246043473075)
m.x116 = Var(within=Reals,bounds=(0.0999999999999999,0.25),initialize=0.124026629740688)
m.x117 = Var(within=Reals,bounds=(72.5237288782701,86.3238670975489),initialize=73.8156778247339)
m.x118 = Var(within=Reals,bounds=(50.1320713690688,134.947014894021),initialize=55.4814551455366)
...
m.x122 = Var(within=Reals,bounds=(64.5007008990703,77.2227743679247),initialize=64.5007008990703)
...
m.x172 = Var(within=Reals,bounds=(0,10),initialize=0.0867960059629119)
...
m.x267 = Var(within=Reals,bounds=(0,30),initialize=2.64479565120751)
...
m.x272 = Var(within=Reals,bounds=(0,30),initialize=2.64479565120751)
...
m.x277 = Var(within=Reals,bounds=(0,30),initialize=2.64479565120751)
...
m.x282 = Var(within=Reals,bounds=(0,30),initialize=3.17375478144901)
m.x283 = Var(within=Reals,bounds=(0,30),initialize=1.81406204389446)
...
m.x287 = Var(within=Reals,bounds=(0,30),initialize=3.17375478144901)
m.x288 = Var(within=Reals,bounds=(0,30),initialize=1.81406204389446)
...
m.x293 = Var(within=Reals,bounds=(0,30),initialize=0.0181406204389446)
...
m.x297 = Var(within=Reals,bounds=(0,10),initialize=3.04680459019105)
...
m.x308 = Var(within=Reals,bounds=(0,10),initialize=1.43673713876441)
m.x309 = Var(within=Reals,bounds=(0,10),initialize=0.0208711825356255)
...
m.x313 = Var(within=Reals,bounds=(0,10),initialize=1.43673713876441)
m.x314 = Var(within=Reals,bounds=(0,10),initialize=0.0208711825356255)
...
m.x323 = Var(within=Reals,bounds=(0,10),initialize=1.43673713876441)
m.x324 = Var(within=Reals,bounds=(0,10),initialize=0.0208711825356255)
...
m.x328 = Var(within=Reals,bounds=(0,10),initialize=1.43673713876441)
m.x329 = Var(within=Reals,bounds=(0,10),initialize=0.0208711825356255)
...
m.x338 = Var(within=Reals,bounds=(0,10),initialize=1.43673713876441)
m.x339 = Var(within=Reals,bounds=(0,10),initialize=0.0208711825356255)
...
m.x353 = Var(within=Reals,bounds=(0,10),initialize=1.43673713876441)
m.x354 = Var(within=Reals,bounds=(0,10),initialize=0.0208711825356255)
m.x355 = Var(within=Reals,bounds=(0,10),initialize=0)
m.x356 = Var(within=Reals,bounds=(0,10),initialize=0.00121706253040703)
m.x357 = Var(within=Reals,bounds=(0,10),initialize=2.388938543077)
m.x358 = Var(within=Reals,bounds=(0,10),initialize=0.0143673713876441)
...
m.x364 = Var(within=Reals,bounds=(0,10),initialize=0.0208711825356255)
...
m.x384 = Var(within=Reals,bounds=(0,10),initialize=0.0208711825356255)
...
m.x389 = Var(within=Reals,bounds=(0,10),initialize=0.0208711825356255)
...
m.x394 = Var(within=Reals,bounds=(0,10),initialize=0.0208711825356255)
...
m.x403 = Var(within=Reals,bounds=(0,10),initialize=0.0711184883688385)
...
m.x457 = Var(within=Reals,bounds=(0,30),initialize=0.0253900382515921)
...
m.x467 = Var(within=Reals,bounds=(0,30),initialize=0.0253900382515921)
...
m.x472 = Var(within=Reals,bounds=(0,10),initialize=0.0253900382515921)
...
m.x552 = Var(within=Reals,bounds=(0,30),initialize=3.17375478144901)
m.x553 = Var(within=Reals,bounds=(0,30),initialize=1.81406204389446)
...
m.x652 = Var(within=Reals,bounds=(3,8.943),initialize=3)
...
m.obj = Objective(expr=   1.2*m.x1 + 1.155*m.x5 + 1.155*m.x6 + 1.155*m.x7 + 1.227*m.x8 + 0.375*m.x16 + 1.55*m.x17
                        + 1.12*m.x18 + 5171.7*m.x52 + 700*m.x53 + 700*m.x54 + 8000*m.x55 + 8000*m.x56 + 8000*m.x57
                        + 8000*m.x58 + 1.257*m.x71 + 1.57125*m.x72 + 0.7*m.x81 + 1275*m.x133 + 49*m.x135 - 10149*m.x163
                        - 6038.4*m.x167 + 49*m.x185 + 7140*m.x197 + 7140*m.x198 - 550.8*m.x220 - 1718.7*m.x221
                        - 550.8*m.x340 - 1718.7*m.x341 - 550.8*m.x460 - 1718.7*m.x461 - 550.8*m.x470 - 1718.7*m.x471
                        + 50.395*m.b710 + 74.3*m.b711 + 92.875*m.b712 + 1.126*m.b714 + 3.9*m.b715 + 48.106*m.b718
                        + 7.155*m.b719 + 10.155*m.b721 + m.x722, sense=minimize)
...
m.c45 = Constraint(expr=-(-3.52925925925925 + 3.52925925925925*m.x9)*m.x641*m.x137 + m.x5 == 0)

m.c46 = Constraint(expr=-(-3.52925925925925 + 3.52925925925925*m.x10)*m.x694*m.x190 + m.x6 == 0)

m.c47 = Constraint(expr=-(-3.52925925925925 + 3.52925925925925*m.x11)*m.x699*m.x195 + m.x7 == 0)

m.c48 = Constraint(expr=-(-3.52925925925925 + 3.52925925925925*m.x12)*m.x691*m.x187 + m.x8 == 0)
