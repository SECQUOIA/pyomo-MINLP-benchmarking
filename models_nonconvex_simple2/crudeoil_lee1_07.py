#  MINLP written by GAMS Convert at 08/20/20 01:30:48
#
#  Equation counts
#      Total        E        G        L        N        X        C        B
...
m.obj = Objective(expr=0.1*m.x306 + 0.6*m.x307 + 0.2*m.x308 + 0.5*m.x309 + 0.1*m.x310 + 0.6*m.x311 + 0.2*m.x312
                  + 0.5*m.x313 + 0.1*m.x338 + 0.6*m.x339 + 0.2 *
                  m.x340 + 0.5*m.x341 + 0.1*m.x342 + 0.6*m.x343
                  + 0.2*m.x344 + 0.5*m.x345 + 0.1*m.x370 + 0.6 *
                  m.x371 + 0.2*m.x372 + 0.5*m.x373 + 0.1*m.x374
                  + 0.6*m.x375 + 0.2*m.x376 + 0.5*m.x377 + 0.1 *
                  m.x402 + 0.6*m.x403 + 0.2*m.x404 + 0.5*m.x405
                  + 0.1*m.x406 + 0.6*m.x407 + 0.2*m.x408 + 0.5 *
                  m.x409 + 0.1*m.x434 + 0.6*m.x435 + 0.2*m.x436
                  + 0.5*m.x437 + 0.1*m.x438 + 0.6*m.x439 + 0.2 *
                  m.x440 + 0.5*m.x441 + 0.1*m.x466 + 0.6*m.x467
                  + 0.2*m.x468 + 0.5*m.x469 + 0.1*m.x470 + 0.6 *
                  m.x471 + 0.2*m.x472 + 0.5*m.x473 + 0.1*m.x498
                  + 0.6*m.x499 + 0.2*m.x500 + 0.5*m.x501 + 0.1*m.x502 + 0.6*m.x503 + 0.2*m.x504 + 0.5*m.x505, sense=maximize)
...
m.c72 = Constraint(expr=m.b2 + m.b10 + m.b18 +
                   m.b26 + m.b34 + m.b42 + m.b50 >= 1)

m.c73 = Constraint(expr=m.b3 + m.b11 + m.b19 +
                   m.b27 + m.b35 + m.b43 + m.b51 >= 1)

m.c74 = Constraint(expr=m.b8 + m.b16 + m.b24 +
                   m.b32 + m.b40 + m.b48 + m.b56 >= 1)

m.c75 = Constraint(expr=m.b9 + m.b17 + m.b25 +
                   m.b33 + m.b41 + m.b49 + m.b57 >= 1)

m.c76 = Constraint(expr=m.b8 + m.b9 + m.b16 + m.b17 + m.b24 + m.b25 + m.b32 + m.b33 + m.b40 + m.b41 + m.b48 + m.b49
                   + m.b56 + m.b57 >= 3)

m.c77 = Constraint(expr=m.b2 + m.b10 + m.b18 +
                   m.b26 + m.b34 + m.b42 + m.b50 <= 1)

m.c78 = Constraint(expr=m.b3 + m.b11 + m.b19 +
                   m.b27 + m.b35 + m.b43 + m.b51 <= 1)

m.c79 = Constraint(expr=m.b8 + m.b16 + m.b24 +
                   m.b32 + m.b40 + m.b48 + m.b56 <= 2)

m.c80 = Constraint(expr=m.b9 + m.b17 + m.b25 +
                   m.b33 + m.b41 + m.b49 + m.b57 <= 2)
...
m.c88 = Constraint(expr=m.b2 - m.b3 + m.b10 -
                   m.b11 + m.b18 - m.b19 - m.b27 >= 0)

m.c89 = Constraint(expr=m.b2 - m.b3 + m.b10 - m.b11 +
                   m.b18 - m.b19 + m.b26 - m.b27 - m.b35 >= 0)

m.c90 = Constraint(expr=m.b2 - m.b3 + m.b10 - m.b11 + m.b18 -
                   m.b19 + m.b26 - m.b27 + m.b34 - m.b35 - m.b43 >= 0)
...
m.c857 = Constraint(expr=- m.x226 + m.x228 + m.x229 -
                    m.x234 + m.x236 + m.x237 + m.x522 == 25)

m.c858 = Constraint(expr=- m.x227 + m.x230 + m.x231 -
                    m.x235 + m.x238 + m.x239 + m.x523 == 75)

m.c859 = Constraint(expr=- m.x228 - m.x230 + m.x232 -
                    m.x236 - m.x238 + m.x240 + m.x524 == 50)

m.c860 = Constraint(expr=- m.x229 - m.x231 + m.x233 -
                    m.x237 - m.x239 + m.x241 + m.x525 == 50)
...
m.c868 = Constraint(expr=- m.x232 - m.x233 - m.x240 -
                    m.x241 - m.x248 - m.x249 + m.x533 == 0)
...
m.c875 = Constraint(expr=- m.x232 - m.x233 - m.x240 -
                    m.x241 - m.x248 - m.x249 - m.x256 - m.x257 + m.x540 == 0)

m.c876 = Constraint(expr=m.x226 + m.x234 + m.x242 +
                    m.x250 + m.x258 + m.x541 == 100)

m.c877 = Constraint(expr=m.x227 + m.x235 + m.x243 +
                    m.x251 + m.x259 + m.x542 == 100)
...
m.c883 = Constraint(expr=m.x226 + m.x234 + m.x242 +
                    m.x250 + m.x258 + m.x266 + m.x548 == 100)

m.c884 = Constraint(expr=m.x227 + m.x235 + m.x243 +
                    m.x251 + m.x259 + m.x267 + m.x549 == 100)
...
m.c954 = Constraint(expr=- m.x282 + m.x290 + m.x294 -
                    m.x314 + m.x322 + m.x326 + m.x619 == 25)

m.c955 = Constraint(expr=- m.x283 + m.x291 + m.x295 -
                    m.x315 + m.x323 + m.x327 + m.x620 == 0)

m.c956 = Constraint(expr=- m.x284 + m.x292 + m.x296 -
                    m.x316 + m.x324 + m.x328 + m.x621 == 0)

m.c957 = Constraint(expr=- m.x285 + m.x293 + m.x297 -
                    m.x317 + m.x325 + m.x329 + m.x622 == 0)

m.c958 = Constraint(expr=- m.x286 + m.x298 + m.x302 -
                    m.x318 + m.x330 + m.x334 + m.x623 == 0)

m.c959 = Constraint(expr=- m.x287 + m.x299 + m.x303 -
                    m.x319 + m.x331 + m.x335 + m.x624 == 75)

m.c960 = Constraint(expr=- m.x288 + m.x300 + m.x304 -
                    m.x320 + m.x332 + m.x336 + m.x625 == 0)

m.c961 = Constraint(expr=- m.x289 + m.x301 + m.x305 -
                    m.x321 + m.x333 + m.x337 + m.x626 == 0)

m.c962 = Constraint(expr=- m.x290 - m.x298 + m.x306 -
                    m.x322 - m.x330 + m.x338 + m.x627 == 0)

m.c963 = Constraint(expr=- m.x291 - m.x299 + m.x307 -
                    m.x323 - m.x331 + m.x339 + m.x628 == 0)

m.c964 = Constraint(expr=- m.x292 - m.x300 + m.x308 -
                    m.x324 - m.x332 + m.x340 + m.x629 == 50)

m.c965 = Constraint(expr=- m.x293 - m.x301 + m.x309 -
                    m.x325 - m.x333 + m.x341 + m.x630 == 0)

m.c966 = Constraint(expr=- m.x294 - m.x302 + m.x310 -
                    m.x326 - m.x334 + m.x342 + m.x631 == 0)

m.c967 = Constraint(expr=- m.x295 - m.x303 + m.x311 -
                    m.x327 - m.x335 + m.x343 + m.x632 == 0)

m.c968 = Constraint(expr=- m.x296 - m.x304 + m.x312 -
                    m.x328 - m.x336 + m.x344 + m.x633 == 0)

m.c969 = Constraint(expr=- m.x297 - m.x305 + m.x313 -
                    m.x329 - m.x337 + m.x345 + m.x634 == 50)
...
m.c998 = Constraint(expr=- m.x306 - m.x310 - m.x338 -
                    m.x342 - m.x370 - m.x374 + m.x663 == 0)

m.c999 = Constraint(expr=- m.x307 - m.x311 - m.x339 -
                    m.x343 - m.x371 - m.x375 + m.x664 == 0)

m.c1000 = Constraint(expr=- m.x308 - m.x312 - m.x340 -
                     m.x344 - m.x372 - m.x376 + m.x665 == 0)

m.c1001 = Constraint(expr=- m.x309 - m.x313 - m.x341 -
                     m.x345 - m.x373 - m.x377 + m.x666 == 0)
...
m.c1026 = Constraint(expr=- m.x306 - m.x310 - m.x338 -
                     m.x342 - m.x370 - m.x374 - m.x402 - m.x406 + m.x691 == 0)

m.c1027 = Constraint(expr=- m.x307 - m.x311 - m.x339 -
                     m.x343 - m.x371 - m.x375 - m.x403 - m.x407 + m.x692 == 0)

m.c1028 = Constraint(expr=- m.x308 - m.x312 - m.x340 -
                     m.x344 - m.x372 - m.x376 - m.x404 - m.x408 + m.x693 == 0)

m.c1029 = Constraint(expr=- m.x309 - m.x313 - m.x341 -
                     m.x345 - m.x373 - m.x377 - m.x405 - m.x409 + m.x694 == 0)

m.c1030 = Constraint(expr=m.x282 + m.x314 + m.x346 +
                     m.x378 + m.x410 + m.x695 == 100)

m.c1031 = Constraint(expr=m.x283 + m.x315 + m.x347 +
                     m.x379 + m.x411 + m.x696 == 0)

m.c1032 = Constraint(expr=m.x284 + m.x316 + m.x348 +
                     m.x380 + m.x412 + m.x697 == 0)

m.c1033 = Constraint(expr=m.x285 + m.x317 + m.x349 +
                     m.x381 + m.x413 + m.x698 == 0)

m.c1034 = Constraint(expr=m.x286 + m.x318 + m.x350 +
                     m.x382 + m.x414 + m.x699 == 0)

m.c1035 = Constraint(expr=m.x287 + m.x319 + m.x351 +
                     m.x383 + m.x415 + m.x700 == 100)

m.c1036 = Constraint(expr=m.x288 + m.x320 + m.x352 +
                     m.x384 + m.x416 + m.x701 == 0)

m.c1037 = Constraint(expr=m.x289 + m.x321 + m.x353 +
                     m.x385 + m.x417 + m.x702 == 0)
...
m.c1058 = Constraint(expr=m.x282 + m.x314 + m.x346 +
                     m.x378 + m.x410 + m.x442 + m.x723 == 100)

m.c1059 = Constraint(expr=m.x283 + m.x315 + m.x347 +
                     m.x379 + m.x411 + m.x443 + m.x724 == 0)

m.c1060 = Constraint(expr=m.x284 + m.x316 + m.x348 +
                     m.x380 + m.x412 + m.x444 + m.x725 == 0)

m.c1061 = Constraint(expr=m.x285 + m.x317 + m.x349 +
                     m.x381 + m.x413 + m.x445 + m.x726 == 0)

m.c1062 = Constraint(expr=m.x286 + m.x318 + m.x350 +
                     m.x382 + m.x414 + m.x446 + m.x727 == 0)

m.c1063 = Constraint(expr=m.x287 + m.x319 + m.x351 +
                     m.x383 + m.x415 + m.x447 + m.x728 == 100)

m.c1064 = Constraint(expr=m.x288 + m.x320 + m.x352 +
                     m.x384 + m.x416 + m.x448 + m.x729 == 0)

m.c1065 = Constraint(expr=m.x289 + m.x321 + m.x353 +
                     m.x385 + m.x417 + m.x449 + m.x730 == 0)
...
m.c1423 = Constraint(expr=m.x232 + m.x240 + m.x248 +
                     m.x256 + m.x264 + m.x272 + m.x280 >= 100)

m.c1424 = Constraint(expr=m.x233 + m.x241 + m.x249 +
                     m.x257 + m.x265 + m.x273 + m.x281 >= 100)

m.c1425 = Constraint(expr=m.x232 + m.x240 + m.x248 +
                     m.x256 + m.x264 + m.x272 + m.x280 <= 100)

m.c1426 = Constraint(expr=m.x233 + m.x241 + m.x249 +
                     m.x257 + m.x265 + m.x273 + m.x281 <= 100)

m.c1427 = Constraint(expr=- 0.15*m.x232 + 0.1*m.x306 +
                     0.6*m.x307 + 0.2*m.x308 + 0.5*m.x309 >= 0)

m.c1428 = Constraint(expr=- 0.45*m.x233 + 0.1*m.x310 +
                     0.6*m.x311 + 0.2*m.x312 + 0.5*m.x313 >= 0)

m.c1429 = Constraint(expr=- 0.15*m.x240 + 0.1*m.x338 +
                     0.6*m.x339 + 0.2*m.x340 + 0.5*m.x341 >= 0)

m.c1430 = Constraint(expr=- 0.45*m.x241 + 0.1*m.x342 +
                     0.6*m.x343 + 0.2*m.x344 + 0.5*m.x345 >= 0)

m.c1431 = Constraint(expr=- 0.15*m.x248 + 0.1*m.x370 +
                     0.6*m.x371 + 0.2*m.x372 + 0.5*m.x373 >= 0)

m.c1432 = Constraint(expr=- 0.45*m.x249 + 0.1*m.x374 +
                     0.6*m.x375 + 0.2*m.x376 + 0.5*m.x377 >= 0)

m.c1433 = Constraint(expr=- 0.15*m.x256 + 0.1*m.x402 +
                     0.6*m.x403 + 0.2*m.x404 + 0.5*m.x405 >= 0)

m.c1434 = Constraint(expr=- 0.45*m.x257 + 0.1*m.x406 +
                     0.6*m.x407 + 0.2*m.x408 + 0.5*m.x409 >= 0)

m.c1435 = Constraint(expr=- 0.15*m.x264 + 0.1*m.x434 +
                     0.6*m.x435 + 0.2*m.x436 + 0.5*m.x437 >= 0)

m.c1436 = Constraint(expr=- 0.45*m.x265 + 0.1*m.x438 +
                     0.6*m.x439 + 0.2*m.x440 + 0.5*m.x441 >= 0)

m.c1437 = Constraint(expr=- 0.15*m.x272 + 0.1*m.x466 +
                     0.6*m.x467 + 0.2*m.x468 + 0.5*m.x469 >= 0)

m.c1438 = Constraint(expr=- 0.45*m.x273 + 0.1*m.x470 +
                     0.6*m.x471 + 0.2*m.x472 + 0.5*m.x473 >= 0)

m.c1439 = Constraint(expr=- 0.15*m.x280 + 0.1*m.x498 +
                     0.6*m.x499 + 0.2*m.x500 + 0.5*m.x501 >= 0)

m.c1440 = Constraint(expr=- 0.45*m.x281 + 0.1*m.x502 +
                     0.6*m.x503 + 0.2*m.x504 + 0.5*m.x505 >= 0)

m.c1441 = Constraint(expr=- 0.25*m.x232 + 0.1*m.x306 +
                     0.6*m.x307 + 0.2*m.x308 + 0.5*m.x309 <= 0)

m.c1442 = Constraint(expr=- 0.55*m.x233 + 0.1*m.x310 +
                     0.6*m.x311 + 0.2*m.x312 + 0.5*m.x313 <= 0)

m.c1443 = Constraint(expr=- 0.25*m.x240 + 0.1*m.x338 +
                     0.6*m.x339 + 0.2*m.x340 + 0.5*m.x341 <= 0)

m.c1444 = Constraint(expr=- 0.55*m.x241 + 0.1*m.x342 +
                     0.6*m.x343 + 0.2*m.x344 + 0.5*m.x345 <= 0)

m.c1445 = Constraint(expr=- 0.25*m.x248 + 0.1*m.x370 +
                     0.6*m.x371 + 0.2*m.x372 + 0.5*m.x373 <= 0)

m.c1446 = Constraint(expr=- 0.55*m.x249 + 0.1*m.x374 +
                     0.6*m.x375 + 0.2*m.x376 + 0.5*m.x377 <= 0)

m.c1447 = Constraint(expr=- 0.25*m.x256 + 0.1*m.x402 +
                     0.6*m.x403 + 0.2*m.x404 + 0.5*m.x405 <= 0)

m.c1448 = Constraint(expr=- 0.55*m.x257 + 0.1*m.x406 +
                     0.6*m.x407 + 0.2*m.x408 + 0.5*m.x409 <= 0)

m.c1449 = Constraint(expr=- 0.25*m.x264 + 0.1*m.x434 +
                     0.6*m.x435 + 0.2*m.x436 + 0.5*m.x437 <= 0)

m.c1450 = Constraint(expr=- 0.55*m.x265 + 0.1*m.x438 +
                     0.6*m.x439 + 0.2*m.x440 + 0.5*m.x441 <= 0)

m.c1451 = Constraint(expr=- 0.25*m.x272 + 0.1*m.x466 +
                     0.6*m.x467 + 0.2*m.x468 + 0.5*m.x469 <= 0)

m.c1452 = Constraint(expr=- 0.55*m.x273 + 0.1*m.x470 +
                     0.6*m.x471 + 0.2*m.x472 + 0.5*m.x473 <= 0)

m.c1453 = Constraint(expr=- 0.25*m.x280 + 0.1*m.x498 +
                     0.6*m.x499 + 0.2*m.x500 + 0.5*m.x501 <= 0)

m.c1454 = Constraint(expr=- 0.55*m.x281 + 0.1*m.x502 +
                     0.6*m.x503 + 0.2*m.x504 + 0.5*m.x505 <= 0)

m.c1455 = Constraint(expr=- m.x226 - m.x234 - m.x242 -
                     m.x250 - m.x258 - m.x266 - m.x274 >= -100)

m.c1456 = Constraint(expr=- m.x227 - m.x235 - m.x243 -
                     m.x251 - m.x259 - m.x267 - m.x275 >= -100)

m.c1457 = Constraint(expr=m.x226 - m.x228 - m.x229 + m.x234 - m.x236 - m.x237 + m.x242 - m.x244 - m.x245 + m.x250
                     - m.x252 - m.x253 + m.x258 - m.x260 - m.x261 +
                     m.x266 - m.x268 - m.x269 + m.x274 - m.x276
                     - m.x277 >= -25)

m.c1458 = Constraint(expr=m.x227 - m.x230 - m.x231 + m.x235 - m.x238 - m.x239 + m.x243 - m.x246 - m.x247 + m.x251
                     - m.x254 - m.x255 + m.x259 - m.x262 - m.x263 +
                     m.x267 - m.x270 - m.x271 + m.x275 - m.x278
                     - m.x279 >= -75)

m.c1459 = Constraint(expr=m.x228 + m.x230 - m.x232 + m.x236 + m.x238 - m.x240 + m.x244 + m.x246 - m.x248 + m.x252
                     + m.x254 - m.x256 + m.x260 + m.x262 - m.x264 +
                     m.x268 + m.x270 - m.x272 + m.x276 + m.x278
                     - m.x280 >= -50)

m.c1460 = Constraint(expr=m.x229 + m.x231 - m.x233 + m.x237 + m.x239 - m.x241 + m.x245 + m.x247 - m.x249 + m.x253
                     + m.x255 - m.x257 + m.x261 + m.x263 - m.x265 +
                     m.x269 + m.x271 - m.x273 + m.x277 + m.x279
                     - m.x281 >= -50)
...
m.c1462 = Constraint(expr=- m.x226 - m.x234 - m.x242 -
                     m.x250 - m.x258 - m.x266 - m.x274 <= 0)

m.c1463 = Constraint(expr=- m.x227 - m.x235 - m.x243 -
                     m.x251 - m.x259 - m.x267 - m.x275 <= 0)
...
m.c1468 = Constraint(expr=- m.x282 - m.x314 - m.x346 -
                     m.x378 - m.x410 - m.x442 - m.x474 >= -100)

m.c1469 = Constraint(expr=- m.x283 - m.x315 - m.x347 -
                     m.x379 - m.x411 - m.x443 - m.x475 >= 0)

m.c1470 = Constraint(expr=- m.x284 - m.x316 - m.x348 -
                     m.x380 - m.x412 - m.x444 - m.x476 >= 0)

m.c1471 = Constraint(expr=- m.x285 - m.x317 - m.x349 -
                     m.x381 - m.x413 - m.x445 - m.x477 >= 0)

m.c1472 = Constraint(expr=- m.x286 - m.x318 - m.x350 -
                     m.x382 - m.x414 - m.x446 - m.x478 >= 0)

m.c1473 = Constraint(expr=- m.x287 - m.x319 - m.x351 -
                     m.x383 - m.x415 - m.x447 - m.x479 >= -100)

m.c1474 = Constraint(expr=- m.x288 - m.x320 - m.x352 -
                     m.x384 - m.x416 - m.x448 - m.x480 >= 0)

m.c1475 = Constraint(expr=- m.x289 - m.x321 - m.x353 -
                     m.x385 - m.x417 - m.x449 - m.x481 >= 0)

m.c1476 = Constraint(expr=m.x282 - m.x290 - m.x294 + m.x314 - m.x322 - m.x326 + m.x346 - m.x354 - m.x358 + m.x378
                     - m.x386 - m.x390 + m.x410 - m.x418 - m.x422 +
                     m.x442 - m.x450 - m.x454 + m.x474 - m.x482
                     - m.x486 >= -25)

m.c1477 = Constraint(expr=m.x283 - m.x291 - m.x295 + m.x315 - m.x323 - m.x327 + m.x347 - m.x355 - m.x359 + m.x379
                     - m.x387 - m.x391 + m.x411 - m.x419 - m.x423 +
                     m.x443 - m.x451 - m.x455 + m.x475 - m.x483
                     - m.x487 >= 0)

m.c1478 = Constraint(expr=m.x284 - m.x292 - m.x296 + m.x316 - m.x324 - m.x328 + m.x348 - m.x356 - m.x360 + m.x380
                     - m.x388 - m.x392 + m.x412 - m.x420 - m.x424 +
                     m.x444 - m.x452 - m.x456 + m.x476 - m.x484
                     - m.x488 >= 0)

m.c1479 = Constraint(expr=m.x285 - m.x293 - m.x297 + m.x317 - m.x325 - m.x329 + m.x349 - m.x357 - m.x361 + m.x381
                     - m.x389 - m.x393 + m.x413 - m.x421 - m.x425 +
                     m.x445 - m.x453 - m.x457 + m.x477 - m.x485
                     - m.x489 >= 0)

m.c1480 = Constraint(expr=m.x286 - m.x298 - m.x302 + m.x318 - m.x330 - m.x334 + m.x350 - m.x362 - m.x366 + m.x382
                     - m.x394 - m.x398 + m.x414 - m.x426 - m.x430 +
                     m.x446 - m.x458 - m.x462 + m.x478 - m.x490
                     - m.x494 >= 0)

m.c1481 = Constraint(expr=m.x287 - m.x299 - m.x303 + m.x319 - m.x331 - m.x335 + m.x351 - m.x363 - m.x367 + m.x383
                     - m.x395 - m.x399 + m.x415 - m.x427 - m.x431 +
                     m.x447 - m.x459 - m.x463 + m.x479 - m.x491
                     - m.x495 >= -75)

m.c1482 = Constraint(expr=m.x288 - m.x300 - m.x304 + m.x320 - m.x332 - m.x336 + m.x352 - m.x364 - m.x368 + m.x384
                     - m.x396 - m.x400 + m.x416 - m.x428 - m.x432 +
                     m.x448 - m.x460 - m.x464 + m.x480 - m.x492
                     - m.x496 >= 0)

m.c1483 = Constraint(expr=m.x289 - m.x301 - m.x305 + m.x321 - m.x333 - m.x337 + m.x353 - m.x365 - m.x369 + m.x385
                     - m.x397 - m.x401 + m.x417 - m.x429 - m.x433 +
                     m.x449 - m.x461 - m.x465 + m.x481 - m.x493
                     - m.x497 >= 0)

m.c1484 = Constraint(expr=m.x290 + m.x298 - m.x306 + m.x322 + m.x330 - m.x338 + m.x354 + m.x362 - m.x370 + m.x386
                     + m.x394 - m.x402 + m.x418 + m.x426 - m.x434 +
                     m.x450 + m.x458 - m.x466 + m.x482 + m.x490
                     - m.x498 >= 0)

m.c1485 = Constraint(expr=m.x291 + m.x299 - m.x307 + m.x323 + m.x331 - m.x339 + m.x355 + m.x363 - m.x371 + m.x387
                     + m.x395 - m.x403 + m.x419 + m.x427 - m.x435 +
                     m.x451 + m.x459 - m.x467 + m.x483 + m.x491
                     - m.x499 >= 0)

m.c1486 = Constraint(expr=m.x292 + m.x300 - m.x308 + m.x324 + m.x332 - m.x340 + m.x356 + m.x364 - m.x372 + m.x388
                     + m.x396 - m.x404 + m.x420 + m.x428 - m.x436 +
                     m.x452 + m.x460 - m.x468 + m.x484 + m.x492
                     - m.x500 >= -50)

m.c1487 = Constraint(expr=m.x293 + m.x301 - m.x309 + m.x325 + m.x333 - m.x341 + m.x357 + m.x365 - m.x373 + m.x389
                     + m.x397 - m.x405 + m.x421 + m.x429 - m.x437 +
                     m.x453 + m.x461 - m.x469 + m.x485 + m.x493
                     - m.x501 >= 0)

m.c1488 = Constraint(expr=m.x294 + m.x302 - m.x310 + m.x326 + m.x334 - m.x342 + m.x358 + m.x366 - m.x374 + m.x390
                     + m.x398 - m.x406 + m.x422 + m.x430 - m.x438 +
                     m.x454 + m.x462 - m.x470 + m.x486 + m.x494
                     - m.x502 >= 0)

m.c1489 = Constraint(expr=m.x295 + m.x303 - m.x311 + m.x327 + m.x335 - m.x343 + m.x359 + m.x367 - m.x375 + m.x391
                     + m.x399 - m.x407 + m.x423 + m.x431 - m.x439 +
                     m.x455 + m.x463 - m.x471 + m.x487 + m.x495
                     - m.x503 >= 0)

m.c1490 = Constraint(expr=m.x296 + m.x304 - m.x312 + m.x328 + m.x336 - m.x344 + m.x360 + m.x368 - m.x376 + m.x392
                     + m.x400 - m.x408 + m.x424 + m.x432 - m.x440 +
                     m.x456 + m.x464 - m.x472 + m.x488 + m.x496
                     - m.x504 >= 0)

m.c1491 = Constraint(expr=m.x297 + m.x305 - m.x313 + m.x329 + m.x337 - m.x345 + m.x361 + m.x369 - m.x377 + m.x393
                     + m.x401 - m.x409 + m.x425 + m.x433 - m.x441 +
                     m.x457 + m.x465 - m.x473 + m.x489 + m.x497
                     - m.x505 >= -50)
...
m.c1496 = Constraint(expr=- m.x282 - m.x314 - m.x346 -
                     m.x378 - m.x410 - m.x442 - m.x474 <= 0)

m.c1497 = Constraint(expr=- m.x283 - m.x315 - m.x347 -
                     m.x379 - m.x411 - m.x443 - m.x475 <= 100)

m.c1498 = Constraint(expr=- m.x284 - m.x316 - m.x348 -
                     m.x380 - m.x412 - m.x444 - m.x476 <= 100)

m.c1499 = Constraint(expr=- m.x285 - m.x317 - m.x349 -
                     m.x381 - m.x413 - m.x445 - m.x477 <= 100)

m.c1500 = Constraint(expr=- m.x286 - m.x318 - m.x350 -
                     m.x382 - m.x414 - m.x446 - m.x478 <= 100)

m.c1501 = Constraint(expr=- m.x287 - m.x319 - m.x351 -
                     m.x383 - m.x415 - m.x447 - m.x479 <= 0)

m.c1502 = Constraint(expr=- m.x288 - m.x320 - m.x352 -
                     m.x384 - m.x416 - m.x448 - m.x480 <= 100)

m.c1503 = Constraint(expr=- m.x289 - m.x321 - m.x353 -
                     m.x385 - m.x417 - m.x449 - m.x481 <= 100)
...
m.c1520 = Constraint(expr=8*m.b10 + 8*m.b11 - m.x66 -
                     m.x67 + m.x170 + m.x171 <= 8)

m.c1521 = Constraint(expr=8*m.b10 + 8*m.b12 - m.x66 -
                     m.x68 + m.x170 + m.x172 <= 8)

m.c1522 = Constraint(expr=8*m.b10 + 8*m.b13 - m.x66 -
                     m.x69 + m.x170 + m.x173 <= 8)

m.c1523 = Constraint(expr=8*m.b11 + 8*m.b14 - m.x67 -
                     m.x70 + m.x171 + m.x174 <= 8)

m.c1524 = Constraint(expr=8*m.b11 + 8*m.b15 - m.x67 -
                     m.x71 + m.x171 + m.x175 <= 8)

m.c1525 = Constraint(expr=8*m.b12 + 8*m.b16 - m.x68 -
                     m.x72 + m.x172 + m.x176 <= 8)

m.c1526 = Constraint(expr=8*m.b13 + 8*m.b17 - m.x69 -
                     m.x73 + m.x173 + m.x177 <= 8)

m.c1527 = Constraint(expr=8*m.b14 + 8*m.b16 - m.x70 -
                     m.x72 + m.x174 + m.x176 <= 8)

m.c1528 = Constraint(expr=8*m.b15 + 8*m.b17 - m.x71 -
                     m.x73 + m.x175 + m.x177 <= 8)

m.c1529 = Constraint(expr=8*m.b16 + 8*m.b17 - m.x72 -
                     m.x73 + m.x176 + m.x177 <= 8)

m.c1530 = Constraint(expr=8*m.b18 + 8*m.b19 - m.x74 -
                     m.x75 + m.x122 + m.x123 + m.x170 + m.x171 <= 8)

m.c1531 = Constraint(expr=8*m.b18 + 8*m.b20 - m.x74 -
                     m.x76 + m.x122 + m.x124 + m.x170 + m.x172 <= 8)

m.c1532 = Constraint(expr=8*m.b18 + 8*m.b21 - m.x74 -
                     m.x77 + m.x122 + m.x125 + m.x170 + m.x173 <= 8)

m.c1533 = Constraint(expr=8*m.b19 + 8*m.b22 - m.x75 -
                     m.x78 + m.x123 + m.x126 + m.x171 + m.x174 <= 8)

m.c1534 = Constraint(expr=8*m.b19 + 8*m.b23 - m.x75 -
                     m.x79 + m.x123 + m.x127 + m.x171 + m.x175 <= 8)

m.c1535 = Constraint(expr=8*m.b20 + 8*m.b24 - m.x76 -
                     m.x80 + m.x124 + m.x128 + m.x172 + m.x176 <= 8)

m.c1536 = Constraint(expr=8*m.b21 + 8*m.b25 - m.x77 -
                     m.x81 + m.x125 + m.x129 + m.x173 + m.x177 <= 8)

m.c1537 = Constraint(expr=8*m.b22 + 8*m.b24 - m.x78 -
                     m.x80 + m.x126 + m.x128 + m.x174 + m.x176 <= 8)

m.c1538 = Constraint(expr=8*m.b23 + 8*m.b25 - m.x79 -
                     m.x81 + m.x127 + m.x129 + m.x175 + m.x177 <= 8)

m.c1539 = Constraint(expr=8*m.b24 + 8*m.b25 - m.x80 -
                     m.x81 + m.x128 + m.x129 + m.x176 + m.x177 <= 8)
...
m.c1580 = Constraint(expr=8*m.b18 + 8*m.b19 - m.x74 -
                     m.x75 + m.x178 + m.x179 <= 8)

m.c1581 = Constraint(expr=8*m.b18 + 8*m.b20 - m.x74 -
                     m.x76 + m.x178 + m.x180 <= 8)

m.c1582 = Constraint(expr=8*m.b18 + 8*m.b21 - m.x74 -
                     m.x77 + m.x178 + m.x181 <= 8)

m.c1583 = Constraint(expr=8*m.b19 + 8*m.b22 - m.x75 -
                     m.x78 + m.x179 + m.x182 <= 8)

m.c1584 = Constraint(expr=8*m.b19 + 8*m.b23 - m.x75 -
                     m.x79 + m.x179 + m.x183 <= 8)

m.c1585 = Constraint(expr=8*m.b20 + 8*m.b24 - m.x76 -
                     m.x80 + m.x180 + m.x184 <= 8)

m.c1586 = Constraint(expr=8*m.b21 + 8*m.b25 - m.x77 -
                     m.x81 + m.x181 + m.x185 <= 8)

m.c1587 = Constraint(expr=8*m.b22 + 8*m.b24 - m.x78 -
                     m.x80 + m.x182 + m.x184 <= 8)

m.c1588 = Constraint(expr=8*m.b23 + 8*m.b25 - m.x79 -
                     m.x81 + m.x183 + m.x185 <= 8)

m.c1589 = Constraint(expr=8*m.b24 + 8*m.b25 - m.x80 -
                     m.x81 + m.x184 + m.x185 <= 8)

m.c1590 = Constraint(expr=8*m.b26 + 8*m.b27 - m.x82 -
                     m.x83 + m.x130 + m.x131 + m.x178 + m.x179 <= 8)

m.c1591 = Constraint(expr=8*m.b26 + 8*m.b28 - m.x82 -
                     m.x84 + m.x130 + m.x132 + m.x178 + m.x180 <= 8)

m.c1592 = Constraint(expr=8*m.b26 + 8*m.b29 - m.x82 -
                     m.x85 + m.x130 + m.x133 + m.x178 + m.x181 <= 8)

m.c1593 = Constraint(expr=8*m.b27 + 8*m.b30 - m.x83 -
                     m.x86 + m.x131 + m.x134 + m.x179 + m.x182 <= 8)

m.c1594 = Constraint(expr=8*m.b27 + 8*m.b31 - m.x83 -
                     m.x87 + m.x131 + m.x135 + m.x179 + m.x183 <= 8)

m.c1595 = Constraint(expr=8*m.b28 + 8*m.b32 - m.x84 -
                     m.x88 + m.x132 + m.x136 + m.x180 + m.x184 <= 8)

m.c1596 = Constraint(expr=8*m.b29 + 8*m.b33 - m.x85 -
                     m.x89 + m.x133 + m.x137 + m.x181 + m.x185 <= 8)

m.c1597 = Constraint(expr=8*m.b30 + 8*m.b32 - m.x86 -
                     m.x88 + m.x134 + m.x136 + m.x182 + m.x184 <= 8)

m.c1598 = Constraint(expr=8*m.b31 + 8*m.b33 - m.x87 -
                     m.x89 + m.x135 + m.x137 + m.x183 + m.x185 <= 8)

m.c1599 = Constraint(expr=8*m.b32 + 8*m.b33 - m.x88 -
                     m.x89 + m.x136 + m.x137 + m.x184 + m.x185 <= 8)
...
m.c1630 = Constraint(expr=8*m.b26 + 8*m.b27 - m.x82 -
                     m.x83 + m.x186 + m.x187 <= 8)

m.c1631 = Constraint(expr=8*m.b26 + 8*m.b28 - m.x82 -
                     m.x84 + m.x186 + m.x188 <= 8)

m.c1632 = Constraint(expr=8*m.b26 + 8*m.b29 - m.x82 -
                     m.x85 + m.x186 + m.x189 <= 8)

m.c1633 = Constraint(expr=8*m.b27 + 8*m.b30 - m.x83 -
                     m.x86 + m.x187 + m.x190 <= 8)

m.c1634 = Constraint(expr=8*m.b27 + 8*m.b31 - m.x83 -
                     m.x87 + m.x187 + m.x191 <= 8)

m.c1635 = Constraint(expr=8*m.b28 + 8*m.b32 - m.x84 -
                     m.x88 + m.x188 + m.x192 <= 8)

m.c1636 = Constraint(expr=8*m.b29 + 8*m.b33 - m.x85 -
                     m.x89 + m.x189 + m.x193 <= 8)

m.c1637 = Constraint(expr=8*m.b30 + 8*m.b32 - m.x86 -
                     m.x88 + m.x190 + m.x192 <= 8)

m.c1638 = Constraint(expr=8*m.b31 + 8*m.b33 - m.x87 -
                     m.x89 + m.x191 + m.x193 <= 8)

m.c1639 = Constraint(expr=8*m.b32 + 8*m.b33 - m.x88 -
                     m.x89 + m.x192 + m.x193 <= 8)

m.c1640 = Constraint(expr=8*m.b34 + 8*m.b35 - m.x90 -
                     m.x91 + m.x138 + m.x139 + m.x186 + m.x187 <= 8)

m.c1641 = Constraint(expr=8*m.b34 + 8*m.b36 - m.x90 -
                     m.x92 + m.x138 + m.x140 + m.x186 + m.x188 <= 8)

m.c1642 = Constraint(expr=8*m.b34 + 8*m.b37 - m.x90 -
                     m.x93 + m.x138 + m.x141 + m.x186 + m.x189 <= 8)

m.c1643 = Constraint(expr=8*m.b35 + 8*m.b38 - m.x91 -
                     m.x94 + m.x139 + m.x142 + m.x187 + m.x190 <= 8)

m.c1644 = Constraint(expr=8*m.b35 + 8*m.b39 - m.x91 -
                     m.x95 + m.x139 + m.x143 + m.x187 + m.x191 <= 8)

m.c1645 = Constraint(expr=8*m.b36 + 8*m.b40 - m.x92 -
                     m.x96 + m.x140 + m.x144 + m.x188 + m.x192 <= 8)

m.c1646 = Constraint(expr=8*m.b37 + 8*m.b41 - m.x93 -
                     m.x97 + m.x141 + m.x145 + m.x189 + m.x193 <= 8)

m.c1647 = Constraint(expr=8*m.b38 + 8*m.b40 - m.x94 -
                     m.x96 + m.x142 + m.x144 + m.x190 + m.x192 <= 8)

m.c1648 = Constraint(expr=8*m.b39 + 8*m.b41 - m.x95 -
                     m.x97 + m.x143 + m.x145 + m.x191 + m.x193 <= 8)

m.c1649 = Constraint(expr=8*m.b40 + 8*m.b41 - m.x96 -
                     m.x97 + m.x144 + m.x145 + m.x192 + m.x193 <= 8)
...
m.c1670 = Constraint(expr=8*m.b34 + 8*m.b35 - m.x90 -
                     m.x91 + m.x194 + m.x195 <= 8)

m.c1671 = Constraint(expr=8*m.b34 + 8*m.b36 - m.x90 -
                     m.x92 + m.x194 + m.x196 <= 8)

m.c1672 = Constraint(expr=8*m.b34 + 8*m.b37 - m.x90 -
                     m.x93 + m.x194 + m.x197 <= 8)

m.c1673 = Constraint(expr=8*m.b35 + 8*m.b38 - m.x91 -
                     m.x94 + m.x195 + m.x198 <= 8)

m.c1674 = Constraint(expr=8*m.b35 + 8*m.b39 - m.x91 -
                     m.x95 + m.x195 + m.x199 <= 8)

m.c1675 = Constraint(expr=8*m.b36 + 8*m.b40 - m.x92 -
                     m.x96 + m.x196 + m.x200 <= 8)

m.c1676 = Constraint(expr=8*m.b37 + 8*m.b41 - m.x93 -
                     m.x97 + m.x197 + m.x201 <= 8)

m.c1677 = Constraint(expr=8*m.b38 + 8*m.b40 - m.x94 -
                     m.x96 + m.x198 + m.x200 <= 8)

m.c1678 = Constraint(expr=8*m.b39 + 8*m.b41 - m.x95 -
                     m.x97 + m.x199 + m.x201 <= 8)

m.c1679 = Constraint(expr=8*m.b40 + 8*m.b41 - m.x96 -
                     m.x97 + m.x200 + m.x201 <= 8)

m.c1680 = Constraint(expr=8*m.b42 + 8*m.b43 - m.x98 -
                     m.x99 + m.x146 + m.x147 + m.x194 + m.x195 <= 8)

m.c1681 = Constraint(expr=8*m.b42 + 8*m.b44 - m.x98 -
                     m.x100 + m.x146 + m.x148 + m.x194 + m.x196 <= 8)

m.c1682 = Constraint(expr=8*m.b42 + 8*m.b45 - m.x98 -
                     m.x101 + m.x146 + m.x149 + m.x194 + m.x197 <= 8)

m.c1683 = Constraint(expr=8*m.b43 + 8*m.b46 - m.x99 -
                     m.x102 + m.x147 + m.x150 + m.x195 + m.x198 <= 8)

m.c1684 = Constraint(expr=8*m.b43 + 8*m.b47 - m.x99 -
                     m.x103 + m.x147 + m.x151 + m.x195 + m.x199 <= 8)

m.c1685 = Constraint(expr=8*m.b44 + 8*m.b48 - m.x100 -
                     m.x104 + m.x148 + m.x152 + m.x196 + m.x200 <= 8)

m.c1686 = Constraint(expr=8*m.b45 + 8*m.b49 - m.x101 -
                     m.x105 + m.x149 + m.x153 + m.x197 + m.x201 <= 8)

m.c1687 = Constraint(expr=8*m.b46 + 8*m.b48 - m.x102 -
                     m.x104 + m.x150 + m.x152 + m.x198 + m.x200 <= 8)

m.c1688 = Constraint(expr=8*m.b47 + 8*m.b49 - m.x103 -
                     m.x105 + m.x151 + m.x153 + m.x199 + m.x201 <= 8)

m.c1689 = Constraint(expr=8*m.b48 + 8*m.b49 - m.x104 -
                     m.x105 + m.x152 + m.x153 + m.x200 + m.x201 <= 8)
...
m.c1700 = Constraint(expr=8*m.b42 + 8*m.b43 - m.x98 -
                     m.x99 + m.x202 + m.x203 <= 8)

m.c1701 = Constraint(expr=8*m.b42 + 8*m.b44 - m.x98 -
                     m.x100 + m.x202 + m.x204 <= 8)

m.c1702 = Constraint(expr=8*m.b42 + 8*m.b45 - m.x98 -
                     m.x101 + m.x202 + m.x205 <= 8)

m.c1703 = Constraint(expr=8*m.b43 + 8*m.b46 - m.x99 -
                     m.x102 + m.x203 + m.x206 <= 8)

m.c1704 = Constraint(expr=8*m.b43 + 8*m.b47 - m.x99 -
                     m.x103 + m.x203 + m.x207 <= 8)

m.c1705 = Constraint(expr=8*m.b44 + 8*m.b48 - m.x100 -
                     m.x104 + m.x204 + m.x208 <= 8)

m.c1706 = Constraint(expr=8*m.b45 + 8*m.b49 - m.x101 -
                     m.x105 + m.x205 + m.x209 <= 8)

m.c1707 = Constraint(expr=8*m.b46 + 8*m.b48 - m.x102 -
                     m.x104 + m.x206 + m.x208 <= 8)

m.c1708 = Constraint(expr=8*m.b47 + 8*m.b49 - m.x103 -
                     m.x105 + m.x207 + m.x209 <= 8)

m.c1709 = Constraint(expr=8*m.b48 + 8*m.b49 - m.x104 -
                     m.x105 + m.x208 + m.x209 <= 8)

m.c1710 = Constraint(expr=8*m.b50 + 8*m.b51 - m.x106 -
                     m.x107 + m.x154 + m.x155 + m.x202 + m.x203 <= 8)

m.c1711 = Constraint(expr=8*m.b50 + 8*m.b52 - m.x106 -
                     m.x108 + m.x154 + m.x156 + m.x202 + m.x204 <= 8)

m.c1712 = Constraint(expr=8*m.b50 + 8*m.b53 - m.x106 -
                     m.x109 + m.x154 + m.x157 + m.x202 + m.x205 <= 8)

m.c1713 = Constraint(expr=8*m.b51 + 8*m.b54 - m.x107 -
                     m.x110 + m.x155 + m.x158 + m.x203 + m.x206 <= 8)

m.c1714 = Constraint(expr=8*m.b51 + 8*m.b55 - m.x107 -
                     m.x111 + m.x155 + m.x159 + m.x203 + m.x207 <= 8)

m.c1715 = Constraint(expr=8*m.b52 + 8*m.b56 - m.x108 -
                     m.x112 + m.x156 + m.x160 + m.x204 + m.x208 <= 8)

m.c1716 = Constraint(expr=8*m.b53 + 8*m.b57 - m.x109 -
                     m.x113 + m.x157 + m.x161 + m.x205 + m.x209 <= 8)

m.c1717 = Constraint(expr=8*m.b54 + 8*m.b56 - m.x110 -
                     m.x112 + m.x158 + m.x160 + m.x206 + m.x208 <= 8)

m.c1718 = Constraint(expr=8*m.b55 + 8*m.b57 - m.x111 -
                     m.x113 + m.x159 + m.x161 + m.x207 + m.x209 <= 8)

m.c1719 = Constraint(expr=8*m.b56 + 8*m.b57 - m.x112 -
                     m.x113 + m.x160 + m.x161 + m.x208 + m.x209 <= 8)

m.c1720 = Constraint(expr=8*m.b50 + 8*m.b51 - m.x106 -
                     m.x107 + m.x210 + m.x211 <= 8)

m.c1721 = Constraint(expr=8*m.b50 + 8*m.b52 - m.x106 -
                     m.x108 + m.x210 + m.x212 <= 8)

m.c1722 = Constraint(expr=8*m.b50 + 8*m.b53 - m.x106 -
                     m.x109 + m.x210 + m.x213 <= 8)

m.c1723 = Constraint(expr=8*m.b51 + 8*m.b54 - m.x107 -
                     m.x110 + m.x211 + m.x214 <= 8)

m.c1724 = Constraint(expr=8*m.b51 + 8*m.b55 - m.x107 -
                     m.x111 + m.x211 + m.x215 <= 8)

m.c1725 = Constraint(expr=8*m.b52 + 8*m.b56 - m.x108 -
                     m.x112 + m.x212 + m.x216 <= 8)

m.c1726 = Constraint(expr=8*m.b53 + 8*m.b57 - m.x109 -
                     m.x113 + m.x213 + m.x217 <= 8)

m.c1727 = Constraint(expr=8*m.b54 + 8*m.b56 - m.x110 -
                     m.x112 + m.x214 + m.x216 <= 8)

m.c1728 = Constraint(expr=8*m.b55 + 8*m.b57 - m.x111 -
                     m.x113 + m.x215 + m.x217 <= 8)

m.c1729 = Constraint(expr=8*m.b56 + 8*m.b57 - m.x112 -
                     m.x113 + m.x216 + m.x217 <= 8)
