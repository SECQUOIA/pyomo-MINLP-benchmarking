...
m.b1 = Var(within=Binary, bounds=(0, 1))
...
m.x93 = Var(within=Reals, bounds=(0, None), initialize=1.60182773798373)
m.x94 = Var(within=Reals, bounds=(0, None), initialize=3.05400369998218)
m.x95 = Var(within=Reals, bounds=(0, None), initialize=1.95673968396495)
m.x96 = Var(within=Reals, bounds=(0, None), initialize=1.36134435840075)
m.x97 = Var(within=Reals, bounds=(0, None), initialize=0.205218266964009)
m.x98 = Var(within=Reals, bounds=(0, None), initialize=0.205218266964009)
m.x99 = Var(within=Reals, bounds=(0, None), initialize=0.205218266964009)
m.x100 = Var(within=Reals, bounds=(0, None), initialize=0.25111008984325)
m.x101 = Var(within=Reals, bounds=(0, None), initialize=0.25111008984325)
m.x102 = Var(within=Reals, bounds=(0, None), initialize=0.25111008984325)
m.x103 = Var(within=Reals, bounds=(0, None), initialize=0.220596545870753)
m.x104 = Var(within=Reals, bounds=(0, None), initialize=0.220596545870753)
m.x105 = Var(within=Reals, bounds=(0, None), initialize=0.220596545870753)
m.x106 = Var(within=Reals, bounds=(0, None), initialize=0.192170807779844)
m.x107 = Var(within=Reals, bounds=(0, None), initialize=0.192170807779844)
m.x108 = Var(within=Reals, bounds=(0, None), initialize=0.192170807779844)

m.obj = Objective(expr=605.279840123728*m.b1 + 272.608555855308*m.b2 + 211.960656393875*m.b3 + 135.715048070326*m.b4
                  + 522.241469316371*m.b5 + 523.563443912583*m.b6 +
                  619.396068733614*m.b7 + 682.855110454901*m.b8
                  ...
                  + 816.295996604146*m.b78 + 1138.18899052505 *
                  m.b79 + 1010.10082815226*m.b80 + 334.527248*m.b81
                        + 153.380628575016*m.b82 + 110.155626976693*m.b83 +
                  304.26749275*m.b84 + 134.618265608558*m.b85
                        + 94.9717940075149*m.b86 + 386.41984025*m.b87 +
                  164.839722634043*m.b88 + 114.190322638477*m.b89
                        + 292.732952*m.b90 + 143.429945907125*m.b91 +
                  106.48563964612*m.b92 + 113818.899052505*m.x93
...
m.c2 = Constraint(expr=1.051196132*m.b1 + 1.318044576*m.b5 + 0.980364732*m.b9 + 0.515442765*m.b13 + 0.868604743*m.b17
                  ...
                  + 0.971951107*m.b69 + 0.997801135*m.b73 +
                  1.479427834*m.b77 - 4.0303184825*m.x97
...
m.c42 = Constraint(expr=m.x97*m.b81 + m.x97*m.x93 - m.x93*m.b81 <= 0)

m.c43 = Constraint(expr=m.x98*m.b82 + m.x98*m.x93 - m.x93*m.b82 <= 0)

m.c44 = Constraint(expr=m.x99*m.b83 + m.x99*m.x93 - m.x93*m.b83 <= 0)

m.c45 = Constraint(expr=m.x100*m.b84 + m.x100*m.x94 - m.x94*m.b84 <= 0)

m.c46 = Constraint(expr=m.x101*m.b85 + m.x101*m.x94 - m.x94*m.b85 <= 0)

m.c47 = Constraint(expr=m.x102*m.b86 + m.x102*m.x94 - m.x94*m.b86 <= 0)

m.c48 = Constraint(expr=m.x103*m.b87 + m.x103*m.x95 - m.x95*m.b87 <= 0)

m.c49 = Constraint(expr=m.x104*m.b88 + m.x104*m.x95 - m.x95*m.b88 <= 0)

m.c50 = Constraint(expr=m.x105*m.b89 + m.x105*m.x95 - m.x95*m.b89 <= 0)

m.c51 = Constraint(expr=m.x106*m.b90 + m.x106*m.x96 - m.x96*m.b90 <= 0)

m.c52 = Constraint(expr=m.x107*m.b91 + m.x107*m.x96 - m.x96*m.b91 <= 0)

m.c53 = Constraint(expr=m.x108*m.b92 + m.x108*m.x96 - m.x96*m.b92 <= 0)
