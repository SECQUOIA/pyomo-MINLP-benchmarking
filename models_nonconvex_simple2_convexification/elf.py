#  MINLP written by GAMS Convert at 08/20/20 01:30:40
#
#  Equation counts
#      Total        E        G        L        N        X        C        B
#         39        7       32        0        0        0        0        0
...
m.obj = Objective(expr=m.x25 + m.x26 + m.x27 + m.x28 + m.x29 + m.x30 + m.x31 + m.x32 + m.x33 + m.x34 + m.x35 + m.x36
                  + m.x37 + m.x38 + m.x39 + m.x40 + m.x41 + m.x42 + m.x43 + m.x44 + m.x45 + m.x46 + m.x47 + m.x48, sense=minimize)
...
m.c33 = Constraint(expr=- m.b1 - m.b4 - m.b7 - m.b10 -
                   m.b13 - m.b16 - m.b19 - m.b22 + m.x52 == 0)

m.c34 = Constraint(expr=- m.b2 - m.b5 - m.b8 - m.b11 -
                   m.b14 - m.b17 - m.b20 - m.b23 + m.x53 == 0)

m.c35 = Constraint(expr=- m.b3 - m.b6 - m.b9 - m.b12 -
                   m.b15 - m.b18 - m.b21 - m.b24 + m.x54 == 0)
