...
m.obj = Objective(expr=322.234552934*sqrt(1e-10 + m.x77) + 302.50169455058*sqrt(1e-10 + m.x78) + 228.02026850162*sqrt(1e-6
                        + m.x79) + 6050.05692401735*sqrt(1e-10 + m.x34) + 5835.32285968594*sqrt(1e-10 + m.x35) + 
                       5989.86353513014*sqrt(1e-10 + m.x36) + 539.712349032506*sqrt(1e-10 + m.x37) + 16850.0288492985*
                       sqrt(1e-10 + m.x38) + 8222.60184978362*sqrt(1e-10 + m.x39) + 151717.47132*m.b7 + 158432.66708*m.b8
