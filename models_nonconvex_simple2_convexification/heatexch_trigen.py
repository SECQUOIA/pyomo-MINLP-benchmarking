...
m.c257 = Constraint(expr=-(322*((1.76923076923077*m.x138/(1e-10 + (m.x192*m.x193*(0.5*m.x192 + 0.5*m.x193))**0.33333))**
                         0.83 + (1.76923076923077*m.x139/(1e-10 + (m.x193*m.x194*(0.5*m.x193 + 0.5*m.x194))**0.33333))**
                         0.83 + (3*m.x140/(1e-10 + (m.x195*m.x196*(0.5*m.x195 + 0.5*m.x196))**0.33333))**0.83 + (3*m.x141
                         /(1e-10 + (m.x196*m.x197*(0.5*m.x196 + 0.5*m.x197))**0.33333))**0.83 + (2.76923076923077*m.x142/
                         (1e-10 + (m.x198*m.x199*(0.5*m.x198 + 0.5*m.x199))**0.33333))**0.83 + (2.76923076923077*m.x143/(
                         1e-10 + (m.x199*m.x200*(0.5*m.x199 + 0.5*m.x200))**0.33333))**0.83 + (4*m.x144/(1e-10 + (m.x201*
                         m.x202*(0.5*m.x201 + 0.5*m.x202))**0.33333))**0.83 + (4*m.x145/(1e-10 + (m.x202*m.x203*(0.5*
                         m.x202 + 0.5*m.x203))**0.33333))**0.83 + (1.43589743589744*m.x146/(1e-10 + (m.x204*m.x205*(0.5*
                         m.x204 + 0.5*m.x205))**0.33333))**0.83 + (1.43589743589744*m.x147/(1e-10 + (m.x205*m.x206*(0.5*
                         m.x205 + 0.5*m.x206))**0.33333))**0.83 + (2.66666666666667*m.x148/(1e-10 + (m.x207*m.x208*(0.5*
                         m.x207 + 0.5*m.x208))**0.33333))**0.83 + (2.66666666666667*m.x149/(1e-10 + (m.x208*m.x209*(0.5*
                         m.x208 + 0.5*m.x209))**0.33333))**0.83) + 322*((3*m.x150/(1e-10 + (m.x210*m.x211*(0.5*m.x210 + 
                         0.5*m.x211))**0.33333))**0.83 + (3*m.x151/(1e-10 + (m.x211*m.x212*(0.5*m.x211 + 0.5*m.x212))**
                         0.33333))**0.83 + (4*m.x152/(1e-10 + (m.x213*m.x214*(0.5*m.x213 + 0.5*m.x214))**0.33333))**0.83
                          + (4*m.x153/(1e-10 + (m.x214*m.x215*(0.5*m.x214 + 0.5*m.x215))**0.33333))**0.83 + (
                         2.66666666666667*m.x154/(1e-10 + (m.x216*m.x217*(0.5*m.x216 + 0.5*m.x217))**0.33333))**0.83 + (
                         2.66666666666667*m.x155/(1e-10 + (m.x217*m.x218*(0.5*m.x217 + 0.5*m.x218))**0.33333))**0.83) + 
                         322*((3*m.x156/(1e-10 + (m.x219*m.x220*(0.5*m.x219 + 0.5*m.x220))**0.33333))**0.83 + (3*m.x157/(
                         1e-10 + (m.x220*m.x221*(0.5*m.x220 + 0.5*m.x221))**0.33333))**0.83 + (4*m.x158/(1e-10 + (m.x222*
                         m.x223*(0.5*m.x222 + 0.5*m.x223))**0.33333))**0.83 + (4*m.x159/(1e-10 + (m.x223*m.x224*(0.5*
                         m.x223 + 0.5*m.x224))**0.33333))**0.83 + (2.66666666666667*m.x160/(1e-10 + (m.x225*m.x226*(0.5*
                         m.x225 + 0.5*m.x226))**0.33333))**0.83 + (2.66666666666667*m.x161/(1e-10 + (m.x226*m.x227*(0.5*
                         m.x226 + 0.5*m.x227))**0.33333))**0.83) + 322*((1.4*m.x162/(1e-10 + (m.x228*m.x231*(0.5*m.x228
                          + 0.5*m.x231))**0.33333))**0.83 + (2.4*m.x163/(1e-10 + (m.x229*m.x232*(0.5*m.x229 + 0.5*m.x232)
                         )**0.33333))**0.83 + (1.06666666666667*m.x164/(1e-10 + (m.x230*m.x233*(0.5*m.x230 + 0.5*m.x233))
                         **0.33333))**0.83) + 322*((1.43478260869565*m.x165/(1e-10 + (70*m.x234*(35 + 0.5*m.x234))**
                         0.33333))**0.83 + (2.43478260869565*m.x166/(1e-10 + (30*m.x235*(15 + 0.5*m.x235))**0.33333))**
                         0.83 + (1.10144927536232*m.x167/(1e-10 + (30*m.x236*(15 + 0.5*m.x236))**0.33333))**0.83) + 322*(
                         (2.01923076923077*m.x168/(1e-10 + (m.x237*m.x238*(0.5*m.x237 + 0.5*m.x238))**0.33333))**0.83 + (
                         2.01923076923077*m.x169/(1e-10 + (m.x238*m.x239*(0.5*m.x238 + 0.5*m.x239))**0.33333))**0.83 + (
                         3.25*m.x170/(1e-10 + (m.x240*m.x241*(0.5*m.x240 + 0.5*m.x241))**0.33333))**0.83 + (3.25*m.x171/(
                         1e-10 + (m.x241*m.x242*(0.5*m.x241 + 0.5*m.x242))**0.33333))**0.83) + 322*((0.969230769230769*
                         m.x172/(1e-10 + (35*m.x243*(17.5 + 0.5*m.x243))**0.33333))**0.83 + (2.2*m.x173/(1e-10 + (220*
