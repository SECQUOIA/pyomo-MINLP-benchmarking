...
m.b626 = Var(within=Binary, bounds=(0, 1))
m.b627 = Var(within=Binary, bounds=(0, 1))
m.b628 = Var(within=Binary, bounds=(0, 1))
m.b629 = Var(within=Binary, bounds=(0, 1))
m.b630 = Var(within=Binary, bounds=(0, 1))
m.b631 = Var(within=Binary, bounds=(0, 1))
m.b632 = Var(within=Binary, bounds=(0, 1))
m.b633 = Var(within=Binary, bounds=(0, 1))
m.b634 = Var(within=Binary, bounds=(0, 1))
m.b635 = Var(within=Binary, bounds=(0, 1))
m.b636 = Var(within=Binary, bounds=(0, 1))
m.b637 = Var(within=Binary, bounds=(0, 1))
m.b638 = Var(within=Binary, bounds=(0, 1))
m.b639 = Var(within=Binary, bounds=(0, 1))
m.b640 = Var(within=Binary, bounds=(0, 1))
m.b641 = Var(within=Binary, bounds=(0, 1))
m.b642 = Var(within=Binary, bounds=(0, 1))
m.b643 = Var(within=Binary, bounds=(0, 1))
m.b644 = Var(within=Binary, bounds=(0, 1))
m.b645 = Var(within=Binary, bounds=(0, 1))
m.b646 = Var(within=Binary, bounds=(0, 1))
m.b647 = Var(within=Binary, bounds=(0, 1))
m.b648 = Var(within=Binary, bounds=(0, 1))
m.b649 = Var(within=Binary, bounds=(0, 1))
m.b650 = Var(within=Binary, bounds=(0, 1))
...
m.obj = Objective(expr=59*m.b626 + 8*m.b627 + 33*m.b628 + 68*m.b629 + 74*m.b630 + 19*m.b631 + 88*m.b632 + 75*m.b633
                  + 40*m.b634 + 98*m.b635 + 71*m.b636 + 41*m.b637 +
                  28*m.b638 + 60*m.b639 + 7*m.b640 + 60*m.b641
                  + 20*m.b642 + 51*m.b643 + 21*m.b644 + 48*m.b645 +
                  45*m.b646 + 78*m.b647 + 76*m.b648 + 58*m.b649
                  + 62*m.b650 + 40.7804759877481*m.x651 +
                  39.183122531594*m.x652 + 30.0630680918676*m.x653
...
m.c627 = Constraint(expr=m.x1 + m.x26 + m.x51 + m.x76 + m.x101 + m.x126 + m.x151 + m.x176 + m.x201 + m.x226 + m.x251
                    + m.x276 + m.x301 + m.x326 + m.x351 + m.x376 +
                    m.x401 + m.x426 + m.x451 + m.x476 + m.x501
...
m.c628 = Constraint(expr=m.x2 + m.x27 + m.x52 + m.x77 + m.x102 + m.x127 + m.x152 + m.x177 + m.x202 + m.x227 + m.x252
                    + m.x277 + m.x302 + m.x327 + m.x352 + m.x377 +
                    m.x402 + m.x427 + m.x452 + m.x477 + m.x502
...
m.c629 = Constraint(expr=m.x3 + m.x28 + m.x53 + m.x78 + m.x103 + m.x128 + m.x153 + m.x178 + m.x203 + m.x228 + m.x253
                    + m.x278 + m.x303 + m.x328 + m.x353 + m.x378 +
                    m.x403 + m.x428 + m.x453 + m.x478 + m.x503
...
m.c630 = Constraint(expr=m.x4 + m.x29 + m.x54 + m.x79 + m.x104 + m.x129 + m.x154 + m.x179 + m.x204 + m.x229 + m.x254
                    + m.x279 + m.x304 + m.x329 + m.x354 + m.x379 +
                    m.x404 + m.x429 + m.x454 + m.x479 + m.x504
...
m.c631 = Constraint(expr=m.x5 + m.x30 + m.x55 + m.x80 + m.x105 + m.x130 + m.x155 + m.x180 + m.x205 + m.x230 + m.x255
                    + m.x280 + m.x305 + m.x330 + m.x355 + m.x380 +
                    m.x405 + m.x430 + m.x455 + m.x480 + m.x505
...
m.c632 = Constraint(expr=m.x6 + m.x31 + m.x56 + m.x81 + m.x106 + m.x131 + m.x156 + m.x181 + m.x206 + m.x231 + m.x256
                    + m.x281 + m.x306 + m.x331 + m.x356 + m.x381 +
                    m.x406 + m.x431 + m.x456 + m.x481 + m.x506
...
m.c633 = Constraint(expr=m.x7 + m.x32 + m.x57 + m.x82 + m.x107 + m.x132 + m.x157 + m.x182 + m.x207 + m.x232 + m.x257
                    + m.x282 + m.x307 + m.x332 + m.x357 + m.x382 +
                    m.x407 + m.x432 + m.x457 + m.x482 + m.x507
...
m.c634 = Constraint(expr=m.x8 + m.x33 + m.x58 + m.x83 + m.x108 + m.x133 + m.x158 + m.x183 + m.x208 + m.x233 + m.x258
                    + m.x283 + m.x308 + m.x333 + m.x358 + m.x383 +
                    m.x408 + m.x433 + m.x458 + m.x483 + m.x508
...
m.c635 = Constraint(expr=m.x9 + m.x34 + m.x59 + m.x84 + m.x109 + m.x134 + m.x159 + m.x184 + m.x209 + m.x234 + m.x259
                    + m.x284 + m.x309 + m.x334 + m.x359 + m.x384 +
                    m.x409 + m.x434 + m.x459 + m.x484 + m.x509
...
m.c636 = Constraint(expr=m.x10 + m.x35 + m.x60 + m.x85 + m.x110 + m.x135 + m.x160 + m.x185 + m.x210 + m.x235 + m.x260
                    + m.x285 + m.x310 + m.x335 + m.x360 + m.x385 +
                    m.x410 + m.x435 + m.x460 + m.x485 + m.x510
...
m.c637 = Constraint(expr=m.x11 + m.x36 + m.x61 + m.x86 + m.x111 + m.x136 + m.x161 + m.x186 + m.x211 + m.x236 + m.x261
                    + m.x286 + m.x311 + m.x336 + m.x361 + m.x386 +
                    m.x411 + m.x436 + m.x461 + m.x486 + m.x511
...
m.c638 = Constraint(expr=m.x12 + m.x37 + m.x62 + m.x87 + m.x112 + m.x137 + m.x162 + m.x187 + m.x212 + m.x237 + m.x262
                    + m.x287 + m.x312 + m.x337 + m.x362 + m.x387 +
                    m.x412 + m.x437 + m.x462 + m.x487 + m.x512
...
m.c639 = Constraint(expr=m.x13 + m.x38 + m.x63 + m.x88 + m.x113 + m.x138 + m.x163 + m.x188 + m.x213 + m.x238 + m.x263
                    + m.x288 + m.x313 + m.x338 + m.x363 + m.x388 +
                    m.x413 + m.x438 + m.x463 + m.x488 + m.x513
...
m.c640 = Constraint(expr=m.x14 + m.x39 + m.x64 + m.x89 + m.x114 + m.x139 + m.x164 + m.x189 + m.x214 + m.x239 + m.x264
                    + m.x289 + m.x314 + m.x339 + m.x364 + m.x389 +
                    m.x414 + m.x439 + m.x464 + m.x489 + m.x514
...
m.c641 = Constraint(expr=m.x15 + m.x40 + m.x65 + m.x90 + m.x115 + m.x140 + m.x165 + m.x190 + m.x215 + m.x240 + m.x265
                    + m.x290 + m.x315 + m.x340 + m.x365 + m.x390 +
                    m.x415 + m.x440 + m.x465 + m.x490 + m.x515
...
m.c642 = Constraint(expr=m.x16 + m.x41 + m.x66 + m.x91 + m.x116 + m.x141 + m.x166 + m.x191 + m.x216 + m.x241 + m.x266
                    + m.x291 + m.x316 + m.x341 + m.x366 + m.x391 +
                    m.x416 + m.x441 + m.x466 + m.x491 + m.x516
...
m.c643 = Constraint(expr=m.x17 + m.x42 + m.x67 + m.x92 + m.x117 + m.x142 + m.x167 + m.x192 + m.x217 + m.x242 + m.x267
                    + m.x292 + m.x317 + m.x342 + m.x367 + m.x392 +
                    m.x417 + m.x442 + m.x467 + m.x492 + m.x517
...
m.c644 = Constraint(expr=m.x18 + m.x43 + m.x68 + m.x93 + m.x118 + m.x143 + m.x168 + m.x193 + m.x218 + m.x243 + m.x268
                    + m.x293 + m.x318 + m.x343 + m.x368 + m.x393 +
                    m.x418 + m.x443 + m.x468 + m.x493 + m.x518
...
m.c645 = Constraint(expr=m.x19 + m.x44 + m.x69 + m.x94 + m.x119 + m.x144 + m.x169 + m.x194 + m.x219 + m.x244 + m.x269
                    + m.x294 + m.x319 + m.x344 + m.x369 + m.x394 +
                    m.x419 + m.x444 + m.x469 + m.x494 + m.x519
...
m.c646 = Constraint(expr=m.x20 + m.x45 + m.x70 + m.x95 + m.x120 + m.x145 + m.x170 + m.x195 + m.x220 + m.x245 + m.x270
                    + m.x295 + m.x320 + m.x345 + m.x370 + m.x395 +
                    m.x420 + m.x445 + m.x470 + m.x495 + m.x520
...
m.c647 = Constraint(expr=m.x21 + m.x46 + m.x71 + m.x96 + m.x121 + m.x146 + m.x171 + m.x196 + m.x221 + m.x246 + m.x271
                    + m.x296 + m.x321 + m.x346 + m.x371 + m.x396 +
                    m.x421 + m.x446 + m.x471 + m.x496 + m.x521
...
m.c648 = Constraint(expr=m.x22 + m.x47 + m.x72 + m.x97 + m.x122 + m.x147 + m.x172 + m.x197 + m.x222 + m.x247 + m.x272
                    + m.x297 + m.x322 + m.x347 + m.x372 + m.x397 +
                    m.x422 + m.x447 + m.x472 + m.x497 + m.x522
...
m.c649 = Constraint(expr=m.x23 + m.x48 + m.x73 + m.x98 + m.x123 + m.x148 + m.x173 + m.x198 + m.x223 + m.x248 + m.x273
                    + m.x298 + m.x323 + m.x348 + m.x373 + m.x398 +
                    m.x423 + m.x448 + m.x473 + m.x498 + m.x523
...
m.c650 = Constraint(expr=m.x24 + m.x49 + m.x74 + m.x99 + m.x124 + m.x149 + m.x174 + m.x199 + m.x224 + m.x249 + m.x274
                    + m.x299 + m.x324 + m.x349 + m.x374 + m.x399 +
                    m.x424 + m.x449 + m.x474 + m.x499 + m.x524
                    + m.x549 + m.x574 + m.x599 + m.x624 == 1)

m.c651 = Constraint(expr=m.x25 + m.x50 + m.x75 + m.x100 + m.x125 + m.x150 + m.x175 + m.x200 + m.x225 + m.x250
                    + m.x275 + m.x300 + m.x325 + m.x350 + m.x375 +
                    m.x400 + m.x425 + m.x450 + m.x475 + m.x500
