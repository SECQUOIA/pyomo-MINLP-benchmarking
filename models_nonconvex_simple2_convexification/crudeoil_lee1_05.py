...
m.obj = Objective(expr=0.1*m.x226 + 0.6*m.x227 + 0.2*m.x228 + 0.5*m.x229 + 0.1*m.x230 + 0.6*m.x231 + 0.2*m.x232
                  + 0.5*m.x233 + 0.1*m.x258 + 0.6*m.x259 + 0.2 *
                  m.x260 + 0.5*m.x261 + 0.1*m.x262 + 0.6*m.x263
                  + 0.2*m.x264 + 0.5*m.x265 + 0.1*m.x290 + 0.6 *
                  m.x291 + 0.2*m.x292 + 0.5*m.x293 + 0.1*m.x294
                  + 0.6*m.x295 + 0.2*m.x296 + 0.5*m.x297 + 0.1 *
                  m.x322 + 0.6*m.x323 + 0.2*m.x324 + 0.5*m.x325
                  + 0.1*m.x326 + 0.6*m.x327 + 0.2*m.x328 + 0.5 *
                  m.x329 + 0.1*m.x354 + 0.6*m.x355 + 0.2*m.x356
...
m.c56 = Constraint(expr=m.b8 + m.b9 + m.b16 + m.b17 + m.b24 +
                   m.b25 + m.b32 + m.b33 + m.b40 + m.b41 >= 3)
...
m.c61 = Constraint(expr=m.b8 + m.b9 + m.b16 + m.b17 + m.b24 +
                   m.b25 + m.b32 + m.b33 + m.b40 + m.b41 <= 3)
...
m.c64 = Constraint(expr=- m.x43 - m.x51 - m.x59 - m.x67 -
                   m.x75 + m.x122 + m.x130 + m.x138 + m.x146 + m.x154 <= 0)
...
m.c68 = Constraint(expr=m.b2 - m.b3 + m.b10 -
                   m.b11 + m.b18 - m.b19 - m.b27 >= 0)

m.c69 = Constraint(expr=m.b2 - m.b3 + m.b10 - m.b11 +
...
m.c621 = Constraint(expr=- m.x162 + m.x164 + m.x165 -
                    m.x170 + m.x172 + m.x173 + m.x378 == 25)

m.c622 = Constraint(expr=- m.x163 + m.x166 + m.x167 -
                    m.x171 + m.x174 + m.x175 + m.x379 == 75)

m.c623 = Constraint(expr=- m.x164 - m.x166 + m.x168 -
                    m.x172 - m.x174 + m.x176 + m.x380 == 50)

m.c624 = Constraint(expr=- m.x165 - m.x167 + m.x169 -
                    m.x173 - m.x175 + m.x177 + m.x381 == 50)
...
m.c632 = Constraint(expr=- m.x168 - m.x169 - m.x176 -
                    m.x177 - m.x184 - m.x185 + m.x389 == 0)
...
m.c639 = Constraint(expr=- m.x168 - m.x169 - m.x176 -
                    m.x177 - m.x184 - m.x185 - m.x192 - m.x193 + m.x396 == 0)
...
m.c704 = Constraint(expr=- m.x202 + m.x210 + m.x214 -
                    m.x234 + m.x242 + m.x246 + m.x461 == 25)

m.c705 = Constraint(expr=- m.x203 + m.x211 + m.x215 -
                    m.x235 + m.x243 + m.x247 + m.x462 == 0)

m.c706 = Constraint(expr=- m.x204 + m.x212 + m.x216 -
                    m.x236 + m.x244 + m.x248 + m.x463 == 0)

m.c707 = Constraint(expr=- m.x205 + m.x213 + m.x217 -
                    m.x237 + m.x245 + m.x249 + m.x464 == 0)

m.c708 = Constraint(expr=- m.x206 + m.x218 + m.x222 -
                    m.x238 + m.x250 + m.x254 + m.x465 == 0)

m.c709 = Constraint(expr=- m.x207 + m.x219 + m.x223 -
                    m.x239 + m.x251 + m.x255 + m.x466 == 75)

m.c710 = Constraint(expr=- m.x208 + m.x220 + m.x224 -
                    m.x240 + m.x252 + m.x256 + m.x467 == 0)

m.c711 = Constraint(expr=- m.x209 + m.x221 + m.x225 -
                    m.x241 + m.x253 + m.x257 + m.x468 == 0)

m.c712 = Constraint(expr=- m.x210 - m.x218 + m.x226 -
                    m.x242 - m.x250 + m.x258 + m.x469 == 0)

m.c713 = Constraint(expr=- m.x211 - m.x219 + m.x227 -
                    m.x243 - m.x251 + m.x259 + m.x470 == 0)

m.c714 = Constraint(expr=- m.x212 - m.x220 + m.x228 -
                    m.x244 - m.x252 + m.x260 + m.x471 == 50)

m.c715 = Constraint(expr=- m.x213 - m.x221 + m.x229 -
                    m.x245 - m.x253 + m.x261 + m.x472 == 0)

m.c716 = Constraint(expr=- m.x214 - m.x222 + m.x230 -
                    m.x246 - m.x254 + m.x262 + m.x473 == 0)

m.c717 = Constraint(expr=- m.x215 - m.x223 + m.x231 -
                    m.x247 - m.x255 + m.x263 + m.x474 == 0)

m.c718 = Constraint(expr=- m.x216 - m.x224 + m.x232 -
                    m.x248 - m.x256 + m.x264 + m.x475 == 0)

m.c719 = Constraint(expr=- m.x217 - m.x225 + m.x233 -
                    m.x249 - m.x257 + m.x265 + m.x476 == 50)
...
m.c748 = Constraint(expr=- m.x226 - m.x230 - m.x258 -
                    m.x262 - m.x290 - m.x294 + m.x505 == 0)

m.c749 = Constraint(expr=- m.x227 - m.x231 - m.x259 -
                    m.x263 - m.x291 - m.x295 + m.x506 == 0)

m.c750 = Constraint(expr=- m.x228 - m.x232 - m.x260 -
                    m.x264 - m.x292 - m.x296 + m.x507 == 0)

m.c751 = Constraint(expr=- m.x229 - m.x233 - m.x261 -
                    m.x265 - m.x293 - m.x297 + m.x508 == 0)
...
m.c776 = Constraint(expr=- m.x226 - m.x230 - m.x258 -
                    m.x262 - m.x290 - m.x294 - m.x322 - m.x326 + m.x533 == 0)

m.c777 = Constraint(expr=- m.x227 - m.x231 - m.x259 -
                    m.x263 - m.x291 - m.x295 - m.x323 - m.x327 + m.x534 == 0)

m.c778 = Constraint(expr=- m.x228 - m.x232 - m.x260 -
                    m.x264 - m.x292 - m.x296 - m.x324 - m.x328 + m.x535 == 0)

m.c779 = Constraint(expr=- m.x229 - m.x233 - m.x261 -
                    m.x265 - m.x293 - m.x297 - m.x325 - m.x329 + m.x536 == 0)
...
m.c1020 = Constraint(expr=m.x88 + m.x89 + m.x96 + m.x97 +
                     m.x104 + m.x105 + m.x112 + m.x113 + m.x120 + m.x121 == 8)
...
m.c1025 = Constraint(expr=- 0.15*m.x168 + 0.1*m.x226 +
                     0.6*m.x227 + 0.2*m.x228 + 0.5*m.x229 >= 0)

m.c1026 = Constraint(expr=- 0.45*m.x169 + 0.1*m.x230 +
                     0.6*m.x231 + 0.2*m.x232 + 0.5*m.x233 >= 0)

m.c1027 = Constraint(expr=- 0.15*m.x176 + 0.1*m.x258 +
                     0.6*m.x259 + 0.2*m.x260 + 0.5*m.x261 >= 0)

m.c1028 = Constraint(expr=- 0.45*m.x177 + 0.1*m.x262 +
                     0.6*m.x263 + 0.2*m.x264 + 0.5*m.x265 >= 0)

m.c1029 = Constraint(expr=- 0.15*m.x184 + 0.1*m.x290 +
                     0.6*m.x291 + 0.2*m.x292 + 0.5*m.x293 >= 0)

m.c1030 = Constraint(expr=- 0.45*m.x185 + 0.1*m.x294 +
                     0.6*m.x295 + 0.2*m.x296 + 0.5*m.x297 >= 0)

m.c1031 = Constraint(expr=- 0.15*m.x192 + 0.1*m.x322 +
                     0.6*m.x323 + 0.2*m.x324 + 0.5*m.x325 >= 0)

m.c1032 = Constraint(expr=- 0.45*m.x193 + 0.1*m.x326 +
                     0.6*m.x327 + 0.2*m.x328 + 0.5*m.x329 >= 0)

m.c1033 = Constraint(expr=- 0.15*m.x200 + 0.1*m.x354 +
                     0.6*m.x355 + 0.2*m.x356 + 0.5*m.x357 >= 0)

m.c1034 = Constraint(expr=- 0.45*m.x201 + 0.1*m.x358 +
                     0.6*m.x359 + 0.2*m.x360 + 0.5*m.x361 >= 0)

m.c1035 = Constraint(expr=- 0.25*m.x168 + 0.1*m.x226 +
                     0.6*m.x227 + 0.2*m.x228 + 0.5*m.x229 <= 0)

m.c1036 = Constraint(expr=- 0.55*m.x169 + 0.1*m.x230 +
                     0.6*m.x231 + 0.2*m.x232 + 0.5*m.x233 <= 0)

m.c1037 = Constraint(expr=- 0.25*m.x176 + 0.1*m.x258 +
                     0.6*m.x259 + 0.2*m.x260 + 0.5*m.x261 <= 0)

m.c1038 = Constraint(expr=- 0.55*m.x177 + 0.1*m.x262 +
                     0.6*m.x263 + 0.2*m.x264 + 0.5*m.x265 <= 0)

m.c1039 = Constraint(expr=- 0.25*m.x184 + 0.1*m.x290 +
                     0.6*m.x291 + 0.2*m.x292 + 0.5*m.x293 <= 0)

m.c1040 = Constraint(expr=- 0.55*m.x185 + 0.1*m.x294 +
                     0.6*m.x295 + 0.2*m.x296 + 0.5*m.x297 <= 0)

m.c1041 = Constraint(expr=- 0.25*m.x192 + 0.1*m.x322 +
                     0.6*m.x323 + 0.2*m.x324 + 0.5*m.x325 <= 0)

m.c1042 = Constraint(expr=- 0.55*m.x193 + 0.1*m.x326 +
                     0.6*m.x327 + 0.2*m.x328 + 0.5*m.x329 <= 0)

m.c1043 = Constraint(expr=- 0.25*m.x200 + 0.1*m.x354 +
                     0.6*m.x355 + 0.2*m.x356 + 0.5*m.x357 <= 0)

m.c1044 = Constraint(expr=- 0.55*m.x201 + 0.1*m.x358 +
                     0.6*m.x359 + 0.2*m.x360 + 0.5*m.x361 <= 0)
...
m.c1110 = Constraint(expr=8*m.b10 + 8*m.b11 - m.x50 -
                     m.x51 + m.x122 + m.x123 <= 8)

m.c1111 = Constraint(expr=8*m.b10 + 8*m.b12 - m.x50 -
                     m.x52 + m.x122 + m.x124 <= 8)

m.c1112 = Constraint(expr=8*m.b10 + 8*m.b13 - m.x50 -
                     m.x53 + m.x122 + m.x125 <= 8)

m.c1113 = Constraint(expr=8*m.b11 + 8*m.b14 - m.x51 -
                     m.x54 + m.x123 + m.x126 <= 8)

m.c1114 = Constraint(expr=8*m.b11 + 8*m.b15 - m.x51 -
                     m.x55 + m.x123 + m.x127 <= 8)

m.c1115 = Constraint(expr=8*m.b12 + 8*m.b16 - m.x52 -
                     m.x56 + m.x124 + m.x128 <= 8)

m.c1116 = Constraint(expr=8*m.b13 + 8*m.b17 - m.x53 -
                     m.x57 + m.x125 + m.x129 <= 8)

m.c1117 = Constraint(expr=8*m.b14 + 8*m.b16 - m.x54 -
                     m.x56 + m.x126 + m.x128 <= 8)

m.c1118 = Constraint(expr=8*m.b15 + 8*m.b17 - m.x55 -
                     m.x57 + m.x127 + m.x129 <= 8)

m.c1119 = Constraint(expr=8*m.b16 + 8*m.b17 - m.x56 -
                     m.x57 + m.x128 + m.x129 <= 8)

m.c1120 = Constraint(expr=8*m.b18 + 8*m.b19 - m.x58 -
                     m.x59 + m.x90 + m.x91 + m.x122 + m.x123 <= 8)

m.c1121 = Constraint(expr=8*m.b18 + 8*m.b20 - m.x58 -
                     m.x60 + m.x90 + m.x92 + m.x122 + m.x124 <= 8)

m.c1122 = Constraint(expr=8*m.b18 + 8*m.b21 - m.x58 -
                     m.x61 + m.x90 + m.x93 + m.x122 + m.x125 <= 8)

m.c1123 = Constraint(expr=8*m.b19 + 8*m.b22 - m.x59 -
                     m.x62 + m.x91 + m.x94 + m.x123 + m.x126 <= 8)

m.c1124 = Constraint(expr=8*m.b19 + 8*m.b23 - m.x59 -
                     m.x63 + m.x91 + m.x95 + m.x123 + m.x127 <= 8)

m.c1125 = Constraint(expr=8*m.b20 + 8*m.b24 - m.x60 -
                     m.x64 + m.x92 + m.x96 + m.x124 + m.x128 <= 8)

m.c1126 = Constraint(expr=8*m.b21 + 8*m.b25 - m.x61 -
                     m.x65 + m.x93 + m.x97 + m.x125 + m.x129 <= 8)

m.c1127 = Constraint(expr=8*m.b22 + 8*m.b24 - m.x62 -
                     m.x64 + m.x94 + m.x96 + m.x126 + m.x128 <= 8)

m.c1128 = Constraint(expr=8*m.b23 + 8*m.b25 - m.x63 -
                     m.x65 + m.x95 + m.x97 + m.x127 + m.x129 <= 8)

m.c1129 = Constraint(expr=8*m.b24 + 8*m.b25 - m.x64 -
                     m.x65 + m.x96 + m.x97 + m.x128 + m.x129 <= 8)

m.c1130 = Constraint(expr=8*m.b26 + 8*m.b27 - m.x66 - m.x67 +
                     m.x90 + m.x91 + m.x98 + m.x99 + m.x122 + m.x123 <= 8)

m.c1131 = Constraint(expr=8*m.b26 + 8*m.b28 - m.x66 - m.x68 +
                     m.x90 + m.x92 + m.x98 + m.x100 + m.x122 + m.x124 <= 8)

m.c1132 = Constraint(expr=8*m.b26 + 8*m.b29 - m.x66 - m.x69 +
                     m.x90 + m.x93 + m.x98 + m.x101 + m.x122 + m.x125 <= 8)

m.c1133 = Constraint(expr=8*m.b27 + 8*m.b30 - m.x67 - m.x70 +
                     m.x91 + m.x94 + m.x99 + m.x102 + m.x123 + m.x126 <= 8)

m.c1134 = Constraint(expr=8*m.b27 + 8*m.b31 - m.x67 - m.x71 +
                     m.x91 + m.x95 + m.x99 + m.x103 + m.x123 + m.x127 <= 8)

m.c1135 = Constraint(expr=8*m.b28 + 8*m.b32 - m.x68 - m.x72 +
                     m.x92 + m.x96 + m.x100 + m.x104 + m.x124 + m.x128 <= 8)

m.c1136 = Constraint(expr=8*m.b29 + 8*m.b33 - m.x69 - m.x73 +
                     m.x93 + m.x97 + m.x101 + m.x105 + m.x125 + m.x129 <= 8)

m.c1137 = Constraint(expr=8*m.b30 + 8*m.b32 - m.x70 - m.x72 +
                     m.x94 + m.x96 + m.x102 + m.x104 + m.x126 + m.x128 <= 8)

m.c1138 = Constraint(expr=8*m.b31 + 8*m.b33 - m.x71 - m.x73 +
                     m.x95 + m.x97 + m.x103 + m.x105 + m.x127 + m.x129 <= 8)

m.c1139 = Constraint(expr=8*m.b32 + 8*m.b33 - m.x72 - m.x73 +
                     m.x96 + m.x97 + m.x104 + m.x105 + m.x128 + m.x129 <= 8)
...
m.c1150 = Constraint(expr=8*m.b18 + 8*m.b19 - m.x58 -
                     m.x59 + m.x130 + m.x131 <= 8)

m.c1151 = Constraint(expr=8*m.b18 + 8*m.b20 - m.x58 -
                     m.x60 + m.x130 + m.x132 <= 8)

m.c1152 = Constraint(expr=8*m.b18 + 8*m.b21 - m.x58 -
                     m.x61 + m.x130 + m.x133 <= 8)

m.c1153 = Constraint(expr=8*m.b19 + 8*m.b22 - m.x59 -
                     m.x62 + m.x131 + m.x134 <= 8)

m.c1154 = Constraint(expr=8*m.b19 + 8*m.b23 - m.x59 -
                     m.x63 + m.x131 + m.x135 <= 8)

m.c1155 = Constraint(expr=8*m.b20 + 8*m.b24 - m.x60 -
                     m.x64 + m.x132 + m.x136 <= 8)

m.c1156 = Constraint(expr=8*m.b21 + 8*m.b25 - m.x61 -
                     m.x65 + m.x133 + m.x137 <= 8)

m.c1157 = Constraint(expr=8*m.b22 + 8*m.b24 - m.x62 -
                     m.x64 + m.x134 + m.x136 <= 8)

m.c1158 = Constraint(expr=8*m.b23 + 8*m.b25 - m.x63 -
                     m.x65 + m.x135 + m.x137 <= 8)

m.c1159 = Constraint(expr=8*m.b24 + 8*m.b25 - m.x64 -
                     m.x65 + m.x136 + m.x137 <= 8)

m.c1160 = Constraint(expr=8*m.b26 + 8*m.b27 - m.x66 -
                     m.x67 + m.x98 + m.x99 + m.x130 + m.x131 <= 8)

m.c1161 = Constraint(expr=8*m.b26 + 8*m.b28 - m.x66 -
                     m.x68 + m.x98 + m.x100 + m.x130 + m.x132 <= 8)

m.c1162 = Constraint(expr=8*m.b26 + 8*m.b29 - m.x66 -
                     m.x69 + m.x98 + m.x101 + m.x130 + m.x133 <= 8)

m.c1163 = Constraint(expr=8*m.b27 + 8*m.b30 - m.x67 -
                     m.x70 + m.x99 + m.x102 + m.x131 + m.x134 <= 8)

m.c1164 = Constraint(expr=8*m.b27 + 8*m.b31 - m.x67 -
                     m.x71 + m.x99 + m.x103 + m.x131 + m.x135 <= 8)

m.c1165 = Constraint(expr=8*m.b28 + 8*m.b32 - m.x68 -
                     m.x72 + m.x100 + m.x104 + m.x132 + m.x136 <= 8)

m.c1166 = Constraint(expr=8*m.b29 + 8*m.b33 - m.x69 -
                     m.x73 + m.x101 + m.x105 + m.x133 + m.x137 <= 8)

m.c1167 = Constraint(expr=8*m.b30 + 8*m.b32 - m.x70 -
                     m.x72 + m.x102 + m.x104 + m.x134 + m.x136 <= 8)

m.c1168 = Constraint(expr=8*m.b31 + 8*m.b33 - m.x71 -
                     m.x73 + m.x103 + m.x105 + m.x135 + m.x137 <= 8)

m.c1169 = Constraint(expr=8*m.b32 + 8*m.b33 - m.x72 -
                     m.x73 + m.x104 + m.x105 + m.x136 + m.x137 <= 8)

m.c1170 = Constraint(expr=8*m.b34 + 8*m.b35 - m.x74 - m.x75 +
                     m.x98 + m.x99 + m.x106 + m.x107 + m.x130 + m.x131 <= 8)
...
m.c1180 = Constraint(expr=8*m.b26 + 8*m.b27 - m.x66 -
                     m.x67 + m.x138 + m.x139 <= 8)

m.c1181 = Constraint(expr=8*m.b26 + 8*m.b28 - m.x66 -
                     m.x68 + m.x138 + m.x140 <= 8)

m.c1182 = Constraint(expr=8*m.b26 + 8*m.b29 - m.x66 -
                     m.x69 + m.x138 + m.x141 <= 8)

m.c1183 = Constraint(expr=8*m.b27 + 8*m.b30 - m.x67 -
                     m.x70 + m.x139 + m.x142 <= 8)

m.c1184 = Constraint(expr=8*m.b27 + 8*m.b31 - m.x67 -
                     m.x71 + m.x139 + m.x143 <= 8)

m.c1185 = Constraint(expr=8*m.b28 + 8*m.b32 - m.x68 -
                     m.x72 + m.x140 + m.x144 <= 8)

m.c1186 = Constraint(expr=8*m.b29 + 8*m.b33 - m.x69 -
                     m.x73 + m.x141 + m.x145 <= 8)

m.c1187 = Constraint(expr=8*m.b30 + 8*m.b32 - m.x70 -
                     m.x72 + m.x142 + m.x144 <= 8)

m.c1188 = Constraint(expr=8*m.b31 + 8*m.b33 - m.x71 -
                     m.x73 + m.x143 + m.x145 <= 8)

m.c1189 = Constraint(expr=8*m.b32 + 8*m.b33 - m.x72 -
                     m.x73 + m.x144 + m.x145 <= 8)

m.c1190 = Constraint(expr=8*m.b34 + 8*m.b35 - m.x74 -
                     m.x75 + m.x106 + m.x107 + m.x138 + m.x139 <= 8)

m.c1191 = Constraint(expr=8*m.b34 + 8*m.b36 - m.x74 -
                     m.x76 + m.x106 + m.x108 + m.x138 + m.x140 <= 8)

m.c1192 = Constraint(expr=8*m.b34 + 8*m.b37 - m.x74 -
                     m.x77 + m.x106 + m.x109 + m.x138 + m.x141 <= 8)

m.c1193 = Constraint(expr=8*m.b35 + 8*m.b38 - m.x75 -
                     m.x78 + m.x107 + m.x110 + m.x139 + m.x142 <= 8)

m.c1194 = Constraint(expr=8*m.b35 + 8*m.b39 - m.x75 -
                     m.x79 + m.x107 + m.x111 + m.x139 + m.x143 <= 8)

m.c1195 = Constraint(expr=8*m.b36 + 8*m.b40 - m.x76 -
                     m.x80 + m.x108 + m.x112 + m.x140 + m.x144 <= 8)

m.c1196 = Constraint(expr=8*m.b37 + 8*m.b41 - m.x77 -
                     m.x81 + m.x109 + m.x113 + m.x141 + m.x145 <= 8)

m.c1197 = Constraint(expr=8*m.b38 + 8*m.b40 - m.x78 -
                     m.x80 + m.x110 + m.x112 + m.x142 + m.x144 <= 8)

m.c1198 = Constraint(expr=8*m.b39 + 8*m.b41 - m.x79 -
                     m.x81 + m.x111 + m.x113 + m.x143 + m.x145 <= 8)

m.c1199 = Constraint(expr=8*m.b40 + 8*m.b41 - m.x80 -
                     m.x81 + m.x112 + m.x113 + m.x144 + m.x145 <= 8)

m.c1200 = Constraint(expr=8*m.b34 + 8*m.b35 - m.x74 -
                     m.x75 + m.x146 + m.x147 <= 8)

m.c1201 = Constraint(expr=8*m.b34 + 8*m.b36 - m.x74 -
                     m.x76 + m.x146 + m.x148 <= 8)

m.c1202 = Constraint(expr=8*m.b34 + 8*m.b37 - m.x74 -
                     m.x77 + m.x146 + m.x149 <= 8)

m.c1203 = Constraint(expr=8*m.b35 + 8*m.b38 - m.x75 -
                     m.x78 + m.x147 + m.x150 <= 8)

m.c1204 = Constraint(expr=8*m.b35 + 8*m.b39 - m.x75 -
                     m.x79 + m.x147 + m.x151 <= 8)

m.c1205 = Constraint(expr=8*m.b36 + 8*m.b40 - m.x76 -
                     m.x80 + m.x148 + m.x152 <= 8)

m.c1206 = Constraint(expr=8*m.b37 + 8*m.b41 - m.x77 -
                     m.x81 + m.x149 + m.x153 <= 8)

m.c1207 = Constraint(expr=8*m.b38 + 8*m.b40 - m.x78 -
                     m.x80 + m.x150 + m.x152 <= 8)

m.c1208 = Constraint(expr=8*m.b39 + 8*m.b41 - m.x79 -
                     m.x81 + m.x151 + m.x153 <= 8)

m.c1209 = Constraint(expr=8*m.b40 + 8*m.b41 - m.x80 -
                     m.x81 + m.x152 + m.x153 <= 8)
