...
m.obj = Objective(expr=150*(2*m.x25/(1e-10 + (1e-10 + 0.5*m.x41*m.x42*(m.x41 + m.x42))**0.33333) + 2*m.x26/(1e-10 + (1e-6
                        + 0.5*m.x42*m.x43*(m.x42 + m.x43))**0.33333) + 2*m.x28/(1e-10 + (1e-10 + 0.5*m.x44*m.x45*(m.x44 + 
                       m.x45))**0.33333) + 2*m.x29/(1e-10 + (1e-10 + 0.5*m.x45*m.x46*(m.x45 + m.x46))**0.33333) + 2*m.x31/
                       (1e-10 + (1e-10 + 0.5*m.x47*m.x48*(m.x47 + m.x48))**0.33333) + 2*m.x32/(1e-10 + (1e-10 + 0.5*m.x48*
                       m.x49*(m.x48 + m.x49))**0.33333) + 2*m.x34/(1e-10 + (1e-10 + 0.5*m.x50*m.x51*(m.x50 + m.x51))**
                       0.33333) + 2*m.x35/(1e-10 + (1e-10 + 0.5*m.x51*m.x52*(m.x51 + m.x52))**0.33333)) + 150*(1.2*m.x39/(
                       1e-10 + 30*m.x55*(15 + 0.5*m.x55))**0.33333 + 1.2*m.x40/(1e-10 + 180*m.x56*(90 + 0.5*m.x56))**
                       0.33333) + 150*(2*m.x37/(1e-10 + 35*m.x53*(70 + m.x53))**0.33333 + 2*m.x38/(1e-10 + 35*m.x54*(70 + 
