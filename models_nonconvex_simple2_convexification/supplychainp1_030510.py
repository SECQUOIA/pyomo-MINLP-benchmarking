...
m.obj = Objective(expr=88.85300006996*sqrt(1e-10 + m.x242) + 192.23073994166*sqrt(1e-10 + m.x243) + 127.63233374696*sqrt(
                       1e-10 + m.x244) + 419.48235478268*sqrt(1e-10 + m.x245) + 153.22284111554*sqrt(1e-10 + m.x246) + 
                       11812.8060023653*sqrt(1e-10 + m.x81) + 1350.11753695442*sqrt(1e-10 + m.x82) + 13367.9894872554*
                       sqrt(1e-10 + m.x83) + 22271.0227712868*sqrt(1e-10 + m.x84) + 3005.94387692899*sqrt(1e-10 + m.x85) + 
                       8081.13134168897*sqrt(1e-10 + m.x86) + 2725.40259637536*sqrt(1e-10 + m.x87) + 17834.6321864598*
                       sqrt(1e-10 + m.x88) + 11090.3708869987*sqrt(1e-10 + m.x89) + 34135.3450147183*sqrt(1e-10 + m.x90)
