#  MINLP written by GAMS Convert at 08/20/20 01:30:36
#
#  Equation counts
#      Total        E        G        L        N        X        C        B
...
m.b801 = Var(within=Binary, bounds=(0, 1))
m.b802 = Var(within=Binary, bounds=(0, 1))
m.b803 = Var(within=Binary, bounds=(0, 1))
m.b804 = Var(within=Binary, bounds=(0, 1))
m.b805 = Var(within=Binary, bounds=(0, 1))
m.b806 = Var(within=Binary, bounds=(0, 1))
m.b807 = Var(within=Binary, bounds=(0, 1))
m.b808 = Var(within=Binary, bounds=(0, 1))
m.b809 = Var(within=Binary, bounds=(0, 1))
m.b810 = Var(within=Binary, bounds=(0, 1))
...
m.c802 = Constraint(expr=m.x1 + m.x81 + m.x161 + m.x241 +
                    m.x321 + m.x401 + m.x481 + m.x561 + m.x641 + m.x721 == 1)

m.c803 = Constraint(expr=m.x2 + m.x82 + m.x162 + m.x242 +
                    m.x322 + m.x402 + m.x482 + m.x562 + m.x642 + m.x722 == 1)

m.c804 = Constraint(expr=m.x3 + m.x83 + m.x163 + m.x243 +
                    m.x323 + m.x403 + m.x483 + m.x563 + m.x643 + m.x723 == 1)

m.c805 = Constraint(expr=m.x4 + m.x84 + m.x164 + m.x244 +
                    m.x324 + m.x404 + m.x484 + m.x564 + m.x644 + m.x724 == 1)

m.c806 = Constraint(expr=m.x5 + m.x85 + m.x165 + m.x245 +
                    m.x325 + m.x405 + m.x485 + m.x565 + m.x645 + m.x725 == 1)

m.c807 = Constraint(expr=m.x6 + m.x86 + m.x166 + m.x246 +
                    m.x326 + m.x406 + m.x486 + m.x566 + m.x646 + m.x726 == 1)

m.c808 = Constraint(expr=m.x7 + m.x87 + m.x167 + m.x247 +
                    m.x327 + m.x407 + m.x487 + m.x567 + m.x647 + m.x727 == 1)

m.c809 = Constraint(expr=m.x8 + m.x88 + m.x168 + m.x248 +
                    m.x328 + m.x408 + m.x488 + m.x568 + m.x648 + m.x728 == 1)

m.c810 = Constraint(expr=m.x9 + m.x89 + m.x169 + m.x249 +
                    m.x329 + m.x409 + m.x489 + m.x569 + m.x649 + m.x729 == 1)

m.c811 = Constraint(expr=m.x10 + m.x90 + m.x170 + m.x250 +
                    m.x330 + m.x410 + m.x490 + m.x570 + m.x650 + m.x730 == 1)

m.c812 = Constraint(expr=m.x11 + m.x91 + m.x171 + m.x251 +
                    m.x331 + m.x411 + m.x491 + m.x571 + m.x651 + m.x731 == 1)

m.c813 = Constraint(expr=m.x12 + m.x92 + m.x172 + m.x252 +
                    m.x332 + m.x412 + m.x492 + m.x572 + m.x652 + m.x732 == 1)

m.c814 = Constraint(expr=m.x13 + m.x93 + m.x173 + m.x253 +
                    m.x333 + m.x413 + m.x493 + m.x573 + m.x653 + m.x733 == 1)

m.c815 = Constraint(expr=m.x14 + m.x94 + m.x174 + m.x254 +
                    m.x334 + m.x414 + m.x494 + m.x574 + m.x654 + m.x734 == 1)

m.c816 = Constraint(expr=m.x15 + m.x95 + m.x175 + m.x255 +
                    m.x335 + m.x415 + m.x495 + m.x575 + m.x655 + m.x735 == 1)

m.c817 = Constraint(expr=m.x16 + m.x96 + m.x176 + m.x256 +
                    m.x336 + m.x416 + m.x496 + m.x576 + m.x656 + m.x736 == 1)

m.c818 = Constraint(expr=m.x17 + m.x97 + m.x177 + m.x257 +
                    m.x337 + m.x417 + m.x497 + m.x577 + m.x657 + m.x737 == 1)

m.c819 = Constraint(expr=m.x18 + m.x98 + m.x178 + m.x258 +
                    m.x338 + m.x418 + m.x498 + m.x578 + m.x658 + m.x738 == 1)

m.c820 = Constraint(expr=m.x19 + m.x99 + m.x179 + m.x259 +
                    m.x339 + m.x419 + m.x499 + m.x579 + m.x659 + m.x739 == 1)

m.c821 = Constraint(expr=m.x20 + m.x100 + m.x180 + m.x260 +
                    m.x340 + m.x420 + m.x500 + m.x580 + m.x660 + m.x740 == 1)

m.c822 = Constraint(expr=m.x21 + m.x101 + m.x181 + m.x261 +
                    m.x341 + m.x421 + m.x501 + m.x581 + m.x661 + m.x741 == 1)

m.c823 = Constraint(expr=m.x22 + m.x102 + m.x182 + m.x262 +
                    m.x342 + m.x422 + m.x502 + m.x582 + m.x662 + m.x742 == 1)

m.c824 = Constraint(expr=m.x23 + m.x103 + m.x183 + m.x263 +
                    m.x343 + m.x423 + m.x503 + m.x583 + m.x663 + m.x743 == 1)

m.c825 = Constraint(expr=m.x24 + m.x104 + m.x184 + m.x264 +
                    m.x344 + m.x424 + m.x504 + m.x584 + m.x664 + m.x744 == 1)

m.c826 = Constraint(expr=m.x25 + m.x105 + m.x185 + m.x265 +
                    m.x345 + m.x425 + m.x505 + m.x585 + m.x665 + m.x745 == 1)

m.c827 = Constraint(expr=m.x26 + m.x106 + m.x186 + m.x266 +
                    m.x346 + m.x426 + m.x506 + m.x586 + m.x666 + m.x746 == 1)

m.c828 = Constraint(expr=m.x27 + m.x107 + m.x187 + m.x267 +
                    m.x347 + m.x427 + m.x507 + m.x587 + m.x667 + m.x747 == 1)

m.c829 = Constraint(expr=m.x28 + m.x108 + m.x188 + m.x268 +
                    m.x348 + m.x428 + m.x508 + m.x588 + m.x668 + m.x748 == 1)

m.c830 = Constraint(expr=m.x29 + m.x109 + m.x189 + m.x269 +
                    m.x349 + m.x429 + m.x509 + m.x589 + m.x669 + m.x749 == 1)

m.c831 = Constraint(expr=m.x30 + m.x110 + m.x190 + m.x270 +
                    m.x350 + m.x430 + m.x510 + m.x590 + m.x670 + m.x750 == 1)

m.c832 = Constraint(expr=m.x31 + m.x111 + m.x191 + m.x271 +
                    m.x351 + m.x431 + m.x511 + m.x591 + m.x671 + m.x751 == 1)

m.c833 = Constraint(expr=m.x32 + m.x112 + m.x192 + m.x272 +
                    m.x352 + m.x432 + m.x512 + m.x592 + m.x672 + m.x752 == 1)

m.c834 = Constraint(expr=m.x33 + m.x113 + m.x193 + m.x273 +
                    m.x353 + m.x433 + m.x513 + m.x593 + m.x673 + m.x753 == 1)

m.c835 = Constraint(expr=m.x34 + m.x114 + m.x194 + m.x274 +
                    m.x354 + m.x434 + m.x514 + m.x594 + m.x674 + m.x754 == 1)

m.c836 = Constraint(expr=m.x35 + m.x115 + m.x195 + m.x275 +
                    m.x355 + m.x435 + m.x515 + m.x595 + m.x675 + m.x755 == 1)

m.c837 = Constraint(expr=m.x36 + m.x116 + m.x196 + m.x276 +
                    m.x356 + m.x436 + m.x516 + m.x596 + m.x676 + m.x756 == 1)

m.c838 = Constraint(expr=m.x37 + m.x117 + m.x197 + m.x277 +
                    m.x357 + m.x437 + m.x517 + m.x597 + m.x677 + m.x757 == 1)

m.c839 = Constraint(expr=m.x38 + m.x118 + m.x198 + m.x278 +
                    m.x358 + m.x438 + m.x518 + m.x598 + m.x678 + m.x758 == 1)

m.c840 = Constraint(expr=m.x39 + m.x119 + m.x199 + m.x279 +
                    m.x359 + m.x439 + m.x519 + m.x599 + m.x679 + m.x759 == 1)

m.c841 = Constraint(expr=m.x40 + m.x120 + m.x200 + m.x280 +
                    m.x360 + m.x440 + m.x520 + m.x600 + m.x680 + m.x760 == 1)

m.c842 = Constraint(expr=m.x41 + m.x121 + m.x201 + m.x281 +
                    m.x361 + m.x441 + m.x521 + m.x601 + m.x681 + m.x761 == 1)

m.c843 = Constraint(expr=m.x42 + m.x122 + m.x202 + m.x282 +
                    m.x362 + m.x442 + m.x522 + m.x602 + m.x682 + m.x762 == 1)

m.c844 = Constraint(expr=m.x43 + m.x123 + m.x203 + m.x283 +
                    m.x363 + m.x443 + m.x523 + m.x603 + m.x683 + m.x763 == 1)

m.c845 = Constraint(expr=m.x44 + m.x124 + m.x204 + m.x284 +
                    m.x364 + m.x444 + m.x524 + m.x604 + m.x684 + m.x764 == 1)

m.c846 = Constraint(expr=m.x45 + m.x125 + m.x205 + m.x285 +
                    m.x365 + m.x445 + m.x525 + m.x605 + m.x685 + m.x765 == 1)

m.c847 = Constraint(expr=m.x46 + m.x126 + m.x206 + m.x286 +
                    m.x366 + m.x446 + m.x526 + m.x606 + m.x686 + m.x766 == 1)

m.c848 = Constraint(expr=m.x47 + m.x127 + m.x207 + m.x287 +
                    m.x367 + m.x447 + m.x527 + m.x607 + m.x687 + m.x767 == 1)

m.c849 = Constraint(expr=m.x48 + m.x128 + m.x208 + m.x288 +
                    m.x368 + m.x448 + m.x528 + m.x608 + m.x688 + m.x768 == 1)

m.c850 = Constraint(expr=m.x49 + m.x129 + m.x209 + m.x289 +
                    m.x369 + m.x449 + m.x529 + m.x609 + m.x689 + m.x769 == 1)

m.c851 = Constraint(expr=m.x50 + m.x130 + m.x210 + m.x290 +
                    m.x370 + m.x450 + m.x530 + m.x610 + m.x690 + m.x770 == 1)

m.c852 = Constraint(expr=m.x51 + m.x131 + m.x211 + m.x291 +
                    m.x371 + m.x451 + m.x531 + m.x611 + m.x691 + m.x771 == 1)

m.c853 = Constraint(expr=m.x52 + m.x132 + m.x212 + m.x292 +
                    m.x372 + m.x452 + m.x532 + m.x612 + m.x692 + m.x772 == 1)

m.c854 = Constraint(expr=m.x53 + m.x133 + m.x213 + m.x293 +
                    m.x373 + m.x453 + m.x533 + m.x613 + m.x693 + m.x773 == 1)

m.c855 = Constraint(expr=m.x54 + m.x134 + m.x214 + m.x294 +
                    m.x374 + m.x454 + m.x534 + m.x614 + m.x694 + m.x774 == 1)

m.c856 = Constraint(expr=m.x55 + m.x135 + m.x215 + m.x295 +
                    m.x375 + m.x455 + m.x535 + m.x615 + m.x695 + m.x775 == 1)

m.c857 = Constraint(expr=m.x56 + m.x136 + m.x216 + m.x296 +
                    m.x376 + m.x456 + m.x536 + m.x616 + m.x696 + m.x776 == 1)

m.c858 = Constraint(expr=m.x57 + m.x137 + m.x217 + m.x297 +
                    m.x377 + m.x457 + m.x537 + m.x617 + m.x697 + m.x777 == 1)

m.c859 = Constraint(expr=m.x58 + m.x138 + m.x218 + m.x298 +
                    m.x378 + m.x458 + m.x538 + m.x618 + m.x698 + m.x778 == 1)

m.c860 = Constraint(expr=m.x59 + m.x139 + m.x219 + m.x299 +
                    m.x379 + m.x459 + m.x539 + m.x619 + m.x699 + m.x779 == 1)

m.c861 = Constraint(expr=m.x60 + m.x140 + m.x220 + m.x300 +
                    m.x380 + m.x460 + m.x540 + m.x620 + m.x700 + m.x780 == 1)

m.c862 = Constraint(expr=m.x61 + m.x141 + m.x221 + m.x301 +
                    m.x381 + m.x461 + m.x541 + m.x621 + m.x701 + m.x781 == 1)

m.c863 = Constraint(expr=m.x62 + m.x142 + m.x222 + m.x302 +
                    m.x382 + m.x462 + m.x542 + m.x622 + m.x702 + m.x782 == 1)

m.c864 = Constraint(expr=m.x63 + m.x143 + m.x223 + m.x303 +
                    m.x383 + m.x463 + m.x543 + m.x623 + m.x703 + m.x783 == 1)

m.c865 = Constraint(expr=m.x64 + m.x144 + m.x224 + m.x304 +
                    m.x384 + m.x464 + m.x544 + m.x624 + m.x704 + m.x784 == 1)

m.c866 = Constraint(expr=m.x65 + m.x145 + m.x225 + m.x305 +
                    m.x385 + m.x465 + m.x545 + m.x625 + m.x705 + m.x785 == 1)

m.c867 = Constraint(expr=m.x66 + m.x146 + m.x226 + m.x306 +
                    m.x386 + m.x466 + m.x546 + m.x626 + m.x706 + m.x786 == 1)

m.c868 = Constraint(expr=m.x67 + m.x147 + m.x227 + m.x307 +
                    m.x387 + m.x467 + m.x547 + m.x627 + m.x707 + m.x787 == 1)

m.c869 = Constraint(expr=m.x68 + m.x148 + m.x228 + m.x308 +
                    m.x388 + m.x468 + m.x548 + m.x628 + m.x708 + m.x788 == 1)

m.c870 = Constraint(expr=m.x69 + m.x149 + m.x229 + m.x309 +
                    m.x389 + m.x469 + m.x549 + m.x629 + m.x709 + m.x789 == 1)

m.c871 = Constraint(expr=m.x70 + m.x150 + m.x230 + m.x310 +
                    m.x390 + m.x470 + m.x550 + m.x630 + m.x710 + m.x790 == 1)

m.c872 = Constraint(expr=m.x71 + m.x151 + m.x231 + m.x311 +
                    m.x391 + m.x471 + m.x551 + m.x631 + m.x711 + m.x791 == 1)

m.c873 = Constraint(expr=m.x72 + m.x152 + m.x232 + m.x312 +
                    m.x392 + m.x472 + m.x552 + m.x632 + m.x712 + m.x792 == 1)

m.c874 = Constraint(expr=m.x73 + m.x153 + m.x233 + m.x313 +
                    m.x393 + m.x473 + m.x553 + m.x633 + m.x713 + m.x793 == 1)

m.c875 = Constraint(expr=m.x74 + m.x154 + m.x234 + m.x314 +
                    m.x394 + m.x474 + m.x554 + m.x634 + m.x714 + m.x794 == 1)

m.c876 = Constraint(expr=m.x75 + m.x155 + m.x235 + m.x315 +
                    m.x395 + m.x475 + m.x555 + m.x635 + m.x715 + m.x795 == 1)

m.c877 = Constraint(expr=m.x76 + m.x156 + m.x236 + m.x316 +
                    m.x396 + m.x476 + m.x556 + m.x636 + m.x716 + m.x796 == 1)

m.c878 = Constraint(expr=m.x77 + m.x157 + m.x237 + m.x317 +
                    m.x397 + m.x477 + m.x557 + m.x637 + m.x717 + m.x797 == 1)

m.c879 = Constraint(expr=m.x78 + m.x158 + m.x238 + m.x318 +
                    m.x398 + m.x478 + m.x558 + m.x638 + m.x718 + m.x798 == 1)

m.c880 = Constraint(expr=m.x79 + m.x159 + m.x239 + m.x319 +
                    m.x399 + m.x479 + m.x559 + m.x639 + m.x719 + m.x799 == 1)

m.c881 = Constraint(expr=m.x80 + m.x160 + m.x240 + m.x320 +
                    m.x400 + m.x480 + m.x560 + m.x640 + m.x720 + m.x800 == 1)
