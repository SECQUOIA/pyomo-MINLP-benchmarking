...
m.x68 = Var(within=Reals, initialize=15)
m.x68.fix(15)
...
m.x75 = Var(within=Reals, initialize=5)
m.x75.fix(5)
...
m.obj = Objective(expr=2.4*m.x32 + 2.4*m.x33 + 12*m.x50 + 12 *
                  m.x51 + 12*m.x58 + 12*m.x59 + 6*m.x60 + 6*m.x61, sense=minimize)
...
m.c31 = Constraint(expr=- 15*m.b1 - 15*m.b2 + 0.5 *
                   m.x62 + 0.5*m.x63 - m.x76 + m.x77 <= 0)

m.c32 = Constraint(expr=- 15*m.b1 + 15*m.b2 + 0.5 *
                   m.x62 + 0.5*m.x63 + m.x76 - m.x77 <= 15)

m.c33 = Constraint(expr=5*m.b1 - 5*m.b2 + 0.5*m.x69 +
                   0.5*m.x70 - m.x82 + m.x83 <= 5)

m.c34 = Constraint(expr=5*m.b1 + 5*m.b2 + 0.5*m.x69 +
                   0.5*m.x70 + m.x82 - m.x83 <= 10)
...
m.c39 = Constraint(expr=- 15*m.b3 - 15*m.b4 + 0.5 *
                   m.x62 + 0.5*m.x64 - m.x76 + m.x78 <= 0)

m.c40 = Constraint(expr=- 15*m.b3 + 15*m.b4 + 0.5 *
                   m.x62 + 0.5*m.x64 + m.x76 - m.x78 <= 15)

m.c41 = Constraint(expr=5*m.b3 - 5*m.b4 + 0.5*m.x69 +
                   0.5*m.x71 - m.x82 + m.x84 <= 5)

m.c42 = Constraint(expr=5*m.b3 + 5*m.b4 + 0.5*m.x69 +
                   0.5*m.x71 + m.x82 - m.x84 <= 10)
...
m.c47 = Constraint(expr=- 15*m.b5 - 15*m.b6 + 0.5 *
                   m.x62 + 0.5*m.x65 - m.x76 + m.x79 <= 0)

m.c48 = Constraint(expr=- 15*m.b5 + 15*m.b6 + 0.5 *
                   m.x62 + 0.5*m.x65 + m.x76 - m.x79 <= 15)

m.c49 = Constraint(expr=5*m.b5 - 5*m.b6 + 0.5*m.x69 +
                   0.5*m.x72 - m.x82 + m.x85 <= 5)

m.c50 = Constraint(expr=5*m.b5 + 5*m.b6 + 0.5*m.x69 +
                   0.5*m.x72 + m.x82 - m.x85 <= 10)
...
m.c55 = Constraint(expr=- 15*m.b7 - 15*m.b8 + 0.5 *
                   m.x62 + 0.5*m.x66 - m.x76 + m.x80 <= 0)

m.c56 = Constraint(expr=- 15*m.b7 + 15*m.b8 + 0.5 *
                   m.x62 + 0.5*m.x66 + m.x76 - m.x80 <= 15)

m.c57 = Constraint(expr=5*m.b7 - 5*m.b8 + 0.5*m.x69 +
                   0.5*m.x73 - m.x82 + m.x86 <= 5)

m.c58 = Constraint(expr=5*m.b7 + 5*m.b8 + 0.5*m.x69 +
                   0.5*m.x73 + m.x82 - m.x86 <= 10)
...
m.c63 = Constraint(expr=- 15*m.b9 - 15*m.b10 + 0.5 *
                   m.x62 + 0.5*m.x67 - m.x76 + m.x81 <= 0)

m.c64 = Constraint(expr=- 15*m.b9 + 15*m.b10 + 0.5 *
                   m.x62 + 0.5*m.x67 + m.x76 - m.x81 <= 15)

m.c65 = Constraint(expr=5*m.b9 - 5*m.b10 + 0.5*m.x69 +
                   0.5*m.x74 - m.x82 + m.x87 <= 5)

m.c66 = Constraint(expr=5*m.b9 + 5*m.b10 + 0.5*m.x69 +
                   0.5*m.x74 + m.x82 - m.x87 <= 10)
...
m.c71 = Constraint(expr=- 15*m.b11 - 15*m.b12 + 0.5 *
                   m.x63 + 0.5*m.x64 - m.x77 + m.x78 <= 0)

m.c72 = Constraint(expr=- 15*m.b11 + 15*m.b12 + 0.5 *
                   m.x63 + 0.5*m.x64 + m.x77 - m.x78 <= 15)

m.c73 = Constraint(expr=5*m.b11 - 5*m.b12 + 0.5*m.x70 +
                   0.5*m.x71 - m.x83 + m.x84 <= 5)

m.c74 = Constraint(expr=5*m.b11 + 5*m.b12 + 0.5*m.x70 +
                   0.5*m.x71 + m.x83 - m.x84 <= 10)
...
m.c79 = Constraint(expr=- 15*m.b13 - 15*m.b14 + 0.5 *
                   m.x63 + 0.5*m.x65 - m.x77 + m.x79 <= 0)

m.c80 = Constraint(expr=- 15*m.b13 + 15*m.b14 + 0.5 *
                   m.x63 + 0.5*m.x65 + m.x77 - m.x79 <= 15)

m.c81 = Constraint(expr=5*m.b13 - 5*m.b14 + 0.5*m.x70 +
                   0.5*m.x72 - m.x83 + m.x85 <= 5)

m.c82 = Constraint(expr=5*m.b13 + 5*m.b14 + 0.5*m.x70 +
                   0.5*m.x72 + m.x83 - m.x85 <= 10)
...
m.c87 = Constraint(expr=- 15*m.b15 - 15*m.b16 + 0.5 *
                   m.x63 + 0.5*m.x66 - m.x77 + m.x80 <= 0)

m.c88 = Constraint(expr=- 15*m.b15 + 15*m.b16 + 0.5 *
                   m.x63 + 0.5*m.x66 + m.x77 - m.x80 <= 15)

m.c89 = Constraint(expr=5*m.b15 - 5*m.b16 + 0.5*m.x70 +
                   0.5*m.x73 - m.x83 + m.x86 <= 5)

m.c90 = Constraint(expr=5*m.b15 + 5*m.b16 + 0.5*m.x70 +
                   0.5*m.x73 + m.x83 - m.x86 <= 10)
...
m.c95 = Constraint(expr=- 15*m.b17 - 15*m.b18 + 0.5 *
                   m.x63 + 0.5*m.x67 - m.x77 + m.x81 <= 0)

m.c96 = Constraint(expr=- 15*m.b17 + 15*m.b18 + 0.5 *
                   m.x63 + 0.5*m.x67 + m.x77 - m.x81 <= 15)

m.c97 = Constraint(expr=5*m.b17 - 5*m.b18 + 0.5*m.x70 +
                   0.5*m.x74 - m.x83 + m.x87 <= 5)

m.c98 = Constraint(expr=5*m.b17 + 5*m.b18 + 0.5*m.x70 +
                   0.5*m.x74 + m.x83 - m.x87 <= 10)
...
m.c103 = Constraint(expr=- 15*m.b19 - 15*m.b20 + 0.5 *
                    m.x64 + 0.5*m.x65 - m.x78 + m.x79 <= 0)

m.c104 = Constraint(expr=- 15*m.b19 + 15*m.b20 + 0.5 *
                    m.x64 + 0.5*m.x65 + m.x78 - m.x79 <= 15)

m.c105 = Constraint(expr=5*m.b19 - 5*m.b20 + 0.5*m.x71 +
                    0.5*m.x72 - m.x84 + m.x85 <= 5)

m.c106 = Constraint(expr=5*m.b19 + 5*m.b20 + 0.5*m.x71 +
                    0.5*m.x72 + m.x84 - m.x85 <= 10)
...
m.c111 = Constraint(expr=- 15*m.b21 - 15*m.b22 + 0.5 *
                    m.x64 + 0.5*m.x66 - m.x78 + m.x80 <= 0)

m.c112 = Constraint(expr=- 15*m.b21 + 15*m.b22 + 0.5 *
                    m.x64 + 0.5*m.x66 + m.x78 - m.x80 <= 15)

m.c113 = Constraint(expr=5*m.b21 - 5*m.b22 + 0.5*m.x71 +
                    0.5*m.x73 - m.x84 + m.x86 <= 5)

m.c114 = Constraint(expr=5*m.b21 + 5*m.b22 + 0.5*m.x71 +
                    0.5*m.x73 + m.x84 - m.x86 <= 10)
...
m.c119 = Constraint(expr=- 15*m.b23 - 15*m.b24 + 0.5 *
                    m.x64 + 0.5*m.x67 - m.x78 + m.x81 <= 0)

m.c120 = Constraint(expr=- 15*m.b23 + 15*m.b24 + 0.5 *
                    m.x64 + 0.5*m.x67 + m.x78 - m.x81 <= 15)

m.c121 = Constraint(expr=5*m.b23 - 5*m.b24 + 0.5*m.x71 +
                    0.5*m.x74 - m.x84 + m.x87 <= 5)

m.c122 = Constraint(expr=5*m.b23 + 5*m.b24 + 0.5*m.x71 +
                    0.5*m.x74 + m.x84 - m.x87 <= 10)
...
m.c127 = Constraint(expr=- 15*m.b25 - 15*m.b26 + 0.5 *
                    m.x65 + 0.5*m.x66 - m.x79 + m.x80 <= 0)

m.c128 = Constraint(expr=- 15*m.b25 + 15*m.b26 + 0.5 *
                    m.x65 + 0.5*m.x66 + m.x79 - m.x80 <= 15)

m.c129 = Constraint(expr=5*m.b25 - 5*m.b26 + 0.5*m.x72 +
                    0.5*m.x73 - m.x85 + m.x86 <= 5)

m.c130 = Constraint(expr=5*m.b25 + 5*m.b26 + 0.5*m.x72 +
                    0.5*m.x73 + m.x85 - m.x86 <= 10)
...
m.c135 = Constraint(expr=- 15*m.b27 - 15*m.b28 + 0.5 *
                    m.x65 + 0.5*m.x67 - m.x79 + m.x81 <= 0)

m.c136 = Constraint(expr=- 15*m.b27 + 15*m.b28 + 0.5 *
                    m.x65 + 0.5*m.x67 + m.x79 - m.x81 <= 15)

m.c137 = Constraint(expr=5*m.b27 - 5*m.b28 + 0.5*m.x72 +
                    0.5*m.x74 - m.x85 + m.x87 <= 5)

m.c138 = Constraint(expr=5*m.b27 + 5*m.b28 + 0.5*m.x72 +
                    0.5*m.x74 + m.x85 - m.x87 <= 10)
...
m.c143 = Constraint(expr=- 15*m.b29 - 15*m.b30 + 0.5 *
                    m.x66 + 0.5*m.x67 - m.x80 + m.x81 <= 0)

m.c144 = Constraint(expr=- 15*m.b29 + 15*m.b30 + 0.5 *
                    m.x66 + 0.5*m.x67 + m.x80 - m.x81 <= 15)

m.c145 = Constraint(expr=5*m.b29 - 5*m.b30 + 0.5*m.x73 +
                    0.5*m.x74 - m.x86 + m.x87 <= 5)

m.c146 = Constraint(expr=5*m.b29 + 5*m.b30 + 0.5*m.x73 +
                    0.5*m.x74 + m.x86 - m.x87 <= 10)
