...
m.x21 = Var(within=Reals, initialize=-2)
m.x21.fix(-2)
...
m.x31 = Var(within=Reals, initialize=0)
m.x31.fix(0)
...
m.obj = Objective(expr=(-1.66666666666667 + m.x71)**2 + 0.2*m.x51**2 + 0.2*m.x52**2 + 0.2*m.x53**2 + 0.2*m.x54**2 + 0.2 *
                  m.x55**2 + 0.2*m.x56**2 + 0.2*m.x57**2 + 0.2*m.x58**2 + 0.2*m.x59**2 + 0.2*m.x60**2, sense=minimize)
