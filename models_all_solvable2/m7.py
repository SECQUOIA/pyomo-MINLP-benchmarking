...
m.x93 = Var(within=Reals, initialize=20)
m.x93.fix(20)
...
m.x101 = Var(within=Reals, initialize=5)
m.x101.fix(5)
...
m.c35 = Constraint(expr=- 20*m.b1 - 20*m.b2 + 0.5*m.x86 +
                   0.5*m.x87 - m.x102 + m.x103 <= 0)

m.c36 = Constraint(expr=- 20*m.b1 + 20*m.b2 + 0.5*m.x86 +
                   0.5*m.x87 + m.x102 - m.x103 <= 20)

m.c37 = Constraint(expr=5*m.b1 - 5*m.b2 + 0.5*m.x94 +
                   0.5*m.x95 - m.x109 + m.x110 <= 5)

m.c38 = Constraint(expr=5*m.b1 + 5*m.b2 + 0.5*m.x94 +
                   0.5*m.x95 + m.x109 - m.x110 <= 10)
...
m.c43 = Constraint(expr=- 20*m.b3 - 20*m.b4 + 0.5*m.x86 +
                   0.5*m.x88 - m.x102 + m.x104 <= 0)

m.c44 = Constraint(expr=- 20*m.b3 + 20*m.b4 + 0.5*m.x86 +
                   0.5*m.x88 + m.x102 - m.x104 <= 20)

m.c45 = Constraint(expr=5*m.b3 - 5*m.b4 + 0.5*m.x94 +
                   0.5*m.x96 - m.x109 + m.x111 <= 5)

m.c46 = Constraint(expr=5*m.b3 + 5*m.b4 + 0.5*m.x94 +
                   0.5*m.x96 + m.x109 - m.x111 <= 10)
...
m.c51 = Constraint(expr=- 20*m.b5 - 20*m.b6 + 0.5*m.x86 +
                   0.5*m.x89 - m.x102 + m.x105 <= 0)

m.c52 = Constraint(expr=- 20*m.b5 + 20*m.b6 + 0.5*m.x86 +
                   0.5*m.x89 + m.x102 - m.x105 <= 20)

m.c53 = Constraint(expr=5*m.b5 - 5*m.b6 + 0.5*m.x94 +
                   0.5*m.x97 - m.x109 + m.x112 <= 5)

m.c54 = Constraint(expr=5*m.b5 + 5*m.b6 + 0.5*m.x94 +
                   0.5*m.x97 + m.x109 - m.x112 <= 10)
...
m.c59 = Constraint(expr=- 20*m.b7 - 20*m.b8 + 0.5*m.x86 +
                   0.5*m.x90 - m.x102 + m.x106 <= 0)

m.c60 = Constraint(expr=- 20*m.b7 + 20*m.b8 + 0.5*m.x86 +
                   0.5*m.x90 + m.x102 - m.x106 <= 20)

m.c61 = Constraint(expr=5*m.b7 - 5*m.b8 + 0.5*m.x94 +
                   0.5*m.x98 - m.x109 + m.x113 <= 5)

m.c62 = Constraint(expr=5*m.b7 + 5*m.b8 + 0.5*m.x94 +
                   0.5*m.x98 + m.x109 - m.x113 <= 10)
...
m.c67 = Constraint(expr=- 20*m.b9 - 20*m.b10 + 0.5 *
                   m.x86 + 0.5*m.x91 - m.x102 + m.x107 <= 0)

m.c68 = Constraint(expr=- 20*m.b9 + 20*m.b10 + 0.5*m.x86 +
                   0.5*m.x91 + m.x102 - m.x107 <= 20)

m.c69 = Constraint(expr=5*m.b9 - 5*m.b10 + 0.5*m.x94 +
                   0.5*m.x99 - m.x109 + m.x114 <= 5)

m.c70 = Constraint(expr=5*m.b9 + 5*m.b10 + 0.5*m.x94 +
                   0.5*m.x99 + m.x109 - m.x114 <= 10)
...
m.c75 = Constraint(expr=- 20*m.b11 - 20*m.b12 + 0.5 *
                   m.x86 + 0.5*m.x92 - m.x102 + m.x108 <= 0)

m.c76 = Constraint(expr=- 20*m.b11 + 20*m.b12 + 0.5 *
                   m.x86 + 0.5*m.x92 + m.x102 - m.x108 <= 20)

m.c77 = Constraint(expr=5*m.b11 - 5*m.b12 + 0.5*m.x94 +
                   0.5*m.x100 - m.x109 + m.x115 <= 5)

m.c78 = Constraint(expr=5*m.b11 + 5*m.b12 + 0.5*m.x94 +
                   0.5*m.x100 + m.x109 - m.x115 <= 10)
...
m.c83 = Constraint(expr=- 20*m.b13 - 20*m.b14 + 0.5 *
                   m.x87 + 0.5*m.x88 - m.x103 + m.x104 <= 0)

m.c84 = Constraint(expr=- 20*m.b13 + 20*m.b14 + 0.5 *
                   m.x87 + 0.5*m.x88 + m.x103 - m.x104 <= 20)

m.c85 = Constraint(expr=5*m.b13 - 5*m.b14 + 0.5*m.x95 +
                   0.5*m.x96 - m.x110 + m.x111 <= 5)

m.c86 = Constraint(expr=5*m.b13 + 5*m.b14 + 0.5*m.x95 +
                   0.5*m.x96 + m.x110 - m.x111 <= 10)
...
m.c91 = Constraint(expr=- 20*m.b15 - 20*m.b16 + 0.5 *
                   m.x87 + 0.5*m.x89 - m.x103 + m.x105 <= 0)

m.c92 = Constraint(expr=- 20*m.b15 + 20*m.b16 + 0.5 *
                   m.x87 + 0.5*m.x89 + m.x103 - m.x105 <= 20)

m.c93 = Constraint(expr=5*m.b15 - 5*m.b16 + 0.5*m.x95 +
                   0.5*m.x97 - m.x110 + m.x112 <= 5)

m.c94 = Constraint(expr=5*m.b15 + 5*m.b16 + 0.5*m.x95 +
                   0.5*m.x97 + m.x110 - m.x112 <= 10)
...
m.c99 = Constraint(expr=- 20*m.b17 - 20*m.b18 + 0.5 *
                   m.x87 + 0.5*m.x90 - m.x103 + m.x106 <= 0)

m.c100 = Constraint(expr=- 20*m.b17 + 20*m.b18 + 0.5 *
                    m.x87 + 0.5*m.x90 + m.x103 - m.x106 <= 20)

m.c101 = Constraint(expr=5*m.b17 - 5*m.b18 + 0.5*m.x95 +
                    0.5*m.x98 - m.x110 + m.x113 <= 5)

m.c102 = Constraint(expr=5*m.b17 + 5*m.b18 + 0.5*m.x95 +
                    0.5*m.x98 + m.x110 - m.x113 <= 10)
...
m.c107 = Constraint(expr=- 20*m.b19 - 20*m.b20 + 0.5 *
                    m.x87 + 0.5*m.x91 - m.x103 + m.x107 <= 0)

m.c108 = Constraint(expr=- 20*m.b19 + 20*m.b20 + 0.5 *
                    m.x87 + 0.5*m.x91 + m.x103 - m.x107 <= 20)

m.c109 = Constraint(expr=5*m.b19 - 5*m.b20 + 0.5*m.x95 +
                    0.5*m.x99 - m.x110 + m.x114 <= 5)

m.c110 = Constraint(expr=5*m.b19 + 5*m.b20 + 0.5*m.x95 +
                    0.5*m.x99 + m.x110 - m.x114 <= 10)
...
m.c115 = Constraint(expr=- 20*m.b21 - 20*m.b22 + 0.5 *
                    m.x87 + 0.5*m.x92 - m.x103 + m.x108 <= 0)

m.c116 = Constraint(expr=- 20*m.b21 + 20*m.b22 + 0.5 *
                    m.x87 + 0.5*m.x92 + m.x103 - m.x108 <= 20)

m.c117 = Constraint(expr=5*m.b21 - 5*m.b22 + 0.5*m.x95 +
                    0.5*m.x100 - m.x110 + m.x115 <= 5)

m.c118 = Constraint(expr=5*m.b21 + 5*m.b22 + 0.5*m.x95 +
                    0.5*m.x100 + m.x110 - m.x115 <= 10)
...
m.c123 = Constraint(expr=- 20*m.b23 - 20*m.b24 + 0.5 *
                    m.x88 + 0.5*m.x89 - m.x104 + m.x105 <= 0)

m.c124 = Constraint(expr=- 20*m.b23 + 20*m.b24 + 0.5 *
                    m.x88 + 0.5*m.x89 + m.x104 - m.x105 <= 20)

m.c125 = Constraint(expr=5*m.b23 - 5*m.b24 + 0.5*m.x96 +
                    0.5*m.x97 - m.x111 + m.x112 <= 5)

m.c126 = Constraint(expr=5*m.b23 + 5*m.b24 + 0.5*m.x96 +
                    0.5*m.x97 + m.x111 - m.x112 <= 10)
...
m.c131 = Constraint(expr=- 20*m.b25 - 20*m.b26 + 0.5 *
                    m.x88 + 0.5*m.x90 - m.x104 + m.x106 <= 0)

m.c132 = Constraint(expr=- 20*m.b25 + 20*m.b26 + 0.5 *
                    m.x88 + 0.5*m.x90 + m.x104 - m.x106 <= 20)

m.c133 = Constraint(expr=5*m.b25 - 5*m.b26 + 0.5*m.x96 +
                    0.5*m.x98 - m.x111 + m.x113 <= 5)

m.c134 = Constraint(expr=5*m.b25 + 5*m.b26 + 0.5*m.x96 +
                    0.5*m.x98 + m.x111 - m.x113 <= 10)
...
m.c139 = Constraint(expr=- 20*m.b27 - 20*m.b28 + 0.5 *
                    m.x88 + 0.5*m.x91 - m.x104 + m.x107 <= 0)

m.c140 = Constraint(expr=- 20*m.b27 + 20*m.b28 + 0.5 *
                    m.x88 + 0.5*m.x91 + m.x104 - m.x107 <= 20)

m.c141 = Constraint(expr=5*m.b27 - 5*m.b28 + 0.5*m.x96 +
                    0.5*m.x99 - m.x111 + m.x114 <= 5)

m.c142 = Constraint(expr=5*m.b27 + 5*m.b28 + 0.5*m.x96 +
                    0.5*m.x99 + m.x111 - m.x114 <= 10)
...
m.c147 = Constraint(expr=- 20*m.b29 - 20*m.b30 + 0.5 *
                    m.x88 + 0.5*m.x92 - m.x104 + m.x108 <= 0)

m.c148 = Constraint(expr=- 20*m.b29 + 20*m.b30 + 0.5 *
                    m.x88 + 0.5*m.x92 + m.x104 - m.x108 <= 20)

m.c149 = Constraint(expr=5*m.b29 - 5*m.b30 + 0.5*m.x96 +
                    0.5*m.x100 - m.x111 + m.x115 <= 5)

m.c150 = Constraint(expr=5*m.b29 + 5*m.b30 + 0.5*m.x96 +
                    0.5*m.x100 + m.x111 - m.x115 <= 10)
...
m.c155 = Constraint(expr=- 20*m.b31 - 20*m.b32 + 0.5 *
                    m.x89 + 0.5*m.x90 - m.x105 + m.x106 <= 0)

m.c156 = Constraint(expr=- 20*m.b31 + 20*m.b32 + 0.5 *
                    m.x89 + 0.5*m.x90 + m.x105 - m.x106 <= 20)

m.c157 = Constraint(expr=5*m.b31 - 5*m.b32 + 0.5*m.x97 +
                    0.5*m.x98 - m.x112 + m.x113 <= 5)

m.c158 = Constraint(expr=5*m.b31 + 5*m.b32 + 0.5*m.x97 +
                    0.5*m.x98 + m.x112 - m.x113 <= 10)
...
m.c163 = Constraint(expr=- 20*m.b33 - 20*m.b34 + 0.5 *
                    m.x89 + 0.5*m.x91 - m.x105 + m.x107 <= 0)

m.c164 = Constraint(expr=- 20*m.b33 + 20*m.b34 + 0.5 *
                    m.x89 + 0.5*m.x91 + m.x105 - m.x107 <= 20)

m.c165 = Constraint(expr=5*m.b33 - 5*m.b34 + 0.5*m.x97 +
                    0.5*m.x99 - m.x112 + m.x114 <= 5)

m.c166 = Constraint(expr=5*m.b33 + 5*m.b34 + 0.5*m.x97 +
                    0.5*m.x99 + m.x112 - m.x114 <= 10)
...
m.c171 = Constraint(expr=- 20*m.b35 - 20*m.b36 + 0.5 *
                    m.x89 + 0.5*m.x92 - m.x105 + m.x108 <= 0)

m.c172 = Constraint(expr=- 20*m.b35 + 20*m.b36 + 0.5 *
                    m.x89 + 0.5*m.x92 + m.x105 - m.x108 <= 20)

m.c173 = Constraint(expr=5*m.b35 - 5*m.b36 + 0.5*m.x97 +
                    0.5*m.x100 - m.x112 + m.x115 <= 5)

m.c174 = Constraint(expr=5*m.b35 + 5*m.b36 + 0.5*m.x97 +
                    0.5*m.x100 + m.x112 - m.x115 <= 10)
...
m.c179 = Constraint(expr=- 20*m.b37 - 20*m.b38 + 0.5 *
                    m.x90 + 0.5*m.x91 - m.x106 + m.x107 <= 0)

m.c180 = Constraint(expr=- 20*m.b37 + 20*m.b38 + 0.5 *
                    m.x90 + 0.5*m.x91 + m.x106 - m.x107 <= 20)

m.c181 = Constraint(expr=5*m.b37 - 5*m.b38 + 0.5*m.x98 +
                    0.5*m.x99 - m.x113 + m.x114 <= 5)

m.c182 = Constraint(expr=5*m.b37 + 5*m.b38 + 0.5*m.x98 +
                    0.5*m.x99 + m.x113 - m.x114 <= 10)
...
m.c187 = Constraint(expr=- 20*m.b39 - 20*m.b40 + 0.5 *
                    m.x90 + 0.5*m.x92 - m.x106 + m.x108 <= 0)

m.c188 = Constraint(expr=- 20*m.b39 + 20*m.b40 + 0.5 *
                    m.x90 + 0.5*m.x92 + m.x106 - m.x108 <= 20)

m.c189 = Constraint(expr=5*m.b39 - 5*m.b40 + 0.5*m.x98 +
                    0.5*m.x100 - m.x113 + m.x115 <= 5)

m.c190 = Constraint(expr=5*m.b39 + 5*m.b40 + 0.5*m.x98 +
                    0.5*m.x100 + m.x113 - m.x115 <= 10)
...
m.c195 = Constraint(expr=- 20*m.b41 - 20*m.b42 + 0.5 *
                    m.x91 + 0.5*m.x92 - m.x107 + m.x108 <= 0)

m.c196 = Constraint(expr=- 20*m.b41 + 20*m.b42 + 0.5 *
                    m.x91 + 0.5*m.x92 + m.x107 - m.x108 <= 20)

m.c197 = Constraint(expr=5*m.b41 - 5*m.b42 + 0.5*m.x99 +
                    0.5*m.x100 - m.x114 + m.x115 <= 5)

m.c198 = Constraint(expr=5*m.b41 + 5*m.b42 + 0.5*m.x99 +
                    0.5*m.x100 + m.x114 - m.x115 <= 10)
